...
## 0010. Componentes de una aplicación
...
* **Jesús Israel Contreras Urquiola** (4)
...
* **Danilo Josué Huacón Aguirre** (0)

	
	No puede ser que haya pagado 29$ por un profesor así…

	* **Omar Enrique Crespo Merchan** (15)
...
## 0020. Opciones para hacer Deploy
...
## 0030. Aplicaciones monolíticas vs microservicios
...
* **Oscar Rodrigo Chavez Calderón** (0)
	...
	* **Oscar Rodrigo Chavez Calderón** (1)
...
* **Jose Francisco Alvarez Valdez** (1)
...
## 0090. Deploy de aplicaciones Node.js
...
## 0100. Deploy de contenedores de Docker
...
## 0110. Configuración de secrets y variables de entorno
...
* **Juan Carlos Mendoza Rodríguez** (4)
...
* **LUIGGI ALEXIS RODRIGUEZ RUIZ** (1)
...
## 0120. Ver el código fuente de tu aplicación
...
## 0130. Definir aliases para tus deploy
...
## 0140. Usar un dominio personalizado
...
* **nicolas ricardo restrepo Restr Restrepo** (1)
	...
	* **nicolas ricardo restrepo Restr Restrepo** (0)
...
* **Martin Cortes** (6)
	...
	* **Damianenko Max Zeballos Torres** (1)
...
## 0180. Deploy en Now.sh desde GitHub
...
## 0190. Combinar muchos servicios
...
## 0200. Usar un servicio diferente
