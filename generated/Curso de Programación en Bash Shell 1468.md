...
* **Anthony Pernia** (1) [726970](https://platzi.com/comentario/726970/) 
	...
	* **Bianca Mercado** [726970] (2)
		...
		user00@localhost shellCourse]$ ./5_substituyeComando.sh  
...
* **Decoderunner** (1) [706990](https://platzi.com/comentario/706990/) 
	...
	Resolving [www-us.apache.org](http://www-us.apache.org) ([www-us.apache.org](http://www-us.apache.org))… 40.79.78.1  
	Connecting to [www-us.apache.org](http://www-us.apache.org) ([www-us.apache.org](http://www-us.apache.org))|40.79.78.1|:443… connected.  
...
* **JosueM** (2) [1004211](https://platzi.com/comentario/1004211/) 
	...
	```
	    # ! /bin/bash
	    # Solución del reto numero 2: Solicitar la informaciónde cada uno de ustedes como nombres, apellidos, edad, dirección y números telefónicos; y posterior imprima toda la información.
...
* **Lerni** (1) [1084945](https://platzi.com/comentario/1084945/) 
	...
	``` 
	    ...
	    edad_regex="^[1-9]{1,3}$"
	    direccion_regex="^([a-zA-Z ]+)([0-9 ]+)(N|#)([a-zA-Z0-9 ]+-[a-zA-Z0-9]+)$"
	    telefono_regex="^[0-9]{7}$"
	    celular_regex="^3[0-9]{9}$"
	    
	    echo-e"Formulario de inscripcion\n"
	    read -p "Ingrese sus nombres: " nombres
	    ...
	    obtener_datos $edad_regex"Ingrese su edad:""Edad no valida"
	    edad=$dato
	    
	    obtener_datos $telefono_regex"Ingrese su telefono:""Telefono no valido"
	    telefono=$dato
	    
	    obtener_datos $celular_regex"Ingrese su celular:""Celular no valido"
	    celular=$dato
	    
	    echo-e"\n=========================================\n"
	    while [ -n "$1" ]; do
	        case"$1"in
	            --nombre-completo) echo"El nombre completo es: $nombres$apellidos";;
	            --datos-contacto) echo-e"Los datos de contacto son:\ndireccion: $direccion\nTelefono: $telefono\nCelular: $celular";;
	            --datos-completos) echo-e"Nombre: $nombres$apellidos\nEdad: $edad\nLos datos de contacto son:\ndireccion: $direccion\nTelefono: $telefono\nCelular: $celular";;
	        esac
	        shift
	    done
...
* **Malalo** (1) [1082543](https://platzi.com/comentario/1082543/) 
	...
	``` 
	    #!/bin/bash
	    # Reto que solicita informacion de nombres, apellidos, direccion, edad y telefono.
	    # Desarrollado por Malalo
...
* **Jordan Arellano Rosero** (1) [1052067](https://platzi.com/comentario/1052067/) 
	...
	``` 
	    #!/bin/bash
	    #Programa para ingresar datos personales y mostrarlos por pantalla
	    #Créditos @Marck MR edited by @Jordam
	    ...
	    read -p "Ingrese su edad: " edad
	    read -p "ingrese su cédula: " dni
	    read -p "Ingrese su correo electrónico: " correo
	    ...
	    echo"Número de cédula inválido"
	    fi
	    if [[ !($correo =~ $correoRegex) ]]; then
	    echo"Correo inválido"
	    elif [[ ($correo =~ $correRegex) ]]; then
	    echo"Correo Valido"
	    fi
...
* **Marck  MR** (1) [1026614](https://platzi.com/comentario/1026614/) 
	...
	```
	    # ! bin/bash
	    #Programa para igresar datos personales y mostrarlos por pantalla
...
* **David A. Casas Amézquita** (1) [1024153](https://platzi.com/comentario/1024153/) 
	...
	```
	    # !/bin/bash
	    # Programa para Solicitar la información de cada uno de ustedes como nombres, apellidos, edad, dirección y números telefónicos; y posterior imprima toda la información.
	    ...
	    echo"Ingrese los siguietnes datos para reclamar su premio "
	    read -p "Nombre: " nombre
	    read -p "Apellido: " apellido
	    read -p "Edad: " edad
	    ...
	    echo-e"\nBienvenido $nombre$apellido \n\nEn breve nos comunicaremos contigo al telefono $telefono \n\nPara acordar un regalo acorde a tus $edad años, el cual te haremos llegar a la dirección $direccion \n\nEsperamos disfrutes de la comunidad :D"
...
* **Carlos Bustos** (1) [1022008](https://platzi.com/comentario/1022008/) 
	...
	```
	    #!/bin/bash
	    # Este programa es la solucion al reto 2, Solicitar el nombre, aprellido, edad, direccion, numero telefonica y esto imprimirlo a pantalla.
	    # Autor: Ing. Carlos Bustos @ingcarlosbustos83
	    
	    nombre=""
	    apellido=""
	    identiticacionRegex='^[0-9]{10}$'
	    edadRegex='^[0-9]{10}$'
	    fechaNacimientoRegex='^19|20[0-8]{2}[1-12][1-31]$'
	    direccion=""
	    telefonoRegex='^[0-9]{10}$'
	    
	    echo"Ingresa los datos solicitado por el programa"
	    read -n10 -p "Ingrese su nombre:" nombre
	    read -n10 -p "Ingrese su apellido:" apellido
	    read      -p "Ingrese su numero de identificacion:" identiticacion
	    read      -p "Ingrese su numero de edad:" edad
	    read      -p "Ingresar fecha de nacimiento [yyyyMMdd]: " fechaNacimiento
	    read -n10 -p "Ingrese su Direccion:" direccion
	    ...
	    echo"Nombre: $nombre"
	    echo"Apellido: $apellido"
	    echo"Numero de Indentificacion: $identificacion"
	    echo"Edad: $edad"
...
* **emmanuelnp95** (1) [995450](https://platzi.com/comentario/995450/) 
	...
	```
	    ...
	    read -p "Escribe tu primer apellido: " apellPaterno
	    read -p "Escribe tu segundo apellido: " apellMaterno
	    read -n2 -p  "Escribe tu segundo edad: " edad
	    read -p "Escribe tu segundo email: \n" email 
	    read -n10 -p "Escribe un telefono celular: " telefono
	    
	    echo-e"\nVerifique su informacion"
	    echo"Hola, $nombre$apellPaterno$apellMaterno"
	    echo"tu edad es: $edad"
	    echo"tu correo es: $email"
	    echo"telefono: $telefono"
	    echo-e"\n"
	    read -n1 -s -r -p "Si todo esta correcto apriete cualquier letra"
	    echo-e"\n"
	    exit
...
* **Ian Javier Duran Roman** (1) [974354](https://platzi.com/comentario/974354/) 
	...
	```
	    ...
	    echo"------------------------------------------
	         Hola, ingrese sus datos por favor
	    -------------------------------------------"
...
* **jairhop** (1) [937397](https://platzi.com/comentario/937397/) 
	...
	```
	    ...
	    jair@TOSHIBA:~/shell$ ls -lh reto2.sh
	    -rw-rw-rw- 1 jair jair 647 Jan 20 22:26 reto2.sh
	    jair@TOSHIBA:~/shell$ chmod +x reto2.sh
	    jair@TOSHIBA:~/shell$ ls -lh reto2.sh
	    -rwxrwxrwx 1 jair jair 647 Jan 20 22:26 reto2.sh
	    jair@TOSHIBA:~/shell$ ./reto2.sh
	    Bienvenido al Concurso! Brindenos algunos datos para el sorteo.
	    Nombres: Jair Hernan
	    Apellidos: Otiniano Proa
	    Edad: 27
	    Direccion: Calle XXXX, Urb XXXX. XXXX-XXXX
	    Telefono 1: 123456789
	    Telefono 2: 987654321
	    
	    
	    Gracias por los datos Otiniano Proa, Jair Hernan!
	    
	    
	    Resumen del Candidato al Premio!
	    --------------------------------
	    Nombres: Jair Hernan
	    Apellidos: Otiniano Proa
	    Edad: 27
	    Dirección: Calle XXXX, Urb XXXX. XXXX-XXXX
	    Teléfono 1: 123456789
	    Teléfono 2: 987654321
	    jair@TOSHIBA:~/shell$ cat reto2.sh
	    #!/bin/bash
	    nombres=""
	    apellidos=""
	    edad=0
	    ...
	    telefono1=0
	    telefono2=0
	    echo"Bienvenido al Concurso! Brindenos algunos datos para el sorteo."
	    read -p "Nombres: " nombres
	    read -p "Apellidos: " apellidos
	    read -p "Edad: " edad
	    read -p "Direccion: " direccion
	    read -p "Telefono 1: " telefono1
	    read -p "Telefono 2: " telefono2
	    echo-e"\n"
	    echo"Gracias por los datos $apellidos, $nombres!"
	    echo-e"\n"
	    echo"Resumen del Candidato al Premio!"
	    echo"--------------------------------"
	    echo"Nombres: $nombres"
	    echo"Apellidos: $apellidos"
	    echo"Edad: $edad"
	    echo"Dirección: $direccion"
	    echo"Teléfono 1: $telefono1"
	    echo"Teléfono 2: $telefono2"```
...
* **Antonio Rafael González Ferrer** (1) [834863](https://platzi.com/comentario/834863/) 
	...
	```
	``` 
	    agonzalezf87@ubuntu-virtual:/media/sf_shellCourse$ ./reto3.sh 
	    ...
	    : t
	    La opciónque eligió nose encuentra dentro del listado, vuelva a intentar.
...
* **JoanXD** (1) [629397](https://platzi.com/comentario/629397/) 
	...
	10 echo "Array of fib: ${array_fib[ _]} "  
	11 #show the values in separated lines  
	12 echo "Array of chain: ${array_chain[@]}"  
	13 #show the values in the same lines  
	14 echo "Array of range: ${array_range[_]}"  
	15  
	16 #Print the length of all arrays  
	17 echo "Length of array of fib: ${#array_fib[ _]} "  
	18 echo "Length of array of chain: ${#array_chain[_]}"  
	19 echo "Length of array of range: ${#array_range[ _]} "  
	20  
	...
	34 echo "Array of fib: ${array_fib[_]}"  
...
Alguien me puede ayudar a resolver la siguiente duda de por qué salen diferentes resultados por favor esto surgió por qué no distinguía b...
	...
	* **EPadronU23** [71399] (1)
		...
		```
		    ...
		    {A...Z}{10..20} # Por la falta de espacio, además de expandir dos rangos, produce un producto cartesiano. Todos los elementos del primer rango concatenados a todos los elementos del segundo
		    {A..Z}{10..20] # Expande el único rango que hay `{A..Z}` (tienes un error en el segundo rango: abres con llave y cierras con conrchete) y lo concatena con la cadena de caracteres `{10..20]`
	...
	* **Ivan Rene Acosta Lallemand** [77173] (1)
		...
		``` 
		    ...
		    do
		         ...
		         read -n1 -p "Ingrese una opcion [1-5] " x
	...
	**DONE**
	``` 
	    #! /bin/bash
	     ...
	     62         echo"_________________________________________"
	     63         echo"1. Procesos Actuales"
	     64         echo"2. Memoria Disponible"
	     65         echo"3. Espacio En Disco"
	     66         echo"4. Informacion De Red"
	     67         echo"5. Variables De Entorno Configuradas"
	     68         echo"6. Informacion Programa"
	     69         echo"7. Backup informacion"
	     70         echo"8.salir"
	     71
	     72
	     73         read -n1 -p "Ingrese una opcion [1-8]:    " option
	     74
	     75         echo-e"\n\n"
	     76
	     77         case$optionin
	     78             1)
	     79                 echo-e"Instalando"
	     80                 top
	     81                 sleep 3
	     82                 ;;
	     83             2)
	     84                 echo"Desintalando"
	     85                 free -h
	     86                 sleep 2
	     87                 ;;
	     88             3)
	    ...
	    102                 ;;
	    103             6)
	    104                 echo"Practicas para crear menus"
	    105                 sleep 2
	    106                 ;;
	    107             7)
	    108                 echo"tar -czf archivo.tar.gz ejemplo_1.txt ejemplo_2.txt"
	    109                 sleep 2
	    110                 ;;
	    111             8)
	    112                 echo"Saliendo"
	    ...
	    do
	    	if [ $flag == 0 ]; then
	          for ((i=0;i<4;i++))
	    		...
	    		echo" 8. 	SALIR"
	    		echo""
	    		read -n 1 -p "Ingrese una opción [1-8]: " opcion
...
* **Javier Avilés** (1) [1036110](https://platzi.com/comentario/1036110/) 
	...
	``` 
	    ...
	    do
	        ...
	        echo"------------------------------------------"
	        echo"RETO 4 - programa de utilidades"
	        echo"------------------------------------------"
...
* **Victor Martin Ortiz Palacio** (1) [991046](https://platzi.com/comentario/991046/) 
	...
	``` 
	     1 # !/bin/bash
	     2 # Crear un menú con las siguientes opciones: 1)Procesos actuales, 2)Memoria disponible, 3)Espacio en disco, 4)Información de red, 5)Variables de entorno configuradas    , 6)Información programa, 7)Backup información, 8)Ingrese  una opción.
	      3 # Author: Víctor Ortíz
	      4 
	      5 option=0
	      6 info=( "version: 1.0.0""Author: Víctor Ortíz""Github: victormartinortiz")
	      7 
	      8 clear
	      9 echo"-----------------------------------------------"
	     10 echo"                  MENÚ                         "
	     11 echo"-----------------------------------------------"
	     12 echo"1)Procesos actuales."
	     13 echo"2)Memoria disponible."
	     14 echo"3)Espacio de disco." 
	     15 echo"4)Información de red." 
	     16 echo"5)Variables de entorno configuradas." 
	     17 echo"6)Información de programa." 
	     18 echo"7)Backup información." 
	     19 echo"8)Salir." 
	     20  
	     21 read -n1 -p "Ingrese una opción [1-8]: " option 
	     22  
	     23 case$optionin 
	     24  
	...
	**Script reto 4**
	``` 
	    ...
	    do
	            ...
	            echo"3. Espacio en Disco"
	            echo"4. Informacion de Red"
	            echo"5. Variable de Entorno Configuradas"
	            echo"6. Información del programa"
	            echo"7. Backup de información"
	            echo"8. Salir"
	    
	            read -n1 -p "Por favor, ingrese una opción [1-8]:   " option
	            echo-e"\n\n"
	            ...
	            case$optionin
	                    1)
	                            ...
	                            ps
	                            read -n1 -s -r -p "Ingrese una tecla para continuar: " key;;
	                    2)
	                            echo-e"Mostrando la memoria disponible\n"
	                            free -m -t
	                            read -n1 -s -r -p "Ingrese una tecla para continuar: " key;;
	                    3)
	                            echo-e"Mostrando espacio libre en disco\n"
	                            df -h
	                            read -n1 -s -r -p "Ingrese una tecla para continuar: " key;;
	                    4)
	                            echo-e"Mostrando la Inormación de Red\n"
	                            ifconfig
	                            read -n1 -s -r -p "Ingrese una tecla para continuar: " key;;
	                    5)
	                            echo-e"Mostrando las variables de entorno"
	                            printenv
	                            read -n1 -s -r -p "Ingrese una tecla para continuar: " key;;
	                    6)
	                            echo-e"La version del programa es: v0.0.1"
	                            read -n1 -s -r -p "Ingrese una tecla para continuar: " key;;
	                    7)
	                            echo"Realizando Backup..."
	                            sleep 3;;
	                    8)
	                            echo"Saliendo del programa, que tenga un buen día"
	                            exit 0;;
...
* **rafster.15** (1) [944086](https://platzi.com/comentario/944086/) 
	...
	echo "3\. Espacio en Disco "  
	echo "4\. Informacion de red "  
	echo "5\. Variables de entornos Configuradas"  
	echo "6\. Informacion del Programa "  
	echo "7\. Backup Informacion "  
	echo "8\. Salir "  
	echo -e "\n"  
	...
	``` 
	    #Evaluando la option con  la expresion case
	    case $option in
	        1)
	            echo -e "\nLa informacion de los procesos actuales es "
	            ps -aux
	            sleep 3
	            ;;
	        2)
	        ...
	        4)
	            ...
	            ;;
	        5)
	            echo -e "\nLas variables de entornos que estan configuradas son : "
	            printenv
	            sleep 3
	            ;;
	        6) 
	            echo -e "\nLa informacion del programa es la siguiente :"
	            ls -l reto4.sh
	            sleep 3
	            ;;
	        7)  echo -e "\nGenerando informacionm del backup "
	            sleep 5
	            ;;
	        8)
...
* **Valakyr** (1) [929737](https://platzi.com/comentario/929737/) 
	...
	```
	    ...
	    do
	        ...
	        case$opcionin
	            1)
	                echo-e"\nRecopilando información de los procesos actuales......"
	                sleep 3
	                ;;
	    
	            2)
	                echo-e"\nCalculando la memoria disponible......"
	                sleep 3
	                ;;
	            ...
	            4)
	                ...
	                ;;
	            5)
	                echo-e"\nImprimiendo la configuración de las variables de entorno....."
	                sleep 3
	                ;;
	            6)
	                echo-e"\nImprimiendo la información del programa....."
	                sleep 3
	                ;;
	            7)
	                echo-e"\nCreando un backup de la información....."
	                sleep 3
	                ;;
	            8)
	                echo-e"\nSalir del programa"
...
* **Luis Miguel Taque Diaz** (1) [853134](https://platzi.com/comentario/853134/) 
	...
	```
	    ...
	    while :
	            ...
	            echo"1. Procesos En Ejecucion......."
	            echo"2. Memoria Disponible.........."
	            echo"3. Espacio En Disco............"
	            echo"4. Informacion de la Red......."
	            echo"5. Variables de Entorno Configuradas..."
	            echo"6. Informacion del Programa....."
	            echo"7. backup Informacion.........."
	            ...
	            case$opcionin
	                    ...
	                    5) printenv
	                            sleep 2
	                            ;;
	                    6) echo" El programa tiene como finalidad poner en practica la creacion de menus...."
	                            sleep 2
	                            ;;
	                    7) echo"tar -czf archiv.tar.gz ejemplo_1.txt ejemplo_2.txt"
	                            sleep 2
	                            ;;
	                    8)      pipo=""
	                            read -p "Ingresar tu nombre: " pipo
	                            echo"Osea que te llamas $pipo Mucho gusto me llamo Bash y Soy Tu Dios..."
	                            sleep 2
	                            ;;
...
* **Antonio Rafael González Ferrer** (1) [838907](https://platzi.com/comentario/838907/) 
	...
	``` 
	    # !/bin/bash
	    # Reto 4 Bash Shell by Antonio González
	    
	    opcion=0
	    opciones=("1.Procesos Actuales""2.Memoria Disponible""3.Espacio en Disco""4.Información de Red""5.Variables de Entorno Configuradas""6.Información Programa""7.Backup Información""8.Salir")
...
* **Diego Emanuel Ramirez** (1) [650965](https://platzi.com/comentario/650965/) 
	...
	```
	      1 # !/bin/bash
	      2 # Programa para ejemplificar la creación de archivos y directorios
	      3 # Autor: Diego Ramirez - @diegodev
	      4 
	     ...
	     21     ls -la $2
	     22 else
	     23     echo"No existe esa opción: $1"
	     24 fi
...
* **Luber** (1) [913466](https://platzi.com/comentario/913466/) 
	...
	Salida:
	``` 
	    Valores escritos conecho 
	    Valores conel comando cat
	    echo"Otra linea más"
	    asdasdadada
	           ...
	           "2") echo-e"\nIntroduzca el numero A: "
	            ...
	            "3")    echo-e"\n"
	                 ...
	                 "4") echo-e"\n"
	                      read -p "Ingrese la ruta de un directorio: " dirPath
	                      if [[ -d$dirPath  ]]; then
	                          echo"$DATE-$TIME --- Usuario consulta satisfactoriamente el directorio $dirPath" >> logs_reto6/$NEWFILEecho"El directorio $dirPath SI Existe"
...
* **Haroun Hussain Asto Rojas** (2) [511810](https://platzi.com/comentario/511810/) 
	...
	* **Juan Carlos Pinzón** [511810] (2)
		...
		El problema es que puedas leer bien STDOUTPUT de eso.
