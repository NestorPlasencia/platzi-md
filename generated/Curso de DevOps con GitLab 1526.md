...
* **CARLOS JULIAN RAMIREZ MILLAN** (2)
...
## 0030. El ciclo de vida del Devops
...
* **Jhonn Sebastian Quiroz Pirazan** (20)
...
* **josearturoperezenriquez** (1)

	
	Mejor explicación DevOps

* **Perla Godinez Castillo** (1)
...
* **Christopher Steven Fuentes Torres** (2)
...
* **Michael Alejandro Ura Acosta** (2)
...
* **CARLOS JULIAN RAMIREZ MILLAN** (3)

	
	necesito generar una SSH key por cada proyecto??

	* **David Aroesti (Platzi)** (2)
...
* **erasmojoseaurelioalcaidecazale** (2)
...
* **Ernesto Jose Gabriel Lopez Bravo** (5)
...
* **wilo087** (4)
	...
	* **Jose Ignacio Oyarzún Carrasco** (1)

		
		esta en la clase 10

* **erasmojoseaurelioalcaidecazale** (3)

	
	No me aparece la opcíón de internal para el grupo

	* **Ildebrando Mora Valdes** (1)
...
* **Juan Carlos Atanacio Quintero** (1)
...
* **Everson Vidal Mamani Huayta** (1)

	
	usaba Atlassian,
	  *[SaaS]: Software as a Service

* **Andrés Mauricio López Rojas** (1)
...
## 0120. Planificación en Gitlab-Issues
...
* **wilo087** (2)
	...
	* **Lindolfo Maximiliano Ayala Aguirre** (2)
...
* **Freddy Alexandro Gamboa Velasco** (1)
...
* **Jeisson Francois Rosas Céspedes** (1)
...
## 0130. Planificación en Gitlab-Etiquetas
...
## 0140. Planificación en Gitlab-Pesos
...
## 0150. Planificación en Gitlab-Milestones
...
* **Fernando Eladio Alvarez Noya** (5)
...
* **Freddy Alexandro Gamboa Velasco** (2)
...
## 0160. Planificación en Gitlab-Boards
...
* **hectormoreno7cd3c8ea72e34efe** (1)
...
## 0170. Planificación en Gitlab-Service Desk
...
## 0180. Planificación en Gitlab-Quick actions
...
## 0190. Inicialización del repositorio
...
* **David Andrey Rodríguez Zamora** (3)
...
* **Fernando Rocha Olivera** (1)
	...
	* **David Andrey Rodríguez Zamora** (2)
...
* **Jonathan Emmanuel Pumares Chab** (2)
...
* **Jonathan Emmanuel Pumares Chab** (1)
...
## 0210. Profundizando en Merge requests
...
## 0220. Continuous Integration-CI
...
## 0250. Validacion de la configuracion con GitLab Cl
...
* **JOSE DE JESUS USCANGA MOLINA** (4)
...
Hola, tengo un problema con el CI/CD, sucede que cuando hago push al remoto intenta iniciar los jobs, pero no se completan debido a que m...
	...
	* **Edgar Estuardo Dardón Rodríguez** (2)
...
## 0280. Implementando Gitlab pages
...
* **Victor Hugo Cornejo Calderon** (1)
...
## 0290. ¿Qué es el Desarrollo Ágil
...
## 0310. Implementando GitLab autodevops
...
No entiendo muy bien de donde sacaron el pipeline? podrian explicarme por favor
	...
	* **Yully Adriana Gamboa Contreras** (2)
...
## 0330. Introducción a contenedores
...
## 0340. Gitlab container registry
...
## 0370. Pruebas estáticas de seguridad
...
## 0400. Pruebas dinámicas de seguridad
...
## 0410. Gitlab security dashboard
...
## 0450. Estrategias de Distribución
...
## 0490. Métricas de desempeño (performance metrics)
...
## 0500. Métricas de salud (health metrics)
...
## 0530. ¿Por qué desarrollar con Gitlab
