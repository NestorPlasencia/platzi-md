...
* **dcortesnet** (2) [487414](https://platzi.com/comentario/487414/) 
	...
	* **abbustamante** [487414] (1)
		...
		La info la encontré en este link:[https://apiumhub.com/es/tech-blog-barcelona/principios-solid/](url)
...
* **Washington Antonio Delgado Neira** (1) [863654](https://platzi.com/comentario/863654/) 
	...
	* **Jhon Alexander Romero Gonzaga** [863654] (1)
		...
		**Para compilar java es:** javac nombre-del-archivo  
	...
	* **Jhon Alexander Romero Gonzaga** [863654] (2)
		...
		1.Primero hay que abrir la terminal (Ctrl+Alt+t).  
		  
		2\. Al parecer este problema se debe a unas entradas antiguas en la lista de los paquetes, que hay que borrar:  
		`sudo rm /var/lib/apt/lists/* -vf`  
		  
		3\. Ahora se actualizan las entradas y paquetes:  
		`sudo apt-get update`  
		  
		4\. Por último se actualizan los paquetes  
...
* [The Object-Oriented Thought Process Developer's Library: Amazon.es: Matt A. Weisfeld: Libros en idiomas extranjeros](https://www.amazon.es/Object-Oriented-Thought-Process-Developers-Library/dp/0321861272)
...
* **Carlos Orjuela** (1) [984504](https://platzi.com/comentario/984504/) 
	...
	Diseño del sistema. El diseñador del sistema toma decisiones de alto nivel sobre la arquitectura del mismo. El sistema se organiza en subsistemas basándose tanto en la estructura del análisis como en la arquitectura propuesta.
	
	Diseño de objetos. Construye un modelo de diseño basándose en el modelo de análisis, pero incorporando detalles de implementación. Se centra en las estructuras de datos y algoritmos que son necesarios para implementar cada clase.
...
* **laj-lukum** (1) [979475](https://platzi.com/comentario/979475/) 
	...
	Comportamientos del Objeto Perro  
	Ladrar  
	Comer  
	Dormir  
	Correr
...
* **Jose Luis Solarte Orozco** (1) [901187](https://platzi.com/comentario/901187/) 
	...
	y el **objeto** es la utilización de esa plantilla para organizar un conjunto de información.
	...
	* * *
	...
	EJEMPLO DE UN OBJETO DERIVADO (instanciado) DE LA CLASE PERRO
...
* **Cristian Alexander Osorio Martínez** (1) [896067](https://platzi.com/comentario/896067/) 
	...
	Las propiedades o atributos son los elementos que caracterizan al objeto. Son sustantivos que detallan algo relacionado al objeto como tamaño, forma, color, etc.
...
* **ervic_alexis** (1) [726491](https://platzi.com/comentario/726491/) 
	...
	**Propiedades** : tambien pueden llamarse atributos seran sustantivos.  
	...
	//  
	**Comportamientos** : seran todas las operaciones del objeto, suelen ser verbos o sustantivo y verbo.  
	Por ejemplo podriamos tener que un usuario que podria hacer login(), logout(), makeReport()
	
	
	
	Cuando estamos analizando un problema es importante entender el contexto de nuestros objetos.  
	//  
	Ejemplo objeto “conceptual”:  
	Servicio al cliente  
	Propiedades:
...
* **DubAvenXP** (1) [706541](https://platzi.com/comentario/706541/) 
	...
	Físicos: Puede ser cualquier objeto tangible como un usuario, una tarjeta, una bocina.  
	Conceptuales: Son objetos intangibles que solo viven en tu mente. Como el inicio de sesión, una transacción.
	
	Propiedades: Tambien pueden llamarse atributos serán Sustantivos: nombre, tamaño, forma o estado  
	El atributo es color y el resultado de este atributo es verde.  
	El atributo es nombre y el resultado de este atributo es Pedro.
	
	Comportamientos: Seran todas la operaciones del objeto, suelen ser verbos o sustantivo y verbo.  
	Un Usuario pueder tener un compartamiento de Login o Logout
...
Los comportamientos los podría asociar a un metodo ?? o no tiene nada que ver lo uno con lo otro? , gracias por aclararme esta inquietud
	...
	* **Moisés Cedeño** [72680] (2)
		...
		Objecto: Persona
		  ...
		  1. Atributos/propiedades: nombre, color, peso, cabello.
		  2. Métodos/Comportamiento: Molestarse, correr, bailar, caminar extraño.
		
		
		
		En la POO un objecto se componen de dos elementos:
		
		  1. Atributos / propiedades.
		  2. Métodos / acciones / comportamientos.
...
Cuál sería el contexto del objeto FACTURA DE VENTA. Cuáles serían algunas de sus propiedades y comportamientos?
	...
	* **Javier Alejandro Alamar Martínez** [52065] (1)
		...
		-Emisor  
		-Receptor  
		-Conceptos (o partidas) o bien productos comprados.  
		-Impuestos  
		-Comentarios  
		Comportamientos podrían ser  
		-Cancelar  
		-Emitir  
		-Verificar  
		-Almacenar  
...
* **calozano8** (2) [683356](https://platzi.com/comentario/683356/) 
	...
	**nombre** : _CuentaBancaria._  
	**atributos** : _numeroCuenta, balnce, fechaApertura, tipoCuenta_  
	**métodos** : _abrir(), cerrar(),retirar(),depositar()_
...
* **miguel-ramirez833** (1) [938242](https://platzi.com/comentario/938242/) 
	...
	``` 
	    ...
	    La moludaridad de nuestro código nos va a premitir:
	    -Reutilizar.
	    -Evitar colapso.
	    -Hacer nuestro codigo mas mantenible.
	    -Legibilidad.
	    -Resolución mas rápida de problemas.
...
Los diagramas UML de clases y objetos tiene que ver mucho con el modelo entidad relación de las bases de datos? al hacer el ejercicio de ...
	...
	* **Héctor Manuel Hernández Ortega** [75766] (3)
		...
		Los diagramas entidad relación se utilizan para representar la relación de la información dentro de una base de datos relacional.
...
![0.png](https://static.platzi.com/media/user_upload/0-40823920-f03b-4276-898b-95385f096cad.jpg)
...
* **Jharodip** (1) [1105409](https://platzi.com/comentario/1105409/) 
	...
	Albergue --> lugar de la acción y mantiene otros objetos (mascotas)  
...
* **Mónica Fidelín** (1) [1103852](https://platzi.com/comentario/1103852/) 
	...
	Adoptante:DocumentoIdentidad, nombre, edad, dirección, email  
...
* **Edgard Ernesto Ortiz Ortiz** (1) [1101707](https://platzi.com/comentario/1101707/) 
	...
	* Albergue  
	...
	-donante  
	-adoptante  
	-adopción(que es un objeto conceptual, que se encuentra durante todo el proceso)
...
* **Fausto Medina Lopez** (1) [1100581](https://platzi.com/comentario/1100581/) 
	...
	VacunaMascota: idMascota, idVacuna, fechaImplementacion, notas  
	Empleado: idEmpleado, nombre, apellido, numPIN, telefono, email, fechaInicio, fechaFinal, estado (activo o no)  
...
* **Yolanda Vasquez Aquino** (1) [1097550](https://platzi.com/comentario/1097550/) 
	  ...
	  4. animal:id,nombre,id_raza,color,id_tipo_animal,edad,tamaño,fecha_ingreso,observaciones,adoptado
	  5. raza:id,nombre
	  6. tipo_animal (perros, gatos,etc.):id,nombre
	  7. detalle_medico:id, id_animal,vacunas,estado
...
* **Marco Antonio Chire Rosas** (1) [1083663](https://platzi.com/comentario/1083663/) 
	...
	``` 
	    ...
	    <li>Donador</li>
	    <li>mascota</li>
	    <li>Documento de compromiso</li>
	    <li>Certificado de adopcion</li>
	    </ul>
	    </p>
...
* **santi-cardoso** (1) [1078082](https://platzi.com/comentario/1078082/) 
	...
	```
	    ...
	    2. Perro
	    3. Comida que le compraran
	    4. Planilla de vacunacion
	    5. Casa donde vivira el perro
...
* **axlina90** (1) [1073450](https://platzi.com/comentario/1073450/) 
	...
	Buenas tardes, mi respuesta del reto es:
	  ...
	  1. Mascota (Perro).
	  2. Persona que lo va adoptar (Dueño).  
	3.Lugar de Adopción (Clinica, Albergue)
	  3. Encargado.
	  4. Documento de Adopción
...
* **Rafel Torres** (1) [1060698](https://platzi.com/comentario/1060698/) 
	...
	**Animal** fisico  
	\- Tipo ( perro / gato / hámster )  
	> (nombre, edad, raza, genero)  
	> (vacunas, esterilización )  
	**Adopción** conceptual  
	> (fecha, hora, cédula)  
	**Donación** conceptual  
...
* **Jesus Velez Flores** (1) [1039552](https://platzi.com/comentario/1039552/) 
	...
	*Encargado(quien entrega el perrito)  
	*Tramite(proceso de adopcion)  
	*Certificado(comprobante de adopcion)  
...
* **Saul Omar** (1) [1027393](https://platzi.com/comentario/1027393/) 
	...
	*Carnet_Adopción  
	*Gerente  
	*Trabajadores_albergue  
	*Veterinario  
	*Carnet_Cuidados_Especiales  
	*Adoptante
...
* **Omar Erick Alban Becerra** (0) [1070911](https://platzi.com/comentario/1070911/) 
	...
	*Casa de Adopción (Información de la adopción)
...
* [Requisitos para los vehículos en la Ciudad de México | Uber](https://www.uber.com/es-MX/drive/mexico-city/vehicle-requirements/)
...
* **mael358** (7) [784109](https://platzi.com/comentario/784109/) 
	...
	* **michaelandresmierpito** [784109] (2)
		...
		USUARIOS.  
		RUTA  
		TIPOS DE AUTOS: UBER X, POOL, BAND,BLACL  
		DRIVER  
		TARIFA  
		VIAJE
...
* **Sebastián Pineda Duque** (1) [575202](https://platzi.com/comentario/575202/) 
	...
	* **Jose Armando Acevedo Angarita** [575202] (1)
		...
		para resolverlo es de esta manera:  
		Usuario{  
		id:123,  
		name:“Jose”,  
		lastname:"Armando"  
...
* **Ulzahk** (5) [959790](https://platzi.com/comentario/959790/) 
	...
	Acá realice unos con [Draw.io](http://Draw.io), los compartirlo por si le es útil a alguno de los compañeros
	  ...
	  1. Clase Account  
	![Diagrama-Herencia-Clase-Account.PNG](https://static.platzi.com/media/user_upload/Diagrama-Herencia-Clase-Account-45216a41-3794-4bb3-8041-c4295c8d6b92.jpg)
	  2. Clase Payments  
	![Diagrama-Herencia-Clase-Payments.PNG](https://static.platzi.com/media/user_upload/Diagrama-Herencia-Clase-Payments-dca2dc96-1be0-4d0b-8fb2-ee45a73c6489.jpg)
	  3. Clase Car  
	![Diagrama-Herencia-Clase-Car.PNG](https://static.platzi.com/media/user_upload/Diagrama-Herencia-Clase-Car-85ee6ae5-2645-4924-83b6-7df2bc55d033.jpg)
	  4. Diagrama Uber  
	![Diagrama-Uber.PNG](https://static.platzi.com/media/user_upload/Diagrama-Uber-795f19ea-ce23-4608-8398-a990e874d4e6.jpg)
...
* **Manuel Rivera** (2) [1014463](https://platzi.com/comentario/1014463/) 
	...
	```
	    classPets{
	      constructor(id, name, age, color, size, weight, vaccines, kind) {
	        this.id = id;
	        this.name = name;
	        this.age = age;
	        this.color = color;
	    ...
	    classPericoextendsPets{
	      constructor(specie) {
	        this.specie = specie;
	      }
	    }
	    
	    classLoroextendsPets{
	      constructor(specie) {
	        this.specie = specie;
	      }
	    }
	    
	    classGatoextendsPets{
	      constructor(breed) {
	        this.breed = breed;
	      }
	    }
	    
	    classHamsterextendsPets{
	      constructor(breed) {
	        this.breed = breed;
	      }
	    }
	    
	    classPerroextendsPets{
	      constructor(breed) {
	        this.breed = breed;
	      }
	    }
...
* **Jose Luis Solarte Orozco** (2) [903107](https://platzi.com/comentario/903107/) 
	...
	**para los ubuntu pueden utilizar el programa **Umbrello**.  
	Lo pueden instalar con este comando:
	``` 
	    <sudo snap install umbrello>
	    
	```
	
	si les aparece que no tenían instalado snap (un sistema de paquetes compatible con todas las distribuciones linux)  
	lo pueden instalar asi:
	``` 
	    <sudo apt update>
	...
	[tomado de](https://snapcraft.io/install/umbrello/ubuntu)  
	[pagina oficial del proyecto umbrello](https://umbrello.kde.org/)
...
* **Carlos Francisco Aparicio Rojas** (1) [1093169](https://platzi.com/comentario/1093169/) 
	...
	Super Clase  
	Usuarios  
	+Id, +documento, +sexo, +email, +teléfono, +nombre
	``` 
	    					       Subclase de Usuarios
	    Funcionario Tramitador   |     Funcionario Aprobación    |    Adoptante
	    +Cargo				    +Cargo                                 +Dirección Residencia
	...
	``` 
	    						Mascotas
	    	+Id, +Color, +Raza, +Sexo, +Edad, +Tipo, +Id Adoptante
...
* **Ulzahk** (1) [967239](https://platzi.com/comentario/967239/) 
	...
	![Adoption-System-Diagram.PNG](https://static.platzi.com/media/user_upload/Adoption-System-Diagram-c8f0ba24-03d2-4171-a651-d73e5ca4aa53.jpg)
	  2. Clase Account  
	  
	![Account-Class.PNG](https://static.platzi.com/media/user_upload/Account-Class-878f4168-5d11-49e5-b465-993d10e16309.jpg)
	  3. Clases Documents y Adopt  
	  
	![Documents-and-Adopt-Classes.PNG](https://static.platzi.com/media/user_upload/Documents-and-Adopt-Classes-f8bd746f-4120-4e8a-b192-5f60ea134b7f.jpg)
	  4. Clase Pets  
	  
	![Pets-Class.PNG](https://static.platzi.com/media/user_upload/Pets-Class-ac713e43-fdc0-4201-ab86-bf70679e2783.jpg)
...
* **Nicolás Mayorga Vargas** (1) [892607](https://platzi.com/comentario/892607/) 
	...
	Class Perro / Sub clase  
	raza
	
	Class gato / Sub clase  
	raza
	
	Class Perico / Sub clase  
	tamaño
...
* **sergioabelgordondolimpio** (1) [882067](https://platzi.com/comentario/882067/) 
	...
	Superclase: mascotas
	  ...
	  4. Hamsters  
	Superclase personas
	  5. Persona que adopta
	  6. Empleado de veterinaria  
	Veterinaria  
	Adopcion
...
* **Andrea Fuentes Castellanos** (1) [859803](https://platzi.com/comentario/859803/) 
	...
	**-user (Datos comunes de los usuarios del sistema) - > Superclase**  
	...
	-adopter (Hereda de user - Quien solicita una adopción)
	
	**-pet (Datos comunes de los animales) - > Superclase**  
	-dog (Hereda de pet)  
	-cat (Hereda de pet)  
	-bird_type(Un enum con los tipos de aves)  
	-bird (Hereda de pet y tiene una relación por asociación con bird_type)  
	-rodent_type(Un enum con los tipos de roedores)  
	-rodent (Hereda de pet y tiene una relación por asociación con rodent_type)
...
Hola a todos No he podido adjuntar la imagen, alguien me puede ayduar por favo. Gracias.
	...
	* **aragonesteban (Platzi)** [56505] (1)
		...
		![Titulo de la imagen](url de la imagen)
...
* **Marcelo Sanchez** (0) [983045](https://platzi.com/comentario/983045/) 
	...
	**Clase usuario:**  
	![](https://i.imgur.com/0ZrWViN.jpg)
	
	**Clase Adopcion:**  
	![](https://i.imgur.com/AJa83v2.jpg)
	
	**Clase Donacion:**  
	![](https://i.imgur.com/jzKJUpE.jpg)
	
	**Clase animal:  
	**![](https://i.imgur.com/Nc6FLxT.jpg)
...
* [Curso de Programación Estructurada | Materiales](https://platzi.com/clases/programacion-estructurada/)
...
* **joaquin-fontela** (2) [1017127](https://platzi.com/comentario/1017127/) 
	...
	* **josedanielhq37** [1017127] (2)
		...
		Para abrir el Debug console puedes hacer cualquiera de estas tres opciones:
		  ...
		  2. Arriba en herramientas, darle click a la opción “Debug” y click en “Start Debugging”
...
* **Ulzahk** (1) [969464](https://platzi.com/comentario/969464/) 
	...
	Gracias por la explicación de cómo manejar la creación de clases de estos dos lenguajes instructora Anahi. Me pareció Interesante los atajos de acciones de Visual Studio Code y aquí dejo los que me funcionaron en Windows:
	  ...
	  2. Alt + flecha del teclado mueve la línea que hayas seleccionado a la posición de otra.
	  3. Ctrl + Alt + flecha teclado mueves pestañas y creas divisiones más pequeñas.
	  4. Shift + Inicio: para seleccionar desde ese punto de la línea hasta su principio.
	  5. Shift + Fin: para seleccionar desde ese punto de la línea hasta su final
...
* **EdwinCrP** (1) [819388](https://platzi.com/comentario/819388/) 
	...
	EDWIN te quiero  
	PS C:\Users\DELL 3000\Documents\POO_1> cd ‘c:\Users\DELL 3000\Documents\POO_1’; & ‘C:\Users\DELL 3000.vscode\extensions\vscjava.vscode-java-debug-0.23.0\scripts\launcher.bat’ ‘C:\Program Files\Java\jdk1.8.0_221\bin\java’ ‘-Dfile.encoding=UTF-8’ ‘-cp’ ‘C:\Users\DELL 3000\AppData\Roaming\Code\User\workspaceStorage\0da6cfa0bb1e320b53eb7e9503afe53b\redhat.java\jdt_ws\jdt.ls-java-project\bin’ 'Main’  
	EDWIN te quiero  
	PS C:\Users\DELL 3000\Documents\POO_1> cd ‘c:\Users\DELL 3000\Documents\POO_1’; & ‘C:\Users\DELL 3000.vscode\extensions\vscjava.vscode-java-debug-0.23.0\scripts\launcher.bat’ ‘C:\Program Files\Java\jdk1.8.0_221\bin\java’ ‘-Dfile.encoding=UTF-8’ ‘-cp’ ‘C:\Users\DELL 3000\AppData\Roaming\Code\User\workspaceStorage\0da6cfa0bb1e320b53eb7e9503afe53b\redhat.java\jdt_ws\jdt.ls-java-project\bin’ 'Main’  
	EDWIN te quiero  
...
![Captura de pantalla 2019-01-13 a la\(s\) 2.56.24.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-13%20a%20la%28s%29%202.56.24-f11c0607-b11e-425f-aafe-05a11ae8c3f8.jpg)

## Car.js

![Captura de pantalla 2019-01-13 a la\(s\) 2.56.34.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-13%20a%20la%28s%29%202.56.34-a046c5f8-3e4e-4339-88a2-f4a610295155.jpg)

## Payment.js

![Captura de pantalla 2019-01-13 a la\(s\) 2.56.41.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-13%20a%20la%28s%29%202.56.41-4f859f05-797a-42da-a12d-899d99abb08c.jpg)

## Route.js

![Captura de pantalla 2019-01-13 a la\(s\) 2.56.56.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-13%20a%20la%28s%29%202.56.56-09463e4b-c572-4803-9ed7-4232bcfc9589.jpg)
...
* **Bryan Ignacio Vera Cabanilla** (1) [1081002](https://platzi.com/comentario/1081002/) 
	...
	`<?php class Account{ public $id; public $name; public $document; public $email; public $password; } ?>`  
	Car
	
	`<?php class Car{ public $id; public $license; public $driver; public $passenger; }; ?>`
...
* **Martín Chalén Chang** (1) [1072052](https://platzi.com/comentario/1072052/) 
	...
	Accoount:  
	![](http://www.aquigps.com/accountphp.png)
	
	Car:  
	![](http://www.aquigps.com/carphp.png)
	
	Payment:  
	![](http://www.aquigps.com/paymentphp.png)
...
* **Christian Ricardo Conchari Cabrera** (1) [918771](https://platzi.com/comentario/918771/) 
	...
	![car.jpg](https://static.platzi.com/media/user_upload/car-4e2b9719-6dfb-4111-8818-0e1d894c65bc.jpg)  
	Payment.php:
	
	![payment.jpg](https://static.platzi.com/media/user_upload/payment-e38c595c-ccdd-4332-b2fe-193c276ce2e7.jpg)  
	Route.php:
...
* **Decgar** (1) [914243](https://platzi.com/comentario/914243/) 
	...
	**Car.php:**
	...
	![Clase19_Car_PHP.PNG](https://static.platzi.com/media/user_upload/Clase19_Car_PHP-844313e5-a843-469e-be18-706e22c71ba0.jpg)
	
	**Payment.php:**
	
	![Clase19_Payment_PHP.PNG](https://static.platzi.com/media/user_upload/Clase19_Payment_PHP-33349f5d-300e-49e0-a1ec-c83c240dcb5c.jpg)
...
* **oscarbeta** (1) [867896](https://platzi.com/comentario/867896/) 
	...
	?>  
	Así con las demás, excepto la de Route.php :  
	<?php  
	class Route {  
	public $id;  
	public $init = array();  
...
* **Javi Felices** (1) [765630](https://platzi.com/comentario/765630/) 
	...
	Las de PHP es igual, tan solo que para la clase `Route`, en vez de indicar `array()` he puesto `[]`, que se puede poner a partir de la versión 5.4, según he podido leer.
...
* **mkitivenic** (0) [747205](https://platzi.com/comentario/747205/) 
	...
	**Account.php**
	...
	![Account.jpg](https://static.platzi.com/media/user_upload/Account-4be4a26f-0338-481a-bd39-d72b778cadde.jpg)
	
	**Car.php**
	
	![Car.jpg](https://static.platzi.com/media/user_upload/Car-c6014e47-4f01-464f-ac13-639be030c2df.jpg)
	
	**Payments.php**
	
	![Payments.jpg](https://static.platzi.com/media/user_upload/Payments-cec24dda-b519-4712-b50c-0bfe3f9b6beb.jpg)
	
	**Route.php**
	
	![Route.jpg](https://static.platzi.com/media/user_upload/Route-421ba0d4-ee16-48fb-bff2-efb1dfe0ca8d.jpg)
...
<h1> **JAVA** </h1>
	...
	``` 
	    ...
	    def__init__(self,id,name,document,email,password):
	        self.id=id
	        self.name       =name
...
* **Luisa Carolina Osorio Restrepo** (3) [598946](https://platzi.com/comentario/598946/) 
	...
	* **Abdel Mejia** [598946] (1)
		...
		``` 
		    publicConstructor()
		    {
		    	Console.WriteLine("Soy un Constructor");
		    }
		```
...
* **Nikogarcia11** (1) [871450](https://platzi.com/comentario/871450/) 
	...
	* **Jhon Alexander Romero Gonzaga** [871450] (1)
		...
		Este es un ejemplo con JavaScript en el cual el **this** hace referencia a su padre.
		``` 
		    this//Aquí el this hace referencia a la ventana del navegador que es donde se ejecuta el código.
		    
		    functionPersona(nombre){
		    	this.nombre = nombre  //Aquí el this toma como referencia a la clase Persona().
		    }
	...
	* **Paul Cortes** [871450] (1)
		...
		**this** tambien puede ser interpretado como **yo** , ya que son objetos que nacen por ejemplo
		...
		asi que cuando se llaman metodos se le esta preguntando a esa persona por ejemplo, se le dice dame tu fecha de tu cumpleaños seria
		
		![Explicacion_THIS_2.png](https://static.platzi.com/media/user_upload/Explicacion_THIS_2-3f4b4a8f-722d-421b-a6b7-02b0af3aee56.jpg)
		
		para el objeto decir **mi nombre** seria **this.nombre**
...
* **michaelandresmierpito** (1) [852798](https://platzi.com/comentario/852798/) 
	...
	Person: Nombre del método, tiene que ser el mismo nombre de la clase  
	String name: Atributos.  
	[This.name](http://This.name) pasamos atributos.  
	...
	PYTHON:  
	Palabra reservada: self, (name) todos los atributos.  
...
* **michaelandresmierpito** (1) [852183](https://platzi.com/comentario/852183/) 
	...
	JAVA:  
	Public: Modificador de acceso  
	Person: Nombre del metodo, tiene que ser el mismo nombre de la clase  
	String name: Atributos.  
	[This.name](http://This.name) pasamos atributos.  
	Public Person (String name){  
	[This.name](http://This.name) =name;  
...
* **edwin Pardo** (1) [570771](https://platzi.com/comentario/570771/) 
	...
	public class Clase1(){ //Calse1 = Nombre de la Clase  
	int nombre; //nombre = Creamos un atributo
	
	public Clase1(int nombre){ //Constructor que inicializa la variable nombre  
	this.nombre = nombre; //No retorna ningun dato  
	}  
	}
...
* **alejandro-bagnat** (1) [487926](https://platzi.com/comentario/487926/) 
	...
	* **Miguel Gil Rosas** [487926] (1)
		...
		Estás declarando una propiedad del tipo Person que se llama person, pero no la estás inicializando, para inicializarla o darle valor:
		``` 
		    person = new Person();
...
* **TANIA ALEJANDRA VAZQUEZ AGUILAR** (2) [790108](https://platzi.com/comentario/790108/) 
	...
	* **mael358** [790108] (1)
		...
		``` 
		    $ javac nombre_documento.java
		    
		```
		
		Luego va a generar un archivo .class
		``` 
		    $ java documento.class
...
* **michaelandresmierpito** (1) [888585](https://platzi.com/comentario/888585/) 
	...
	``` 
	    void printDataRoute(){
	        ...
	        System.out.println("ROUTE START "+ start.get(0) +" " );
	        System.out.println("ROUTE END "+end.get(0) + " ");
	        System.out.println("  ");
	    }
	...
	``` 
	    public static void main(String[] args) {
	         Car auto = new Car();
	            auto.driver = "ANDRES MIER";
	            auto.id = 100;
	            auto.licence = "AMD-1234";
	            auto.passenger = 4;
	            auto.printDataCar();
	         Car auto2 = new Car();
	            auto2.driver = "MATIAS MIER";
	            auto2.id = 101;
	            auto2.licence = "ABC-1234";
	            auto2.passenger = 4;
	            auto2.printDataCar();
	         
	         Account cuenta = new Account();
	         cuenta.id = 200;
	         cuenta.document = "ACC-200";
	         cuenta.email = "mmier@uber.com";
	         cuenta.name = "JUAN ARELLANO";
	         cuenta.password = "1234";
	         cuenta.printDataAccount();
	        
	         Payment pago = new Payment();
	         pago.id = 300;
	         pago.value = 230.22;
	         pago.printDataPayment();
	    
	         Route  ruta = new Route();
	         ruta.id = 400;
	         ruta.end.add(1220.22);
	         ruta.start.add(1220.22);
	         ruta.printDataRoute();
...
* **michaelandresmierpito** (1) [852952](https://platzi.com/comentario/852952/) 
	...
	password = str
	``` 
	    def printAccountData(self, id,name,document,email):
	         print (" ACCOUNT ID ",id, " ACCOUNT NAME ",name, " ACCOUNT  DOCUMENT ",document, " ACCOUNT EMAIL ",email)
	...
	``` 
	    car = Car ()
	    car.licence = "AUTO1234"
	    car.driver = "ANDRES MIER"
	    car.passenger = 4
	    car.id = 100
	    car.printCarData(car.licence, car.driver, car.passenger,car.id)
	    
	    account = Account ()
	    account.id = 100
	    account.name = "LUIS ROJAS"
	    account.document= "1001002"
	    account.email = "luis.joras@uber.com"
	    account.printAccountData( account.id, account.name, account.document,account.email)
	    
	    payment = Payment()
	    payment.id = 100
	    payment.printPaymetData(payment.id)
	    
	    route = Route ()
	    route.id = 120
	    route.start= 122.22
	    route.end= 100.122
	    route.printRoutetData(route.id, route.start,route.end)
...
* **michaelandresmierpito** (1) [852913](https://platzi.com/comentario/852913/) 
	...
	``` 
	    public static void main(String[] args) {
	          ...
	          Account cuenta = new Account();
	          cuenta.document = "1234";
	          cuenta.email = "mmier@imp.com";
	          cuenta.name = "Andres Mier";
	          cuenta.printdataAc();
	          System.out.println(" ");
	         
	          Car vehiculo = new Car ();
	          vehiculo.licence = "auto-123";
	          vehiculo.driver = "ANDRES LOPEZ";
	          vehiculo.passenger = 5;
	          vehiculo.id = 100;
	          vehiculo.printDataCar();
	          System.out.println(" ");
	          ...
	          Route ruta = new Route ();
	          ruta.identifier = 110;
	          //ruta.start.add = (113.234);
	          //ruta.end.add = (113.234);
...
* **Emmanuel Lopez** (1) [765615](https://platzi.com/comentario/765615/) 
	...
	```
	    ...
	    hola mundo
	    {'license': 'AMB325', 'driver': 'Carlitos Lopez'}
	    {'license': 'WER256', 'driver': 'LILI Armiba'}
...
* **carlosmora_biz** (1) [743249](https://platzi.com/comentario/743249/) 
	...
	Pero funciona al correrlo. Inclusive me funciona si estoy en la carpeta raiz del proyecto.
	
	Si lo importo con .car (antecediendo el punto), el editor no me muestra ninguna alerta, y solo se ejecuta si primero me paro en la consola directamente en el directorio “python”. Si lo llamo desde otra ruta (ejm desde la raiz del proyecto con python python/main.py) me muestra este error:
	``` 
	    python CursoPOOUber/python/main.py                                                                      
	    Traceback (most recent calllast):
	      File"CursoPOOUber/python/main.py", line 1, in <module>
	        from .car import Car
	    ValueError: Attempted relativeimportin non-package
...
* **Manuel Mosquera** (1) [553730](https://platzi.com/comentario/553730/) 
	...
	* **calozano8** [553730] (1)
		...
		``` 
		    C:\Users\clozano>python
		    Python 3.7.0a1 (v3.7.0a1:8f51bb4, Sep 192017, 19:32:44) [MSC v.190064bit (AMD64)] on win32
	...
	* **Emmanuel Lopez** [553730] (1)
		...
		el “ _main_ ” esta mal declarado, se deben poner 2 guiones bajos en vez de uno,
		``` 
		    if __name__=="__main__"
...
* **esme** (1) [547163](https://platzi.com/comentario/547163/) 
	...
	```
	    classCar:
	        ...
	        def__str__(self):
	            text = 'License: {0}'
	            return text.format(self.license)```
	    Sobrescribí el método str de "Car" en main.py, para poder usar: **print(car)** en Car.py
	    y la salida en consola es distinta:
...
* **Falconunknown** (1) [497257](https://platzi.com/comentario/497257/) 
	...
	Y aparte observo que, no me muestra la opción RUN que sale en el video, y esa opción creo que le permite ejecutar directamente el archivo java.
...
* **Leandro Santiago Batista** (3) [986701](https://platzi.com/comentario/986701/) 
	...
	``` 
	    ...
	    namespace Uber.Clases
	    {
	        publicclass Account
	        {
	            public int id;
	            publicString name;
	            publicStringdocument;
	            publicString email;
	            publicString password;
	    
	            public Account(String name, Stringdocument)
	            {
	                this.name = name;
	                this.document = document;
	            }
	...
	``` 
	    ...
	    namespaceUber.Clases
	    {
	        ...
	        publicCar(String license, Account driver)
	         {
	             this.license = license;
	             this.driver = driver;
...
Hola, que significa en sí el método constructor o para que me sirve??? Muchas gracias por su respuesta.
	...
	* **hello_diego** [84009] (2)
		...
		Lo que hay despues de la palabra reservada new es el contructor de la clase, y puede tener o no argumentos en caso de que los tenga significa que inicalizara el objeto con los valores que le pases
		``` 
		    publicclass Humano {
		...
		Entonces para crear un objeto de esa clase escribirias algo asi:
		``` 
		    Humano hum = new Humano("Jose", 23);
		    
		```
		
		Como ves el objeto creado con ese contructor tiene los valores de nombre = Jose y edad = 23
...
* **Emmanuel García** (1) [1092961](https://platzi.com/comentario/1092961/) 
	...
	* **ThAlan** [1092961] (2)
		...
		Ahora, esto pasa cuando lo hacemos con funciones normales.
		``` 
		    Book.prototype.list = function() {
		      return this.name
		    }
		    
		    console.log(myBook.list()); // Harry Potter
		    
		```
		
		Y esto con arrow functions.
		``` 
		    Book.prototype.list = () => {
		      returnthis.name
		    }
...
* **Juan Vicente Cordero** (1) [1072598](https://platzi.com/comentario/1072598/) 
	...
	Descripción: Run C, C++, Java, JS, PHP, Python, Perl, Ruby, Go, Lua, Groovy, PowerShell, CMD, BASH, F#, C#, VBScript, TypeScript, CoffeeScript, Scala, Swift, Julia, Crystal, OCaml, R, AppleScript, Elixir, [VB.NET](http://VB.NET), Clojure, Haxe, Obj-C, Rust, Racket, Scheme, AutoHotkey, AutoIt, Kotlin, Dart, Pascal, Haskell, Nim,  
	Versión: 0.9.17  
	Editor: Jun Han  
...
* **Franklin Ramírez** (1) [1059901](https://platzi.com/comentario/1059901/) 
	...
	``` 
	    <body>
	        <scriptsrc="Account.js"></script>
	        <scriptsrc="index.js"></script>
	        <scriptsrc="Car.js"></script>
	    </body>```
...
A partir de las nuevas especificaciones del EcmaScript 6 ya podemos declarar una clase con la palabra reservada _class_ , aunque es importante aclarar que estos no dejan de ser prototipos, sino todo lo contrario.
...
![1.png](https://static.platzi.com/media/user_upload/1-66a6be76-e42f-479c-be67-3adc45ccd7db.jpg)

Si quisiéramos declarar un método, en esta nueva sintaxis dejaremos de utilizar la palabra clave _function_.

Ahora veamos a la clase **Account** :

![2.png](https://static.platzi.com/media/user_upload/2-2ccbff18-3961-4b42-89ad-3c232a8f1af4.jpg)

Y para finalizar aquí puedes ver las clases **Route** y **Payment** :

![3.png](https://static.platzi.com/media/user_upload/3-e0aac592-7edb-41cf-840f-63628c815201.jpg) ![4.png](https://static.platzi.com/media/user_upload/4-431f9596-35af-4b45-8021-7f0d15258259.jpg)

Notarás que para instanciar un objeto seguiremos usando la palabra clave _new_.

![5.png](https://static.platzi.com/media/user_upload/5-0a9e302c-9376-495e-a2e2-171a1f17f988.jpg)

Y los resultados serán los mismos:

![6.png](https://static.platzi.com/media/user_upload/6-26a92034-dd3b-42a2-94ea-ceaeaf5e1d9f.jpg)
...
* **Manuel Mosquera** (3) [554194](https://platzi.com/comentario/554194/) 
	...
	![ClassCarWithConstructor.PNG](https://static.platzi.com/media/user_upload/ClassCarWithConstructor-0762ce8d-38af-4899-8ba7-b3d87db06a19.jpg)
...
* **michaelandresmierpito** (2) [857976](https://platzi.com/comentario/857976/) 
	...
	var account = new Account(“ACC-001”,“USER [1",“DOC100”,"mmmmm3@outlook.es](mailto:1%22,%22DOC100%22,%22mmmmm3@outlook.es)”,“PASS” );  
...
* **georgehossa** (2) [531295](https://platzi.com/comentario/531295/) 
	...
	* **AlexGarrixen** [531295] (2)
		...
		*Importando desde otro archivo :
		...
		const miClase = require(’…/utils/classExample’)  
...
![Captura de pantalla 2019-01-21 a la\(s\) 1.16.43.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-21%20a%20la%28s%29%201.16.43-c55250b1-a09b-4025-b263-c09ae7364008.jpg)

Ahora veamos la clase Car:

![imagen.png](https://static.platzi.com/media/user_upload/imagen-f683eb2d-6a0a-44c7-a32c-92a0cbce962b.jpg)
...
![Captura de pantalla 2019-01-21 a la\(s\) 1.17.11.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-21%20a%20la%28s%29%201.17.11-72be8450-fa7f-4030-9987-ffb098c4d46c.jpg)

Observa que estamos importando las dos clases que usaremos y las estamos instaciando en los métodos constructores.

Los resultados serán los siguientes:

![Captura de pantalla 2019-01-21 a la\(s\) 1.14.06.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-21%20a%20la%28s%29%201.14.06-613a190d-a678-490c-a010-81150b4b883f.jpg)
...
Ahora que ya viste cómo creamos un método constructor en Python, mira esta clase <https://platzi.com/clases/1338-php/12930-constructor-y-metodos/> y **hazlo también para PHP**. Compártenos tus resultados en la sección de discusiones.
...
* **mkitivenic** (6) [747584](https://platzi.com/comentario/747584/) 
	...
	**Clase Index.php**  
	...
	![Index.jpg](https://static.platzi.com/media/user_upload/Index-fbb4fee7-82aa-4d68-8957-562c402796e3.jpg)
	
	**Clase Account**
	
	![Account.jpg](https://static.platzi.com/media/user_upload/Account-449f2f26-e43f-4183-b246-0cef699f8dcb.jpg)
	
	**Clase Car**  
	require_once ‘Account.php’;  
	![Car.jpg](https://static.platzi.com/media/user_upload/Car-c279bef9-9a72-4052-99e0-1da5097fd109.jpg)
...
* **Fabisuper** (3) [820027](https://platzi.com/comentario/820027/) 
	...
	Servidor:  
	![Servidor php.jpg](https://static.platzi.com/media/user_upload/Servidor%20php-31f95bd4-aa52-46ac-aa77-d00336e39125.jpg)  
	Proyecto index.php:  
	![index php.jpg](https://static.platzi.com/media/user_upload/index%20php-d3d69025-d3dc-4f0a-ad22-aecb3ba48ded.jpg)  
...
* **Ambar de Alejandria** (2) [592889](https://platzi.com/comentario/592889/) 
	...
	Class Car  
	![](https://www.evernote.com/l/AkOKBAUIz9NLOqGjmKWjtIdmTR5i2tU7zAMB/image.png)
...
* **Manuel Mosquera** (2) [554284](https://platzi.com/comentario/554284/) 
	...
	**Account.php**  
	![AccountPHP.PNG](https://static.platzi.com/media/user_upload/AccountPHP-8ffcd396-7714-45ad-81f7-4a9c1cb5a979.jpg)
	
	**Car.php**
	
	![CarPHP.PNG](https://static.platzi.com/media/user_upload/CarPHP-06f0ec70-69cb-4232-9100-64fbac91c887.jpg)
...
* **tonyoz** (1) [1112995](https://platzi.com/comentario/1112995/) 
	...
	print(“HOLAA???”);  
	$car = new Car(“ASD123”, new Account(“Tony”, “12345”));  
	$car->passenger = 6;  
	$car->printDataCard();
	``` 
...
* **Alvaro Arturo** (1) [1076412](https://platzi.com/comentario/1076412/) 
	...
	![error 2.png](https://static.platzi.com/media/user_upload/error%202-794e7df4-22a0-412e-af7b-d2c3bc3cf84a.jpg) ![error 1.png](https://static.platzi.com/media/user_upload/error%201-17bd87c2-8534-4f04-94ba-ca1d51316943.jpg) ![error 3.png](https://static.platzi.com/media/user_upload/error%203-e26c7774-9c73-4953-9465-3eef822302c9.jpg)
	
	Me puse a cacharrear y obtuve la siguiente solucion, no se si este bien pero quito el error, quisiera algo de retroalimentacion. gracias.
...
* **David Alejandro Mosquera Moreno** (1) [1075635](https://platzi.com/comentario/1075635/) 
	...
	**Car**
	...
	require_once (‘Account.php’);
	``` 
	    $car = new Car("AAA 123", new Account("David","Mosquera"));
	    $car->printDataCar();
...
* **Julio Cesar de la Lima López** (1) [1065144](https://platzi.com/comentario/1065144/) 
	...
	``` 
	    ...
	    class Car
	    {
	        ...
	        public function __contruct($license,Account $driver){
	            $this->license = $license;
	            $this->driver = $driver;
	        }
	...
	``` 
	    <?php
	        ...
	        $car = new Car('QRO123',new Account('Julio de la Lima','LIL123'));
	        $car->printDataCar();
	    ?>
...
* **cristhiancoaquira** (1) [1050432](https://platzi.com/comentario/1050432/) 
	...
	``` 
	    ...
	    class Car  
	    {
	      ...
	      public function printDataCar() {
	        print 'Car license :' . $this->license;
	        print 'Driver name: ' . $this->driver->name;
	      }
	    }
	...
	``` 
	    ...
	    require_once './Car.php';
	    require_once './Account.php';
	    $car = new Car('DaDaS-001', new Account('Cristhian Coaquira', '12345678'));
	    $car->printDataCar();
...
* **Carlos Eduardo Repillosa Del Valle** (1) [1021459](https://platzi.com/comentario/1021459/) 
	...
	``` 
	    <?php
	        ...
	        echo"<h1>Prueba de Funciones y Contructores en PHP</h1>";
	    
	        $car1 = new Car('AA156KG',new Account('Carlos Repillosa',18087611),5);
	...
	``` 
	    <?php
	        class Car{
	            ...
	            public function printDataCar(){
	                echo "License: " . $this->license . ", Driver: " . $this->driver->name . ", Driver Document: " . $this->driver->document . ", Passenger: " . $this->passenger;
	            }
	        }
	    ?>
...
* **luis-e-chitala** (1) [1006513](https://platzi.com/comentario/1006513/) 
	...
	``` 
	    ...
	    echo "<h2> Bienvenido al ejemplo de objetos en PHP</h2>";
	    
	    $car = new Car("AMS123", new Account("Andres Herrera", "AMS123"));
	    $car->printDataCar();
...
* **ivandario_treack** (1) [991488](https://platzi.com/comentario/991488/) 
	...
	``` 
	    ...
	    echo "<h1> programacion orientada a objetos PHP</h1>";
	    
	    $car = new Car("ALS145", new Account("Andres Herrera", "ANDA875"));
	    $car->printDataCar();
...
* **alexabellerman** (1) [987994](https://platzi.com/comentario/987994/) 
	...
	```
	    <?php 
	       ...
	       $car = new Car("FIN789", "Andrés Herrera");
	       $car->printDataCar();
	    ?>
...
* **Miguel Torres** (1) [983370](https://platzi.com/comentario/983370/) 
	...
	``` 
	    ...
	    $car = new Car('AMS234', new Account('Andres Herrera', 'AND1234'));
	...
	``` 
	    <?php
	    require_once 'Account.php'; //Importando clase con dependencias
	    
	    class Car { //Declaración de clase
	        public $id;
	        public $license;
	        public $driver;
	        public $passenger;
	    
	        public function __construct($license, $driver){ //Método constructor
	         $this->license = $license;
	         $this->driver = $driver;
	        }
	    
	        public function printDataCar(){ //Método de la clase
	            echo "Name Driver: ". $this->driver->name;
	...
	/windir/c/Users/migue/CursoPOOUber/PHP » php index.php miguel@migueltorresPC  
	Hola Mundo  
	...
	``` 
	    <?php
	        class Car
	        {
	            ...
	            public function printDataCar()
	            {
	                echo("License: $license<br>Driver: $driver->$name<br>Passengers: $passengers");
	            }
	        }
	    ?>
	...
	``` 
	    ...
	    <body>
	        <?php
	            ...
	            $car = new Car("AMQ123", $driver = new Account("Andrés Herrera", "AND123"));
	            $car->$passengers = 3;
	            echo("<p>");
	            $car->printDataCar();
	            echo("</p>");
...
* **fernandojvela** (1) [878525](https://platzi.com/comentario/878525/) 
	...
	``` 
	    ...
	    public function printDataCar($name, $document){
	        return "License: $this->license, Driver: $this->driver, Document: $this->document";
	    }
	...
	require ‘account.php’
	``` 
	    $account = new Account("Rodrigo Herrera", "1032450")
	    $car = new Car("CMX123",$account);
...
* **Jhon Alexander Romero Gonzaga** (1) [878314](https://platzi.com/comentario/878314/) 
	...
	![](https://i.ibb.co/pxDPL1T/Screenshot-from-2019-12-22-21-41-45.png)  
...
* **David Morán** (1) [877366](https://platzi.com/comentario/877366/) 
	...
	Account.php  
	![Reto4_2.png](https://static.platzi.com/media/user_upload/Reto4_2-d6bd4bac-3268-4764-9569-76d3515e5f11.jpg)
...
* **michaelandresmierpito** (1) [860769](https://platzi.com/comentario/860769/) 
	...
	``` 
	    ...
	    public function printDataAccount($id, $name, $document, $email){
	        echo "<h4> EL IDENTIFICADOR DEL USUARIO ES:  $id</h4>";
	        echo "<h4> EL NOMBRE DEL USUARIO ES:  $name</h4>";
	        echo "<h4> EL DOCUMENTO  DEL USUARIO ES:  $document</h4>";
	        echo "<h4> EL EMAIL DEL USUARIO ES:  $email</h4>";
	    }
	...
	``` 
	    ...
	    public function __construct ($id, $licence,Account $driver, $passenger){
	        $this-> $id;
	        $this-> $licence;
	        $this-> $driver;
	        $this-> $passenger;
	    ...
	    public function printDataDriver($id, $licence,Account $driver, $passenger){
	        echo "<h4> EL IDENTIFICADOR DEL CONDUCTOR ES:  $id</h4>";
	        echo "<h4> LA LICENCIA DEL USUARIO ES:  $licence</h4>";
	        echo "<h4> LOS DATOS DEL CONDUCTOR SON:  $driver</h4>";
	        echo "<h4> LA CANTIDAD DE PASAJEROS ES:  $passenger</h4>";
	    }
	...
	$pago = new Paymeny(100);  
	echo $pago->printDataPayment();
	
	$ruta = new Route(100, 200, 300);  
	echo $ruta->prinRouteData();
	
	$cuenta = new Account(100, “ANDRES”, “DOC001”, ["mmier@outlok.es](mailto:%22mmier@outlok.es)", “pass”);  
	echo $cuenta -> printDataAccount();
	
	$conductor = new Car (100, “LICENSE001”,(Account(120, “ANDREA”, “DOC010”, ["mmmmr@outlok.es](mailto:%22mmmmr@outlok.es)", “pass”)), 4);  
	echo $conductor -> printDataDriver();  
	}  
	?>
...
* **alejaksot** (1) [841175](https://platzi.com/comentario/841175/) 
	...
	*/  
	...
	public funtion __construct($license, $driver){  
	$this->license = $license;  
	$this ->driver = $driver;  
	}  
	?>  
...
* **sergio-medina93** (1) [819977](https://platzi.com/comentario/819977/) 
	...
	![account_constructor.png](https://static.platzi.com/media/user_upload/account_constructor-e28c7ca9-81c9-4ec6-b7f5-8db0d88fabcf.jpg)
	
	Car
	
	![car_constructor.png](https://static.platzi.com/media/user_upload/car_constructor-db63874c-ae3b-4824-9714-36289ea005da.jpg)
	
	Payment
	
	![Payment_Constructor.png](https://static.platzi.com/media/user_upload/Payment_Constructor-37c0bbaa-5669-4a4e-973a-e682afc42f12.jpg)
	
	Route
	
	![Route_constructor.png](https://static.platzi.com/media/user_upload/Route_constructor-49fe4ecb-2996-46dc-9e96-4bb8f4d6730f.jpg)
...
* **Iván José Campo De Martino** (1) [716586](https://platzi.com/comentario/716586/) 
	...
	File “[main.py](http://main.py)”, line 1, in <module>  
	from car import Car  
	File “/home/ivanstankov/Documents/platzi/cursoPOOUber/Python/car.py”, line 3, in <module>  
	class Car:  
	File “/home/ivanstankov/Documents/platzi/cursoPOOUber/Python/car.py”, line 6, in Car  
	driver = Account("","")  
	...
	``` 
	    ...
	    def__init__(self, license, driver):
...
* **akivosimcho** (1) [709544](https://platzi.com/comentario/709544/) 
	...
	``` 
	    ...
	    class car{
	       ...
	       public function car($license, account $drive){
	           $this->license = $license;
	           $this->drive = $drive;
	       }
	     
	       public function pintDataCar(){
	           echo "Licencia: ". $this->license. "Drive: ". $this->drive->name;
	       }
	    }
	    ...
	    class account{
	       ...
	       public function Account($name, $document){
	           $this->name = name;
	           $this->document = document;
	       }
	    }
...
* **Wilson Marino Pablo Mendez** (1) [660962](https://platzi.com/comentario/660962/) 
	...
	``` 
	    ...
	    //Instanciando clase
	    $car = new Car("NN023", new Account("Miguel", "PDI0008"));
	    
	    //echo var_dump($car);
	    echo $car->license;
	    echo $car->driver->name;
	    echo $car->driver->document;
	    ?>
...
* **miguel-estrada** (1) [545634](https://platzi.com/comentario/545634/) 
	...
	Hola mundo  
	Traceback (most recent call last):  
	File “D:\cursos\POO\cursoPOOUber\Python\[main.py](http://main.py)”, line 6, in <module>  
	car = Car(“AMS234”,Persona(“Andres Herrera”, “12314123”))  
	...
	``` 
	    ...
	    classCar:
	        ...
	        def_init__(self,license,driver):
	           self.license = license
	           self.driver = driver
...
* **Nubia Magalli Jiménez Hernández** (1) [535338](https://platzi.com/comentario/535338/) 
	...
	``` 
	    <?
	    require_once"Account.php";
	    classCarextendsAccount{
	        private $id;
	        private $license;
	        private $driver;
	        private $passenger;
	    
	        publicfunction__construct($license,$name,$document){
	            
	            $this->license = $license;
	            $this->name = $name;   
	            $this->document = $document;         
	            parent::__construct($this->name,$this->document);  
	        }
	    
	        publicfunctionmostrarInformacion(){
	            echo"<h4>Informacion del auto:</h4>";
	            echo"<h1>Licencia: " . $this->license;        
	            echo"<h1> Driver: " . $this->name;
	            echo"<h1> Dcoument: " . $this->document;
	        }
	    }
	    $obj = new Car("L123", "Peter", "ANDA876");
	    
	    echo $obj->mostrarInformacion();
...
* **georgehossa** (1) [531351](https://platzi.com/comentario/531351/) 
	...
	``` 
	    ...
	    classCar
	    {
	        ...
	        publicfunction__construct($license, Account $driver)
	        {
	            $this->license = $license;
	            $this->diver = $driver;
	        }
	...
	``` 
	    ...
	    $car = new Car("LIC32NC3", new Account("Peter", "AN3456"));
...
* **Leandro Santiago Batista** (2) [986747](https://platzi.com/comentario/986747/) 
	...
	``` 
	    ...
	    namespaceUber.Clases
	    {
	        publicclassUberBlack : Car
	        {
	            Dictionary<string,string> typeCarAccepted = new Dictionary<string,string>();
	            ArrayList seatsMaterial = new ArrayList();
	            publicUberBlack(String license, Account driver, ArrayList seatsMaterial, Dictionary<string,string> typeCarAccepted  ) : base(license, driver)
	            {
	            this.license = license;
	            this.driver = driver;
	...
	``` 
	    ...
	    namespaceUber.Clases
	    {
	        publicclassUberVan : Car
	        {
	            ...
	            //seatsMaterials;
	            ArrayList seatsMaterial = new ArrayList();
	            publicUberVan(String license, Account driver, ArrayList seatsMaterial, Dictionary <string,string> typeCarAccepted ) : base(license, driver)
	            {
	                this.license = license;
	                this.driver = driver; 
	                this.seatsMaterial = seatsMaterial;
...
* **Antoine J. Manuel Gutierrez.** (1) [1114809](https://platzi.com/comentario/1114809/) 
	...
	* **tonyoz** [1114809] (2)
		...
		No es valido, porque un ArrayList te permite solo un argumento y aquí le estamos enviando 2 (String y Integer). Lo que podrías hacer es cambiar ese ArrayList por otro Map (Map <String, Integer>) .
...
* **cristhiancoaquira** (1) [1050551](https://platzi.com/comentario/1050551/) 
	...
	``` 
	    <?php
	    require_once'./Car.php';
	    classUberXextendsCar 
	    {
	      public $brand;
	      public $model;
	    
	      publicfunction__construct($license, $driver, $brand, $model)
	      {
	...
	``` 
	    ...
	    classUberBlackextendsCar 
	    {
	      ...
	      publicfunction__construct($license, $driver, $typeCarAccepted, $seatsMaterial)
	      {
	        parent::__construct($license, $driver);
	        $this->typeCarAccepted = $typeCarAccepted;
	        $this->seatsMaterial = $seatsMaterial;
...
* **xiocm15** (1) [1038501](https://platzi.com/comentario/1038501/) 
	...
	* **oscar_next** [1038501] (2)
		...
		y List es una colleción de objetos genéricos donde espera un tipo de dato, este indica el tipo de dato que soporta la lista en este caso el ArrayList.
		``` 
		    List<String> list;
		    
		```
		
		por lo que tu declaración tendría que ser algo así
		``` 
...
* **Christian Ricardo Conchari Cabrera** (1) [931949](https://platzi.com/comentario/931949/) 
	...
	``` 
	    ...
	    classUberBlackextendsCar{
	        ...
	        publicfunction__construct($license, $driver, $typeCarAccepted, $seatsmodel){
	            parent::__construct($license,$driver);
	            $this->$typeCarAccepted = $typeCarAccepted;
...
* **Manuel Alejandro Aguilar Téllez Girón** (1) [613076](https://platzi.com/comentario/613076/) 
	...
	``` 
	    ...
	    classUberBlackextendsCar{
	      ...
	      publicfunction__construct($license, $driver, $typeCar, $seatsMaterial){
	        parent::__construct($license, $driver);
...
* **esme** (1) [547800](https://platzi.com/comentario/547800/) 
	...
	``` 
	    ...
	    Al parecer elcódigo que tengo es el mismo, pero nome funciona, me sale ese error, alguien sabe que puede ser???
...
* **jecka** (5) [657417](https://platzi.com/comentario/657417/) 
	...
	* **jecka** [657417] (1)
		...
		``` 
		    ...
		    classUberBlackextendsCar{
		        ...
		        publicfunction__construct($license , $driver, $typeCarAccepetd, $seatsMaterial){
		            parent::__construct($license,$driver);
	...
	* **jecka** [657417] (1)
		...
		``` 
		    <?php
		    require_once('Car.php');
		    classUberPoolextendsCar{
		        public $brand;
		        public $model;
		    
		        publicfunction__construct($license , Account $driver, $brand, $model){
		            parent::__construct($license,$driver);
		            $this->brand  = $brand;
		            $this->model = $model;
		          }
	...
	* **abbustamante** [657417] (4)
		...
		Yo también tuve este problema y viendo algunas sugerencias logré solucionarlo. En resumen lo que realicé fue lo siguiente:
		  ...
		  2. En la sección de Extensiones, dentro del Visual Studio Code, busqué PHP server. Esta es la extensión que se instaló al principio del curso. Y se debe ingresar en la configuración, dando clic en el engrane(Manage) / Configure extension settings.
		
		  3. Una vez dentro, verás que hay una sección Phpserver: PHP Path. Aquí deberás colocar la ruta de instalación de PHP. Ejemplo: C:\php-7.3.9\php.exe
...
* **freddymm** (2) [941220](https://platzi.com/comentario/941220/) 
	...
	**Driver.php**
	``` 
	    ...
	    classDriverextendsAccount
	    {
	        ...
	        publicfunction__construct($id, $name, $document, $email, $password, $typeUser)
	        {
	...
	``` 
	    <<?php
	        ...
	        classUberXextendsCar
	        {
	            ...
	            publicfunction__construct($id, $license, $driver, $passenger, $brand, $model)
	            {
	...
	**Main2.php**
	``` 
	    ...
	    $driver1 = new Driver(1235, "quiamentino noroño", "28009657", "noroño@g.com", "mipasdword", "driver");
...
* **DanielCu** (1) [677714](https://platzi.com/comentario/677714/) 
	...
	``` 
	    ...
	    Fatal error: Uncaught Error: Class 'Car' not found in C:\Users\DeLL\Desktop\Fundamentos de programacion\POO\PHP\Main.php:6 Stack trace: #0 {main} thrown in C:\Users\DeLL\Desktop\Fundamentos de programacion\POO\PHP\Main.php online 6```
...
* **Diego Emanuel Ramirez** (1) [545960](https://platzi.com/comentario/545960/) 
	...
	[Wed Mar 27 18:24:18 2019] [::1]:36570 [500]: /CursoPOOUber/PHP/UberX.php - Unknown: Failed opening required ‘/run/media/diegodev/D8E258F9E258DCF6/Users/DiegoDev/Desktop/Platzi/Carrera de Fundamentos de Programación/Curso de Programación Orientada a Objetos/CursoPOOUber/PHP/UberX.php’ (include_path=’.:’) in Unknown on line 0
	
	index.php: <https://goo.gl/MKLLEm>  
	UberBlack.php: <https://goo.gl/Vy3UjV>  
	UberPool.php: <https://goo.gl/ftKxGw>  
	UberVan.php: <https://goo.gl/C1rkcg>  
	UberX.php: <https://goo.gl/f8GpnS>
	
	Así tengo los archivos organizados: <https://goo.gl/nLakFw>
	...
	* **Diego Emanuel Ramirez** [545960] (1)
		...
		[Wed Mar 27 18:52:01 2019] PHP Warning: Unknown: failed to open stream: Operation not permitted in Unknown on line 0
		
		[Wed Mar 27 18:52:01 2019] PHP Fatal error: Unknown: Failed opening required ‘/run/media/diegodev/D8E258F9E258DCF6/Users/DiegoDev/Desktop/Platzi/Carrera de Fundamentos de Programación/Curso de Programación Orientada a Objetos/CursoPOOUber/PHP/index.php’ (include_path=’.:’) in Unknown on line 0
...
![Captura de pantalla 2019-01-21 a la\(s\) 4.10.32.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-21%20a%20la%28s%29%204.10.32-fde223fb-648d-4607-9ecc-abb90aff4246.jpg) ![Captura de pantalla 2019-01-21 a la\(s\) 4.10.48.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-21%20a%20la%28s%29%204.10.48-2d526a66-e015-461f-8253-ef8a6a4eabd5.jpg) ![Captura de pantalla 2019-01-21 a la\(s\) 4.11.01.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-21%20a%20la%28s%29%204.11.01-522ece85-3a5c-44e1-9f69-6070cef7677e.jpg) ![Captura de pantalla 2019-01-21 a la\(s\) 4.11.18.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-21%20a%20la%28s%29%204.11.18-e0aa5965-0996-43d7-a279-95b9fca40a9b.jpg)
...
![Captura de pantalla 2019-01-21 a la\(s\) 4.11.34.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-21%20a%20la%28s%29%204.11.34-74307d10-e9a0-4e21-a797-385a71fd16f2.jpg)

Nuestro ejemplo se verá así:

![Captura de pantalla 2019-01-21 a la\(s\) 4.11.52.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-21%20a%20la%28s%29%204.11.52-12657ec7-3103-4a47-aaef-632b38d1dad2.jpg)
...
* **jmacalupur** (5) [973601](https://platzi.com/comentario/973601/) 
	...
	2.- Si aún no funciona, revisa la versión de Python que tienes, puesto que puede ser que estés probando con Python 2.x, lo cual hace que la sintaxis cambie. Para ello, instala la versión 3.x o si ya la tienes instalada, al ejecutar el [main.py](http://main.py), escribe en el terminal el comando “python3”, en vez de solo “python”, de esta manera:
	``` 
	    python3 main.py
...
* **Jhon Alexander Romero Gonzaga** (4) [878835](https://platzi.com/comentario/878835/) 
	...
	Pueden darse cuenta que en la imagen del documento no esta así, y eso causa el error ya que estamos haciendo funcionar incorrectamente `super()`
...
* **mael358** (4) [810759](https://platzi.com/comentario/810759/) 
	...
	luego el [main.py](http://main.py), solo creamos el uberX y lo pintamos en consola:
	``` 
	    from Car import Car
	    from Account import Account
...
* **Manuel Mosquera** (2) [555117](https://platzi.com/comentario/555117/) 
	...
	Esto les va a tomar como error ya que está asumiendo que está redeclarando la clase o algo así. Debería verse parecido así para que el motor de JS lo diferencie.
...
* **Aldo-Salas** (1) [754067](https://platzi.com/comentario/754067/) 
	...
	* **GibsPM** [754067] (2)
		...
		* Agregar la siguiente línea:  
		...
		“python.autoComplete.extraPaths”: [“E:\Linux Live\CursoPOOUber\Python”]
...
* **emiroedgar** (1) [620716](https://platzi.com/comentario/620716/) 
	...
	la creación el objeto en index.js quedó así:
	
	var uberx = new UberX(“CZC31E”, new Account(“Carolina Betancourt”,“6364646363”), “RENAULT”, “LOGAN” )  
	uberx.printDataCar();
	
	al correrlo me envía este error:
	
	Uncaught ReferenceError: UberX is not defined
...
* **Anfercode** (1) [573060](https://platzi.com/comentario/573060/) 
	...
	* **Anfercode** [573060] (2)
		...
		estoy usando la version de python 3.6, no se si eso tenga que ver ya que mire comentarios pero aun asi me funciona con
		``` 
		    def__init__(self,Licence,Driver,Brand,Model):
		            Car.__init__(self,Licence,Driver)
		            self.Brand = Brand
...
![Captura de pantalla 2019-01-21 a la\(s\) 12.21.03.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-21%20a%20la%28s%29%2012.21.03-6c3f1263-88f7-44db-a123-ba70c028069c.jpg)
...
* **sergio-medina93** (5) [820370](https://platzi.com/comentario/820370/) 
	...
	**Java**
	...
	![herencia_payment.png](https://static.platzi.com/media/user_upload/herencia_payment-441c2a19-d177-4a58-8802-cb5562ba9a5e.jpg)
	
	Card
	
	![herencia_card.png](https://static.platzi.com/media/user_upload/herencia_card-6e559302-015d-4ecc-96c6-47503cad33bf.jpg)
	
	PayPal
	
	![herencia_paypal.png](https://static.platzi.com/media/user_upload/herencia_paypal-aa97d417-114f-4b09-801f-abeb553533df.jpg)
	
	Cash
	
	![herencia_cash.png](https://static.platzi.com/media/user_upload/herencia_cash-18beea71-dc72-4263-bd25-cf443b3b8a97.jpg)
	
	**JavaScript**
	
	Payment
	
	![herencia2_payment.png](https://static.platzi.com/media/user_upload/herencia2_payment-a404c9a5-48e3-45ce-adbf-0c11c54ff74c.jpg)
	
	Card
	
	![herencia2_card.png](https://static.platzi.com/media/user_upload/herencia2_card-5bfc9a32-394c-4dcc-8141-a60aff75a0f8.jpg)
	
	PayPal
	
	![herencia2_paypal.png](https://static.platzi.com/media/user_upload/herencia2_paypal-d41d10df-8e8a-4bcc-b4a5-1fd2d93e003b.jpg)
	
	Cash
	
	![herencia2_cash.png](https://static.platzi.com/media/user_upload/herencia2_cash-980cccc2-e77c-499e-8e7a-d8f916c16e52.jpg)
	
	**PHP**
	
	Payment
	
	![herencia_payment.png](https://static.platzi.com/media/user_upload/herencia_payment-0da84869-e3e1-4348-a5ca-4cf2fde916a7.jpg)
	
	Card
	
	![herencia_card.png](https://static.platzi.com/media/user_upload/herencia_card-eea4d58f-e1ea-40f4-abda-413590a0bcc5.jpg)
	
	PayPal
	
	![herencia_paypal.png](https://static.platzi.com/media/user_upload/herencia_paypal-9ec343ba-f240-4683-bddf-f4a46aeab693.jpg)
	
	Cash
	
	![herencia_cash.png](https://static.platzi.com/media/user_upload/herencia_cash-fe56f828-0150-423a-b9aa-6e02fe9788df.jpg)
	
	Python
	
	Payment
	
	![herencia_payment.png](https://static.platzi.com/media/user_upload/herencia_payment-1c55c615-2873-40d7-ac50-558cca3cf9f0.jpg)
	
	Card
	
	![herencia_card.png](https://static.platzi.com/media/user_upload/herencia_card-db80fd70-af1a-4e67-9d86-4fcf624dafdb.jpg)
	
	PayPal
	
	![herencia_paypal.png](https://static.platzi.com/media/user_upload/herencia_paypal-6cb6eb37-564c-4123-8b0a-9bd3bc7adf26.jpg)
...
* **Ramón Ruiz** (3) [985555](https://platzi.com/comentario/985555/) 
	...
	``` 
	    //index.js
	    var car = newCar("AW456", newAccount("Andres Herrera", "QWE234"))
	    car.passenger = 4;
	    car.printDataCar();
	    
	    var uberX = newUberX("ADE131", newAccount("Juancho", "JFN213"), "Chevi", "Spark")
	    uberX.passenger = 4;
	    uberX.printDataCar();
	    
	    var paypal = newPaypal("SHAKD", "Ajkas@gmail.com");
	...
	**Card**
	``` 
	    ...
	    classCard(Payment):
	        ...
	        def__init__(self, id, number, cvv, date):
	            super().__init__(id)
	            self.number = number
	            self.cvv = cvv
	            self.date = date
	    
	        defprint_data_card(self):
...
* **andrescode7** (1) [520457](https://platzi.com/comentario/520457/) 
	...
	```
	    <code>
	    ```publicclassCardextendsPayment{
	         String number;
	         int cvv;
	        Date date;
	    
	        public Card(int id,String number,int cvv,Date date){
	            super(id);
	            this.number = number;
	            this.cvv    = cvv;
	            this.date   = date;
...
![1CBC2F61-08EB-4F0E-AE72-E13356C7E0EE.png](https://static.platzi.com/media/user_upload/1CBC2F61-08EB-4F0E-AE72-E13356C7E0EE-201e3c36-c34a-47ca-bea7-5bfa9ac10e15.jpg)
...
* **_hackvan** (3) [495597](https://platzi.com/comentario/495597/) 
	...
	**account.rb**
	``` 
	    classAccount
	      ...
	      definitialize(name, document, email, password)
	        @name = name
	        @document = document
	        @email = email
	        @password = password
	...
	**app.rb**
	``` 
	    user= User.new("Diego Camacho", "ID001","dcamacho@gmail.com", "password")
...
* **Erick Vicentin** (2) [993869](https://platzi.com/comentario/993869/) 
	...
	``` 
	    publicclass Account {
	        ...
	        public Account(Integer id, String name, Stringdocument, String email, String password) {
	            this.id         = Math.random();
	            this.name       = name;
	            this.document   = document;
	            this.password   = password;
...
* **Antonio Rafael González Ferrer** (2) [885313](https://platzi.com/comentario/885313/) 
	...
	**index.js**
	``` 
	    var driver1 = new Driver(10001,"Andrés Herrera", "AND123","andherrera@mail.com","passwordand01");
	    ...
	    var user1 = new User(20001,"Andrea Ferra", "ANDA876","andyferra@mail.com","passworandy20");
	    user1.printUserData();
...
* **mkitivenic** (2) [752389](https://platzi.com/comentario/752389/) 
	...
	**clase Account:**  
	![Account.jpg](https://static.platzi.com/media/user_upload/Account-3b09efa2-a0ed-436e-b1da-a0cf14eb18d4.jpg)
	
	**Clase User:**
	
	![Clase User.jpg](https://static.platzi.com/media/user_upload/Clase%20User-1f67408d-a4eb-4f06-95b2-45f9dba54d55.jpg)
	
	**Clase Card:**  
	![Clase Card.jpg](https://static.platzi.com/media/user_upload/Clase%20Card-d8c3ad76-490d-40a3-ba7e-da540e9ca5c8.jpg)
	
	**Clase Index:**
	
	![Index1.jpg](https://static.platzi.com/media/user_upload/Index1-0567aa2a-b30e-4ffe-95b5-d86b324ac391.jpg)  
	![Index2.jpg](https://static.platzi.com/media/user_upload/Index2-b0fa9910-1ad1-41b7-a4db-63657bdf334b.jpg)
...
* **Jose Martin Pardo Morales** (2) [491091](https://platzi.com/comentario/491091/) 
	...
	``` 
	    ...
	    classUserextendsAccount{
	        ...
	        publicfunction__construct($name, $document, $email, $foto, $telefono){
	...
	``` 
	    ...
	    $user1 = new User("Roberto Melchor", "84324823", "username1@gmil.com", "foto1", "948598555");
	    $user1->showDataUser();
	    
	    $user2 = new User("Segunda Torres", "82455553", "username2@gmil.com", "foto2", "985984545");
	    $user2->showDataUser();
	    
	    $conductor1 = new Driver("Carlos Dominguez", "85384383", "conductor1@gmail.com", "fotoc1", "983459385");
	    $conductor1->showDataDriver();
	    
	    $conductor2 = new Driver("Christian Oso", "64583758", "conductor2@gmail.com", "fotoc2", "989379475");
	...
	Correo: [username1@gmil.com](mailto:username1@gmil.com)
	
	Informacion de Usuario:
	
	Nombres y Apellidos: Segunda Torres  
	Documento de Identidad: 82455553  
	Correo: [username2@gmil.com](mailto:username2@gmil.com)
	
	Informacion de Conductor:
	
	Nombres y Apellidos: Carlos Dominguez  
	Documento de Identidad: 85384383  
	Correo: [conductor1@gmail.com](mailto:conductor1@gmail.com)
...
* **johanmateus** (1) [1110261](https://platzi.com/comentario/1110261/) 
	...
	``` 
	    ...
	    classUser(Account):
	        def__init__(self, id_num, name, document, email, password):
	            super().__init__(name, document) # Solicito a super() llamar de la Superclase esos atributos
	            self.id_num = id_num # Sobreescribo el atributo id_num de la Superclase
	            self.email = email # Sobreescribo el atributo email de la Superclase 
	            self.password = password # Sobreescribo el atributo password de la Superclase
	    ...
	    driver = Driver(id_num=1, name='Johan', document='123234244', email='pepito@gomez.com', password='Password')
	    print(vars(driver))
...
* **Juan Felipe Lara Martinez** (1) [1087113](https://platzi.com/comentario/1087113/) 
	...
	``` 
	    ...
	    classUserextendsAccount{
	        ...
	        publicfunctionprintDataAccout(){
	            print'Name: '.$this->name;
	            print' Document: '.$this->document;
	        }
	    }
	...
	``` 
	    ...
	    classDriverextendsAccount{
	        ...
	        publicfunction__construct($name, $document){
	            parent::__construnct($name, $document);        
	        }
	...
	``` 
	    ...
	    $user = new User("Andres Herrera", "6594946");
	    $user->printDataAccout();
	...
	``` 
	   ...
	   * Cuenta
	    ...
	    public classCuenta{
	        ...
	        //método constructor
	        public  Cuenta(String name, Stringdocument) {
	            this.name = name;
	            this.document = document;
	...
	``` 
	   ...
	   * Usuario
	    ...
	    public classUsuarioextendsCuenta{
	        ...
	        public Usuario(String name, String document) {
	            super(name, document);
	...
	``` 
	   ...
	   * Conductor
	    ...
	    public classConductorextendsCuenta{
	        ...
	        public Conductor(String name, String document) {
	            super(name, document);
...
* **Juan Nuñez** (1) [1042720](https://platzi.com/comentario/1042720/) 
	...
	``` 
	    classAccount:
	        ...
	        def__init__(self, ID, name, document, email, passwd):
	            self.ID=ID
	            self.name=name
	            self.document=document
	            self.email=email
	        ...
	        defestado(self):
	            print(self.ID,self.name, self.email, self.passwd, self.document)
	    
	    classUser(Account):
	        def__init__(self, ID, name, document, email, passwd):
	            super().__init__(ID, name, document, email, passwd)
	    ...
	    usuario1=User(1, "juan", "INE", "juan@dominio.com", "paletadefresa")
	    conduct1=Driver(2,"Andrea","Pasaporte","andy@dominio.com","soylacomadreja")
	    usuario1.estado()
	    conduct1.estado()```
...
* **Marcelo Sanchez** (1) [1012410](https://platzi.com/comentario/1012410/) 
	...
	``` 
	    ...
	    classUserextendsAccount{
	        ArrayList<String> cupones;
	    
	        public User(String name, int document, ArrayList<String>cupones) {
	            super(name, document);
	...
	``` 
	    classDriverextendsAccount{
	        ...
	        public Driver(String name, int document, int licenseNum, int calificacion) {
	            super(name, document);
...
* **Leandro Santiago Batista** (1) [986767](https://platzi.com/comentario/986767/) 
	...
	``` 
	    ...
	    namespace Uber.Clases
	    {
	        publicclass Driver : Account
	        {
	              public Driver( String name, Stringdocument ) : base( name, document)
	            {
	                this.name = name;
	                this.document = document;
	...
	``` 
	    ...
	    namespace Uber.Clases
	    {
	        publicclass User : Account
	        {
	            public User( String name, Stringdocument ) : base( name, document)
	            {
	                this.name = name;
	                this.document = document;
...
* **Ramón Ruiz** (1) [985600](https://platzi.com/comentario/985600/) 
	...
	``` 
	    ...
	    var user = newUser(7291, "Sherk", "SH241", "sherk.pantano@burro.com", "YoMeOpongoXD")
	    user.printDataAccount();
	    ...
	    classAccount{
	        ...
	        printDataAccount() {
	            console.log(this.id, this.name, this.document, this.email, this.password);
	        }
...
* **Ramón Ruiz** (1) [985593](https://platzi.com/comentario/985593/) 
	...
	``` 
	    ...
	    if __name__ == "__main__":
	        ...
	        user.name = "Sherk"
	        user.document = "S21K"
	        user.email = "sherk.pantano@burro.com"
...
* **jmacalupur** (1) [974673](https://platzi.com/comentario/974673/) 
	...
	**php:**  
	![php.png](https://static.platzi.com/media/user_upload/php-67a2a5ad-52ef-435a-a7b4-6c698988968c.jpg)
	
	**python:**  
	![python.png](https://static.platzi.com/media/user_upload/python-441cb6df-4f28-4900-b1ce-27b080756f7d.jpg)
	...
	**Clase Hija**
	``` 
	    ...
	    classDriver(Account):
	        ...
	        def__init__(self, id, name, document, email, password, typeUser):
	            super().__init__(self, id, name, document, email, password)
...
* **Christian Ricardo Conchari Cabrera** (1) [932128](https://platzi.com/comentario/932128/) 
	...
	``` 
	    ...
	    if __name__ == "__main__":
	        ...
	        print(vars(uberX))
	        '''
	        user1 = User(1,"Chris","AND123","chris@email.com","12345678")
	        driver1 = Driver(1,"Andres Herrera","WOW123","andres@email.com","87654321")
...
* **Castamare** (1) [915737](https://platzi.com/comentario/915737/) 
	...
	``` 
	    classUserextendsAccount{
	        ...
	        public User(finalString name, finalString document, finalInteger id, finalString email, finalString password) {
	            super(name, document, id, email, password);
	    
	        }
	        void printUserData(){
	            System.out.println("La cuenta es de " + super.name + " de documento " + document + " id " + id);
	        }
	    }
	...
	``` 
	    classDriverextendsAccount{
	        public Driver(finalString name, finalString document, finalInteger id, finalString email, finalString password) {
	            super(name, document, id, email, password);
	...
	``` 
	    classAccount{
	        ...
	        public Account(String name, Stringdocument, Integer id, String email, String password){
	            this.id = id;
	            this.name= name;
	            this.document = document;
	            this.email = email;
	...
	``` 
	    classMain {
	        publicstaticvoidmain(String[] args) {
	            ...
	            Driver driver15 = new Driver("Gabriel", "s524554", 29, "gabriel@uber.com", "password");
	            User notDriver15 = new User ("NoGabriel", "s56982", 92, "notgabriel@uber.com", "password");
	    
	            driver15.printDriverData();
	            notDriver15.printUserData();
...
* **OscarPalomino** (1) [913520](https://platzi.com/comentario/913520/) 
	...
	``` 
	    ...
	    <body>
	        ...
	        <?php
	            ...
	            require_once("user.php");
	            require_once("driver.php");
	            $driver1 = new Driver(new Account("Oscar Palomino", "1096212902"),"ing.oscarp1@gmail.com", "1234");
	            $driver1->printDataDriver();
	            $uberX = new UberX("STU35E", new Account("Oscar Palomino", "1096212902"), "Chevrolet", "Spark");
	            $uberX->printDataCar();
	            $user = new User(new Account("Lisney Berdugo", "1004926645"), "lisberdugo57@gmail.com", "10094");
	            $user->printDataUser();
	        ?>
	    </body>
	    </html>
	...
	``` 
	    ...
	    classUserextendsAccount{
	        ...
	        publicfunction__construct(Account $user, $email, $password){
	            $this->user = $user;
	            $this->email = $email;
	            $this->password = $password;
	        }
	        publicfunctionprintDataUser(){
	            echo ("User: ".$this->user->name."<br> E-mail: $this->email<br>");
	        }
	    }
	    ?>
	...
	``` 
	    ...
	    classDriverextendsAccount{
	        ...
	        publicfunctionprintDataDriver(){
	            echo ("Driver: ".$this->user->name."<br> E-mail: $this->email<br>");
	        }
	    }
	    ?>
...
* **Antonio Rafael González Ferrer** (1) [885548](https://platzi.com/comentario/885548/) 
	...
	**[main.py](http://main.py)**
	``` 
	    ...
	    if __name__ == "__main__":
	        driver1 = Driver(10001, "Andrés Herrera", "AND123", "andherrera@mail.com", "passwordand01")
	    
	        uberX1 = UberX("AMS234", driver1, "Chevrolet", "Spark")
	        print(vars(uberX1))
	        print(vars(uberX1.driver))
	        
	        user1 = User(20001, "Andrea Ferra", "ANDA876", "andyferra@mail.com", "passworandy20")
	        print(vars(user1))
	...
	``` 
	    <?php
	        ...
	        classUserextendsAccount
	        {
	            ...
	            publicfunction__construct($id, $name, $document, $email, $password)
	            {
	                parent::__construct($name, $document);
	                $this->id = $id;
	                $this->email = $email;
	            ...
	            publicfunctionprintUserData()
	            {
	                echo"USer Name: $this->name User ID: $this->id User email: $this->email";
	            }
	        }
	    ?>
	...
	``` 
	    <?php
	        ...
	        classDriverextendsAccount
	        {
	            ...
	            publicfunctionprintDriverData()
	            {
	                echo"Driver ID: $this->id Driver email: $this->email";
	            }
	        }
	    ?>
	...
	**index.php**
	``` 
	    <?php
	        ...
	        $driver1 = new Driver(10001, "Andrés Herrera", "AND123", "andherrera@mail.com", "passwordand01");
	    
	        $uberX = new UberX("CVB123", $driver1, "Chevrolet", "Spark");
	        echo "UberX Brand: $uberX->brand UberX Model: $uberX->model";
	        echo("<br>");
	        $uberX->printDataCar();
	        echo("<br>");
	        $driver1->printDriverData();
	        ...
	        $user1 = new User(20001, "Andrea Ferra", "ANDA876", "andyferra@mail.com", "passworandy20");
	        echo("<br>");
	        $user1->printUserData();
	    ?>
...
* **Antonio Rafael González Ferrer** (1) [885271](https://platzi.com/comentario/885271/) 
	...
	**User.java**
	``` 
	    classUserextendsAccount
	    {
	        ...
	        public User(Integer id, String name, Stringdocument, String email, String password)
	        {
	            super(name, document);
	            this.id = id;
	            this.email = email;
	        ...
	        void printUserData()
	        {
	            System.out.println("User Name: " + name + " User ID: " + id + " User email: " + email);
	        }
	    }
	...
	**Driver.java**
	``` 
	    classDriverextendsAccount
	    {
	        ...
	        public Driver(Integer id, String name, Stringdocument, String email, String password)
	        {
	            super(name, document);
	            this.id = id;
	            this.email = email;
	        ...
	        void printDriverData()
	        {
	            System.out.println("Driver ID: " + id + " Driver email: " + email);
	        }
	    }
	...
	**Main.java**
	``` 
	    ...
	    {
	        publicstaticvoidmain(String[] args) {
	            Driver driver1 = new Driver(10001,"Andrés Herrera", "AND123","andherrera@mail.com","passwordand01");
	    
	            UberX uberX = new UberX("AMQ123", driver1, "Chevrolet", "Spark");
	            uberX.passengers = 4;
	            System.out.println("UberX Brand: " + uberX.brand + " Model: " + uberX.model);
	            uberX.printDataCar();
	            driver1.printDriverData();
	    
	            User user1 = new User(20001,"Andrea Ferra", "ANDA876","andyferra@mail.com","passworandy20");
	            System.out.println("\n");
	            user1.printUserData();
	        }
	    }
	...
	```
	    classMain{
	        publicstaticvoidmain(String[] args) {
	            ...
	            Car car = new Car("8-741-451", new Account("Juan Olloa", "document"));
	            car.passengenger = 4;
	    
	            Car car2 = new Car("5-748-785",new Account("Pedro Sanchez", "Anda123"));
	            car2.passengenger = 3;
	    
	           car.printDataCar();
	           car2.printDataCar();
	    
	           User eUser = new User("David", "QWQ21", "vidm21@gmail.com");
	    
	           eUser.printInformation();
	        }
	    }
...
* **Jhon Alexander Romero Gonzaga** (1) [878992](https://platzi.com/comentario/878992/) 
	...
	JS  
	![](https://i.ibb.co/fqLHD97/Screenshot-from-2019-12-23-11-58-59.png)  
	  
	PHP  
	![](https://i.ibb.co/n0YcTHr/Screenshot-from-2019-12-23-12-16-34.png)  
...
* **laualexandrar** (1) [871609](https://platzi.com/comentario/871609/) 
	...
	**_class User.java_**
	...
	`class User extends Account { public User(String name, String document){ super(name,document); } }`
...
* **sergio-medina93** (1) [820408](https://platzi.com/comentario/820408/) 
	...
	![herencia3_account.png](https://static.platzi.com/media/user_upload/herencia3_account-087057cc-0a30-493f-8048-7a58a3e9e941.jpg)
	
	User
	
	![herencia3_user.png](https://static.platzi.com/media/user_upload/herencia3_user-a3090062-d175-48f0-ad0f-696a969d2b73.jpg)
...
* **Juan Manuel Otero Rey** (1) [818608](https://platzi.com/comentario/818608/) 
	...
	``` 
	    classDriverextendsAccount{
	        constructor(name, license, email){
	            super(name, license, email)
	        }
	    }
...
* **Paola Anttonela Rossi Querales** (1) [812877](https://platzi.com/comentario/812877/) 
	...
	```
	    ...
	    Account(String id,name,document,email,password){
	    this.id=id;
	    this.name=name;
	    this.document=document;
	    this.emaill=email;
	...
	``` 
	    ...
	    User(String id,name,document,email,password){
	    super(id,name,document,email,password);
	    }
	...
	``` 
	    ...
	    Driver(String id,name,document,email,password){
	    super(id,name, document, email, password);
	    }
	    }
...
* **José Alejandro Sierra Osorio** (1) [773447](https://platzi.com/comentario/773447/) 
	...
	public Account(String name, Stringdocument, String id, String email, String password) {  
	[this.name](http://this.name) = name;  
	this.document = document;  
	...
	// User.java  
	classUserextendsAccount{  
	public User (String name, String document, String id, String email, String password) {  
	super(name, document, id, email, password);  
	}  
	}  
	// Driver.java  
	classDriverextendsAccount{  
	public Driver (String name, String document, String id, String email, String password) {  
	super(name, document, id, email, password);  
	}  
	}
...
* **Nicolas Restrepo** (1) [737539](https://platzi.com/comentario/737539/) 
	...
	``` 
	    classAccount:
	        ...
	        def__init__(self, name, document, email, password):
	            self.name     = name
	            self.document = document
	            self.email    = email
	            self.password = password
...
* **Joel Rodrigo Rojas Roman** (1) [737055](https://platzi.com/comentario/737055/) 
	...
	``` 
	    classAccount{
	      ...
	      public Account(String name, Stringdocument, String email, String password){
	        this.name = name;
	        this.document = document;
	        this.email = email;
	        this.password = password;
...
* **bcanon** (1) [695064](https://platzi.com/comentario/695064/) 
	...
	```
	    classUserextendsAccount{
	        ...
	        public User(Integer id , String name, String document, String email, String password, String preferences){
	            super(id, name, document, email, password);
	...
	``` 
	    classDriverextendsAccount{
	        ...
	        public Driver(Integer id , String name, String document, String email, String password, String telephone){
	            super(id, name, document, email, password);
...
* **rafasilva** (1) [651718](https://platzi.com/comentario/651718/) 
	...
	para imprimir:
	``` 
	    <user = User(1, "Pedro Perez", "AND123", "algo@email", "password")
	        print(vars(user))>
	    
	```
	
	y aunque imprime los valores me arroja el sig error:
	
	File “D:\VS CODE\CursoPOOUber\python\[user.py](http://user.py)”, line 5, in **init**  
	super(). **init** (id, name, document, email, password)  
	...
	* Driver
	...
	``` 
	    classDriverextendsAccount{
	      ...
	      publicDriver(String name, String document){
	        super(name, document);
	      }
	    }
	...
	* User
	...
	``` 
	    classUserextendsAccount{
	      ...
	      publicUser(String name, String document){
	        super(name, document);
	      }
	    }
...
* **SolNaranjo** (1) [607427](https://platzi.com/comentario/607427/) 
	...
	``` 
	    ...
	    classUserextendsAccount{
	        ...
	        publicfunction__construct($phoneNumber, $name, $document){
	...
	```
	    exportdefault class Account {
	         ...
	         printUserData () {
	              ...
	              console.log("Document: " + this.user.document)          
	    ...
	    exportdefault class User extends Account {
	    ...
	    let user = new User("Developer", new Account("Jon", "CD574L-1", "wm@gmail.com", "secretPass"))
	    
	    user.printUserData()
	    
	    Account.js:11Name: Jon
	    Account.js:12Document: CD574L-1
	    Account.js:13Job: Developer
	    Account.js:14Email: wm@gmail.com
	    Account.js:15Password: secretPass
...
* **maopita** (1) [548154](https://platzi.com/comentario/548154/) 
	...
	class Driver extends Account{  
	construct(id, name, document, email, password){  
	super(id, name, document, email, password);  
	}  
	}
...
* **Luis Arturo Malagón Merino** (1) [536782](https://platzi.com/comentario/536782/) 
	...
	```
	    ...
	    C L A S E  D R I V E R:
	    classDriverextendsAccount{
	    
	        Integer age;
	    
	        public Driver(Integer id, String name, Stringdocument, Integer age,String email, String password){
	            super(id, name, document, email, password);
	            this.age = age;
	      }
	    }
...
* **jaimeuribe** (1) [535238](https://platzi.com/comentario/535238/) 
	...
	Y cree las clases User y Driver heredando de Account
	``` 
	    classUserextendsAccount{
	...
	``` 
	    classDriverextendsAccount{
	        ...
	        public Driver(Integer id, String name, String document, Integer edad,String email, String password){
	            super(id, name, document, email, password);
	            this.edad = edad;
	        }
...
* **jaimeuribe** (1) [535235](https://platzi.com/comentario/535235/) 
	...
	Y cree las clases User y Driver y herede de Account
	``` 
	    classUserextendsAccount{
...
* **georgehossa** (1) [534984](https://platzi.com/comentario/534984/) 
	...
	**Driver.js:**
	``` 
	    classDriverextendsAccount{
	      constructor(id, name, document, email, password, carType) {
	        super(id, name, document, email, password);
	...
	**index.js:**
	``` 
	    ...
	    const uberX = new UberX(
	      ...
	      new Account('Jorge Ossa', '1037574089'),
	      'KIA',
	      'Soul'
	    );
	    uberX.passanger = 4;
...
* **SERGIO PASTOR ONTIVEROS PEREZ** (1) [500317](https://platzi.com/comentario/500317/) 
	...
	```
	    ...
	    var uberBlack = new UberBlack("AW456", new Account("Sergio Pastor","A123"), "Audi", "Cuero de chivo");
	    UberBlack.passenger = 4;
	    uberBlack.printDataCar();
	    uberBlack.printDataUber();
	    
	    var user = new User("Diovana Fortes", "di32", "dido", "pass");
	    user.printDataUser();
	    var driver = new Driver("Sergio Ontiveros", "S1234", "pipo", "pass1");
...
* **osvaldo-trejo** (1) [491195](https://platzi.com/comentario/491195/) 
	...
	Codigo [Driver.py](http://Driver.py)
	``` 
	    from account import Account
	    classDriver(Account):
	        age = int
...
* **Christian Gómez** (4) [1039684](https://platzi.com/comentario/1039684/) 
	...
	![](!%5Bencapsulamiento.png%5D\(https://static.platzi.com/media/user_upload/encapsulamiento-9dbc8f72-a006-4ec7-8ed7-30e7e852d1c1.jpg\))
...
en javaScript tambien se usa el encapsulamiento… pero ¿¿cual seria el equivalente a ‘public’, ‘protected’, ‘default’ y ‘private’???
	...
	* **Juan David Castro (Platzi)** [71595] (2)
		...
		Por ejemplo, aunque las clases parecen igual que en Java o C++, solo son una sintaxis muy cómoda para usar prototipos, así que algunas características no funcionan exactamente igual. Tenemos que usar TypeScript para desarrollar con estas características.
		
		Te recomiendo este curso para entenderme mejor:
...
* **AxlGz** (6) [647590](https://platzi.com/comentario/647590/) 
	...
	``` 
	    defsetPassenger(self,passengerNum):
	            if passengerNum >= 4:
		...
		```
		    ...
		    classCar:
		        ...
		        def__init__(self,license,driver):
		            self.license = license
		            self.driver  = driver
		            self.printDataCar(driver,license)
		    
		    
		        defprintDataCar(self,driver,license):
		            self.driver = driver
		            self.license = license
		            print(driver.name + " | "+driver.document +" | "+ license)
		            # print(vars(self))#Con vars podemos mostrar todo el contenido del objeto
...
* **Marcelo Sanchez** (1) [1012569](https://platzi.com/comentario/1012569/) 
	...
	``` 
	    ...
	    classCar {
	        ...
	        publicvoidsetPassengers(int passengers) {
	            if (passengers == 4) {
...
* **Manuel Mosquera** (2) [560767](https://platzi.com/comentario/560767/) 
	...
	**Polimorfismo: **  
	...
	![Polimorfismo1.PNG](https://static.platzi.com/media/user_upload/Polimorfismo1-8d7dd5c7-fb44-4fdf-9702-01a8a20fc011.jpg)
...
* **Sebastián Pineda Duque** (2) [500176](https://platzi.com/comentario/500176/) 
	...
	* **CÉSAR ALBERTO SOTO REYES** [500176] (1)
		...
		Cuando explican esto necesitan apoyarse de algún lenguaje para que quede mas claro y al mismo tiempo practicar.
		
		Si requieres mas conocimientos acerca de la sintaxis propia de cada lenguaje hay clases especiales para eso.
...
* **GibsPM** (1) [783872](https://platzi.com/comentario/783872/) 
	...
	Ya leí la solución proporcionada por el colega anterior, pero sigue sin funcionar…  
	¿Alguien que me pueda guiar?  
	Esta es la clase main:  
	![polim2main.PNG](https://static.platzi.com/media/user_upload/polim2main-76e52ddb-4289-471d-a463-90033085cd09.jpg)  
	Esta es la clase UberVan:  
	![polim2ubervan.PNG](https://static.platzi.com/media/user_upload/polim2ubervan-113bf0a5-25e8-4085-b8a5-8160d252d1ac.jpg)
...
![Captura de pantalla 2019-01-21 a la\(s\) 3.20.10.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-21%20a%20la%28s%29%203.20.10-075bf981-504e-46b5-acb5-3d9bc67e8ea5.jpg)
...
![car-driver.png](https://static.platzi.com/media/user_upload/car-driver-204d198e-60fa-4c57-a0d0-0668c0e011d7.jpg)
...
![Captura de pantalla 2019-01-24 a la\(s\) 1.24.30.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-24%20a%20la%28s%29%201.24.30-ff45a4c0-dfa8-464b-8590-5d48cfa03eb5.jpg)

**Familia Account**  
![Captura de pantalla 2019-01-24 a la\(s\) 1.24.13.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-24%20a%20la%28s%29%201.24.13-bc9edb69-8909-487b-9619-350dcb933638.jpg)

**Familia Payment**  
![Captura de pantalla 2019-01-24 a la\(s\) 1.24.42.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-24%20a%20la%28s%29%201.24.42-ef7679b6-3b93-45c1-a4d9-1d6a24f4aa2a.jpg)
...
![Captura de pantalla 2019-01-24 a la\(s\) 1.46.08.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202019-01-24%20a%20la%28s%29%201.46.08-72aaa220-d916-4cae-9ac2-5a8ebe375b80.jpg)
...
Aprende los conceptos fundamentales de la programación orientada a objetos las clases, sus propiedades como la herencia, el encapsulamiento, polimorfismo, abstracción y entiende qué es un objeto y continúa aprendiendo con los cursos de Platzi.
