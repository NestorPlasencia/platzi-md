[Curso Básico de GraphQL 1512](https://platzi.com/cursos/graphql)
...
* **David Behar** (5) [1017106](https://platzi.com/comentario/1017106/) 
...
* **ulises arturo gonzalez callejas** (1) [891889](https://platzi.com/comentario/891889/) 
	...
	* **Daniel Esteves** [891889] (1)
		...
		No, se le debe declarar de qué tipo serán los datos obligatoriamente
...
* **Yank Carlos Reyes Espinal** (3) [966225](https://platzi.com/comentario/966225/) 
...
* **Engels Prado** (1) [685975](https://platzi.com/comentario/685975/) 
...
* **Esteban Ciudad** (10) [596620](https://platzi.com/comentario/596620/) 
...
* **Luis Arturo Lira Cerda** (2) [643078](https://platzi.com/comentario/643078/) 
	...
	* **juan diego ramirez rojas** [643078] (1)
...
* **alejandro2396** (2) [68705](https://platzi.com/comentario/744491/) 
...
* **Jose Daniel Barría Reyes** (1) [602279](https://platzi.com/comentario/602279/) 
...
* **Lian Nivin** (2) [687062](https://platzi.com/comentario/687062/) 
...
* **Alvaro Ruben Hurtado Maldonado** (0) [969770](https://platzi.com/comentario/969770/) 
...
* **Andres Roberto Coello Goyes** (3) [859636](https://platzi.com/comentario/859636/) 
...
* **Andres Roberto Coello Goyes** (2) [859653](https://platzi.com/comentario/859653/) 
...
# Conceptos avanzados [4002]

## 0150. Alias y fragments [19912](https://platzi.com/clases/1512-graphql/19912-alias-y-fragments/)

### Descripción:


Dentro de GraphQL podemos correr más de una petición a la vez y nombrarlas de distinta manera para poder identificarlas, esto es posible gracias a los _**Aliases**_ o simplemente Alias.
...
Además de los Alias, podemos agrupar campos para ser reutilizados en distintas peticiones gracias a los _**Fragments**_.
...
* **Jecsham Castillo** (4) [945711](https://platzi.com/comentario/945711/) 

	Cada vez me está encantando más GraphQL

* **CarlMateus** (4) [606829](https://platzi.com/comentario/606829/) 

	Es bueno hacer varios consultas en una misma peticion es rapido el servicio?

	* **Favio Náquira** [606829] (2)
...
* **Hector Daniel Hernandez Castillo** (2) [996934](https://platzi.com/comentario/996934/) 

	GraphQL realmente enamora a primera vista.

* **Yerlinson** (2) [933405](https://platzi.com/comentario/933405/) 

	Definitivamente esto deja a Rest en pañales. 😮

* **alexabellerman** (2) [903326](https://platzi.com/comentario/903326/) 

	Brutal

* **CarlMateus** (2) [606811](https://platzi.com/comentario/606811/) 
	...
	* **Jesus Eduardo Murrieta Rosas** [606811] (2)
...
* **pabloverduzcos** (1) [1042106](https://platzi.com/comentario/1042106/) 

	🤯

* **JerezA** (1) [83577](https://platzi.com/comentario/1030167/) 
...
## 0160. Variables [19913](https://platzi.com/clases/1512-graphql/19913-variables/)
...
* **gustavoalbertorestrepopelae** (2) [834773](https://platzi.com/comentario/834773/) 
	...
	* **ferchop2002** [834773] (2)

		Lo vi en el curso de React Avanzado , y es parte de Graph QL y es flexible en el código deberias pasar desde el client

	* **Yerlinson** [834773] (1)

		No creo, esta es más bien la forma de consumir el API de diferentes formas, porque en el controlador no hay forma de expresar esa sintaxis, me corrigen si estoy equivocado.

	* **Cristian Camilo Cucunubá** [834773] (2)
	...
	* **Cheil Colombia** [834773] (1)

		Inclusive con Axios se puede consumir la API. Ejemplo súper sencillo aquí <https://blog.apollographql.com/4-simple-ways-to-call-a-graphql-api-a6807bcdb355>

## 0170. Enums [19914](https://platzi.com/clases/1512-graphql/19914-enums/)

### Descripción:


Los _**Enums**_ o enumeration types son tipos de datos escalares cuyos valores son configurables. Si definimos un tipo de dato como enum sus valores posibles solamente serán aquellos que se encuentren entre los definidos en el enum.
...
* **pabloverduzcos** (2) [1042177](https://platzi.com/comentario/1042177/) 

	Me recordó a TypeScript 😂

* **oqodigital** (2) [73520](https://platzi.com/comentario/836547/) 
Video Cortado!!

	* **Nestor Cepeda (Platzi)** [73520] (2)

		¡Hola @oqodigital! 😊¿Podrías darnos más info sobre la parte que ves cortada? ¿En qué min ocurre exactamente?

## 0180. Interfaces - Tipo Monitor [19915](https://platzi.com/clases/1512-graphql/19915-interfaces-tipo-monitor/)
...
* **Daniel Alberto Esquinazi** (3) [637595](https://platzi.com/comentario/637595/) 

	Para consultar se puede hacer un `fragment` de una `interface`. No estoy seguro si es muy útil pero es posible.
	``` 
...
* **Jecsham Castillo** (2) [945743](https://platzi.com/comentario/945743/) 

	A pesar de haber implementado la interface, los campos deben seguir escritos en los types.

* **Javier Fuentes Mora** (1) [1015453](https://platzi.com/comentario/1015453/) 
...
* **Alejandro González Reyes** (1) [69495](https://platzi.com/comentario/758183/) 
Si quiero recuperar solo los Monitores, como se haria la consulta

	* **jhon manuel angulo moncada** [69495] (2)
...
## 0190. Directivas [19916](https://platzi.com/clases/1512-graphql/19916-directivas/)
...
* **Yerlinson** (1) [934238](https://platzi.com/comentario/934238/) 

	Wonderful!

* **DiegoTinitana** (1) [604724](https://platzi.com/comentario/604724/) 

	monitor es un type MONITOR ??? esto no es herencia

	* **Juan José Vega Quintero** [604724] (1)

		mas o menos  
		grahpql lo denomina agrupar grupos que tengan algo en común

## 0200. Unions [19917](https://platzi.com/clases/1512-graphql/19917-unions/)
...
* **Andres Roberto Coello Goyes** (6) [861090](https://platzi.com/comentario/861090/) 

	3 dias para llegar aqui… 😦

	* **Luis Jeanpier Monserrate** [861090] (2)

		Igual me paso a mi jajaja

* **albertodsosa** (3) [1069147](https://platzi.com/comentario/1069147/) 
	...
	* **Juan José Vega Quintero** [1069147] (1)

		Alguien sabe cómo hacer eso con mongo compass?

	* **albertodsosa** [1069147] (2)
...
* **Javier Fuentes Mora** (1) [1015873](https://platzi.com/comentario/1015873/) 
...
* **José Andrés Nava Campos** (1) [1009804](https://platzi.com/comentario/1009804/) 
...
# Consumiendo el API [4003]

## 0210. Preparando API para producción [19918](https://platzi.com/clases/1512-graphql/19918-preparando-api-para-produccion/)
...
* **jhon manuel angulo moncada** (9) [809118](https://platzi.com/comentario/809118/) 
...
* **Walter Ugalde A** (3) [59768](https://platzi.com/comentario/595574/) 
Me gustaría saber cuando van a dar el curso avanzado ? Seguridad ? Cuando el proyecto es grande como separar los resolv...

	* **rucardona** [59768] (2)
Hola, espero lo mismo ya que en la vida real y en un proyecto grande hay muchas cosas q son necesarias

* **Fernando Cordero** (2) [795026](https://platzi.com/comentario/795026/) 

	{“errors”:[{“message”:“Must provide query string.”}]}

	* **Juan José Vega Quintero** [795026] (1)

		cambio la url, tiene que estar en la url del query

* **Walter Ugalde A** (2) [595573](https://platzi.com/comentario/595573/) 

	Gracias Prof. El curso para principiantes esta bien, en realidad aporto muy poco, con respecto al que ya existia.

* **Juan José Vega Quintero** (1) [1088914](https://platzi.com/comentario/1088914/) 

	Usen gitbash o zsh en hyper

* **Mateo Loaiza Rios** (1) [614100](https://platzi.com/comentario/614100/) 

	npm ERR! errno 1  
	npm ERR! platzi-dir@1.0.0 start: `NODE_ENV=production node index.js`  
	npm ERR! Exit status 1

	* **AlexGarrixen** [614100] (1)
	...
	* **danielalbertopaz** [614100] (1)

		Si estas usando windows, puedes instalar la librería **win-node-env**.  
		**npm i win-node-env **o si lo quieres de manera global **npm i -g win-node-env**  
		con esto no se tiene que modificar la línea y se ejecuta sin problemas

	* **Juan David Gómez Gómez** [614100] (1)

		tambien puedes poner  
		"start": “SET NODE_ENV=production && node index”

* **Walter Ugalde A** (1) [595574](https://platzi.com/comentario/595574/) 
...
## 0220. HTTP requests [19919](https://platzi.com/clases/1512-graphql/19919-http-requests/)
...
* **mariomenjr** (13) [716297](https://platzi.com/comentario/716297/) 

	Postman tiene una feature específica para construir queries en GraphQL.
	
	![PostmanGraphQL](https://imgur.com/bbE5vvV.png)

	* **Alejandro González Reyes** [716297] (1)

		Excelente, gracias por el aporte.

	* **Jecsham Castillo** [716297] (1)

		buen aporte

	* **Juan José Vega Quintero** [716297] (1)

		No sabía que postman tenía modo dark, nice

	* **Juan José Vega Quintero** [716297] (1)

		No sabía que postman tenía modo dark, nice

* **Javier Fuentes Mora** (1) [1015941](https://platzi.com/comentario/1015941/) 

	a ustedes no les salió este error al ejecutar en consola??  
	{“errors”:[{“message”:“Expected type String!, found monitor.”,“locations”:[{“line”:2,“column”:24}]}]}%
	
	intente con varios querys pero el resultado fue el mismo sin embargo al hacerlo con Postman funciono sin ningún problema

	* **Juan José Vega Quintero** [1015941] (1)

		con la url de query funcional no debería dar error

## 0230. Clientes de GraphQL [19920](https://platzi.com/clases/1512-graphql/19920-clientes-de-graphql/)
...
* **Jean Carlos Nuñez Hernandez** (8) [594948](https://platzi.com/comentario/594948/) 

	Apollo Client para graphql

* **juan camilo castillo saucedo** (1) [1117342](https://platzi.com/comentario/1117342/) 

	Apollo Client es bastante util.

* **Juan José Vega Quintero** (1) [1088928](https://platzi.com/comentario/1088928/) 

	A veces usar lo mas simple es lo mejor

## 0240. Consumiendo el API desde un frontend simple [19921](https://platzi.com/clases/1512-graphql/19921-consumiendo-el-api-desde-un-frontend-simple/)
...
* **Walter Ugalde A** (35) [595585](https://platzi.com/comentario/595585/) 
	...
	* **Diego Alexander Forero Higuera (Platzi)** [595585] (7)

		Gracias por las sugerencias, vamos a tenerlas en cuenta para una versión avanzada del curso, en cuanto a que se repita el temario es porque cambian las versiones de las librerías y en algunos casos cambian la forma de implementar algo si el curso no se actualiza la implementación no va a funcionar y todo va a fallar por eso se actualizan los cursos aproximadamente una vez al año.

	* **Felipe Acosta** [595585] (16)

		Lo de las actualizaciones esta muy bien, pero tambien deben tener en cuenta que habemos suscriptores permanentes que esperamos seguir avanzando en nuestros conocimientos entonces si ya sabemos lo basico tambien queremos algo avanzado por que si no es ahi donde uno piensa en dejar la plataforma para ir buscando otra con cosas avanzandas y poder seguir subiendo nuestro nivel. 😃 BTW El curso esta excelente.

	* **Paul Mayorga** [595585] (1)

		hay*

	* **flavioaandres** [595585] (3)

		Hay muchos cursos en los que se enseña a proteger la API con JWT y subiur imagenes y videos

* **pabloverduzcos** (3) [1042319](https://platzi.com/comentario/1042319/) 

	GraphQL 💚

* **Pacool84** (3) [1024986](https://platzi.com/comentario/1024986/) 

	Mucho mas clases como estas !!!

* **Juan José Vega Quintero** (1) [86136](https://platzi.com/comentario/1088980/) 
Alguien pudo conectar el frontend?

	* **Juan David Castro (Platzi)** [86136] (1)

		¿Tuviste algún problema con el que te podamos ayudar?

## 0250. Cierre del curso [19922](https://platzi.com/clases/1512-graphql/19922-cierre-del-curso/)
...
* **Jose Vinicio Flores Arias** (8) [881009](https://platzi.com/comentario/881009/) 

	Valió cada maldito segundo!

* **jhon manuel angulo moncada** (7) [809144](https://platzi.com/comentario/809144/) 

	Excelente, pero se merece una versión mas avanzada.

* **ivanruiz__** (5) [785157](https://platzi.com/comentario/785157/) 

	Genial el curso, con ganas de uno para nivel medio/avanzado!

* **gustavoalbertorestrepopelae** (4) [839767](https://platzi.com/comentario/839767/) 
...
* **Luis Paredes** (3) [707349](https://platzi.com/comentario/707349/) 

	Gracias.

* **jhernandez_z** (2) [946789](https://platzi.com/comentario/946789/) 

	Excelente el curso, esperando el curso avanzado.

* **daer13_** (2) [762192](https://platzi.com/comentario/762192/) 

	Genial el curso, muchas gracias

* **juan camilo castillo saucedo** (1) [1117396](https://platzi.com/comentario/1117396/) 

	Muy buen curso!. Estaria genial un curso un poco más avanzado.

* **Jecsham Castillo** (1) [948132](https://platzi.com/comentario/948132/) 
