...
* [Big Buck Bunny 3D - Download](http://bbb3d.renderfarming.net/download.html)
...
* **ronald-machado** (2) [918689](https://platzi.com/comentario/918689/) 
	...
	* **Luis Fernández** [918689] (6)
		...
		para acceder a ese botón sería así
...
* **Leonel Lopez** (2) [889317](https://platzi.com/comentario/889317/) 
	...
	* **Yancarlo Urdaneta** [889317] (5)
		...
		y cuando estés dentro de ella debes utilizar el comando  
...
* **Le_MaliX** (1) [1069274](https://platzi.com/comentario/1069274/) 
	...
	``` 
	      <script>
	        ...
	        const player = new MediaPlayer({ el: video, playPause: button });
...
* **SistemasCBC** (1) [888655](https://platzi.com/comentario/888655/) 
	...
	* **Miguel Segura** [888655] (2)
		...
		``` 
		    ...
		    buttonPause.onclick = video.pause()
		    
		```
		
		Para el final de la clase el codigo era mucho mas extenso y abstracto pero era mas mantenible, reutilizable y replicable
...
Por qué cuando utilizo el código que esta comentado, de definir primero una función y después llamarla con el evento del click, no funcio...
	...
	* **Jhon Alexander Romero Gonzaga** [85786] (2)
		...
		``` 
		    ...
		    button.onclick = playorPause()  //aqui estas llamando la función
		    
		```
		
		Cuando el usuario va a pulsar el boton, ahi queremos que recien se ejecute la función, entonces solo debemos pasarla referencia a la funcion así:
		``` 
		    function playorPause() {
		      player.togglePlay()
		    }
		    button.onclick = playorPause
		    // aqui se esta pasando como referencia a la 
		    // función
...
de donde sale solo el player no deberia ser media player
	...
	* **Jhon Alexander Romero Gonzaga** [85143] (1)
		...
		de ahi al nombre de la variable podemos ponerla de diferete manera que esto no afectara, simplemente que deberan usar ese nombre que asignaron para trabajar con el objeto que crearon de MediaPlayer. 😮
		``` 
...
por qué es necesario usar un callback para la definición del comportamiento de MediaPlayer.prototype.play? Es porque es un método asíncro...
	...
	* **Ruben Padilla** [83696] (1)
		...
		En esta clase aprendemos sobre _callbacks_[Definición Estructura Callback](https://platzi.com/clases/1789-asincronismo-js/24991-definicion-estructura-callback/)
...
* **Cesar Augusto Barco de Gouveia** (18) [707398](https://platzi.com/comentario/707398/) 
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LnAslPvTOO8hEuAVtRL%2F-LnAt4WvAC2p0YUSAQfN%2FScreenshot_5.png?alt=media&token=0ff59938-9760-4265-aa72-f7edf2dbaea2)
	
	‌
	
	Cuando el navegador recibe este archivo lo tiene que convertir en una estructura parecida a un árbol.
	
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LnAslPvTOO8hEuAVtRL%2F-LnAt7T-fldcYHfW_T9t%2FScreenshot_6.png?alt=media&token=207bb874-af92-4444-9645-efe303274f3d)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LnAslPvTOO8hEuAVtRL%2F-LnAtAug9jQQpmpcW98H%2FScreenshot_7.png?alt=media&token=800409d9-0a2d-4ca4-838a-a5540848babc)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LnAslPvTOO8hEuAVtRL%2F-LnAtEMrCVRrSCCDCqSz%2FScreenshot_8.png?alt=media&token=c52a2662-444c-466c-941f-dedd6a965ca4)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LnAslPvTOO8hEuAVtRL%2F-LnAtIzo7lHAK8JTip5O%2FScreenshot_9.png?alt=media&token=a70cd485-aece-4b4c-b91b-d8fb92f913d2)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LnAslPvTOO8hEuAVtRL%2F-LnAtLtUKtU6Ia0Y785O%2FScreenshot_10.png?alt=media&token=64a7f644-e2e7-48a0-8322-2205cd175936)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LnAslPvTOO8hEuAVtRL%2F-LnAtOf3C_MzB_roSVQ4%2FScreenshot_11.png?alt=media&token=12c23c19-72f4-416e-9b54-c9d8ae284ef9)
	
	‌
	
	Ahora existe un atributo que le podemos dar a los scripts externos.
	
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LnAslPvTOO8hEuAVtRL%2F-LnAtRdn_jIHyGbuaeKG%2FScreenshot_12.png?alt=media&token=215dc39b-5594-458b-bf71-592d548593d4)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LnAslPvTOO8hEuAVtRL%2F-LnAtYruZmqR50cusYm3%2FScreenshot_13.png?alt=media&token=3c26c4eb-c40b-439a-ab24-18fcf7995c75)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LnAslPvTOO8hEuAVtRL%2F-LnAtaXWPuWvqqnOHMzc%2FScreenshot_14.png?alt=media&token=7666a428-4c9c-4419-a8c1-fbce95cd399f)
	...
	## ¡Vamos al código![](#vamos-al-codigo)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LnAslPvTOO8hEuAVtRL%2F-LnAtfSkryE1-5G5NWKU%2FScreenshot_15.png?alt=media&token=4dbf1347-f95c-4ce5-81d2-70355f91cfed)
...
* **Sergio Arturo Enriquez Nava** (8) [810370](https://platzi.com/comentario/810370/) 
	...
	[**¿Qué es DOMContentLoaded?**](https://developer.mozilla.org/es/docs/Web/Events/DOMContentLoaded)
	
	[**DOMContentLoaded _VS_ Load event**](https://developer.mozilla.org/en-US/docs/Web/API/Window/load_event)
	
	[**¿Qué es async?**](https://developer.mozilla.org/es/docs/Web/JavaScript/Referencia/Sentencias/funcion_asincrona)
...
* **Jhon Alexander Romero Gonzaga** (4) [1089227](https://platzi.com/comentario/1089227/) 
	...
	Me gusto este tema, la verdad hay que estar preparado con lo fundamental para entender este curso ya que no se para a explicar puntos ya antes vistos, para eso se debe seguir la siguiente ruta y ensayar con lo que aprenden (como hacer una agenda con JavaScript):
	  ...
	  2. [Curso de ECMAScript 6+](https://platzi.com/clases/ecmascript-6/)
	
	  3. [Curso Básico de JavaScript](https://platzi.com/clases/basico-javascript/)
	
	  4. [Curso de JavaScript Engine (V8) y el Navegador](https://platzi.com/clases/javascript-navegador/)
	
	  5. [Philip Roberts: ¿Que diablos es el “event loop” (bucle de eventos) de todos modos? | JSConf EU](https://www.youtube.com/watch?v=8aGhZQkoFbQ&t=3s)
	
	  6. [Curso de Asincronismo con JavaScript](https://platzi.com/clases/asincronismo-js/)
	
	  7. [Curso de Frontend Developer](https://platzi.com/clases/frontend-developer/)
...
* **Juan Carlos García Esquivel** (2) [751014](https://platzi.com/comentario/751014/) 
	...
	``` 
	    ...
	    <body>
	    	...
	    	<scriptsrc="url..."async></script><!--El atributo funcionara-->
	    	<scriptsrc="url..."defer></script><!--El atributo funcionara-->
	    	<h1id="main-title"></h1>
	    </body>
	    </html>
...
Aqui me perdi. Viendo el video no entendia de donde salio el archivo index.js Lo estuve buscando en el repositorio y no lo encontraba. Ha...
	...
	* **JhonColorado07** [83755] (2)
		...
		**Aportes:** Aquí estará todos los aportes que hacen los estudiantes y profesores de la comunidad.
		
		**Preguntas:** Sí tienes alguna pregunta con respecto al video o curso la puedes hacer aquí.
		
		**Marcadores:** Aquí estarán todos tus marcadores públicos y privados.
...
que es togglePlay()?? ,como funciona?
	...
	* **Christian Perez** [75901] (4)
		...
		por ejemplo:
		``` 
		      MediaPlayer.prototype.togglePlay = función() {
		    //Si el vídeo se encuentra en pausa la función this.play se ejecuta al hacer clic en el boton play
		        if (this.media.paused) {
		          this.play();
		    //Y acá, si el vídeo esta reproduciendo lo pausa
		        } else {
		          this.pause();
		        }
		      };
...
Variables disponibles de forma global se usa la palabra _var_ , son accesibles por todos los scripts que se cargan en la página. Aquí hay mucho riesgo de sobreescritura.
...
Variables definidas dentro de un bloque, por ejemplo variables declaradas dentro un loop _while_ o _for_. Se usa _let_ y _const_ para declarar este tipo de variables.
...
* **Andrea Méndez Díaz** (2) [754472](https://platzi.com/comentario/754472/) 
	...
	* **Freddy Rojas Valera** [754472] (1)
		...
		En package.json en la parte de los Scripts agregas el flag de --cors.  
		“scripts”: {  
...
¿“Global Scope” es lo mismo que el “contexto padre”?
	...
	* **Demian Arenas (Platzi)** [68773] (5)
		...
		``` 
		    <script>
		    var variableGlobal = 'hola puedo ejecutarme en cualquier script'
		    </script>
		    <script>
		    console.log(variableGlobal) // imprime el mensaje 'hola puedo ejecutarme en cualquier script'
		    function padre() {
		      let a = 'variable que vive dentro del contexto de la función padre';
		      function hijo() {
		        console.log(a); // el contexto padre de esta función es el contexto de la función padre
		      }
		      hijo();
		    }
		    padre();
...
* **Cristian Camilo Cucunubá** (1) [731325](https://platzi.com/comentario/731325/) 
	...
	``` 
	    <scripttype="moduel"src="./index.js"></script>
...
* **wilantury** (3) [741364](https://platzi.com/comentario/741364/) 
	...
	* **Alejandro Silva Berbesi** [741364] (3)
		...
		No se si comprendí bien tu pregunta 😅
...
* **carlosshanks** (2) [870256](https://platzi.com/comentario/870256/) 
	...
	``` 
	    ...
	    console.log(x);  // Reference Error: x isnot defined
...
* **Mateo Aquino** (2) [911852](https://platzi.com/comentario/911852/) 
	...
	Agrego la funcionalidad con un _prototype_
	``` 
	      MediaPlayer.prototype.mute = function(){
	        if(this.media.muted){
	          this.unmuted()
...
* **Luis Daniel Caraballo** (2) [744053](https://platzi.com/comentario/744053/) 
	...
	![Screenshot_3.png](https://static.platzi.com/media/user_upload/Screenshot_3-d1a328de-1c7b-417a-9a62-560036fe1bd6.jpg)
...
Por que this.plugins = config.plugins || []. Comprendo lo del array vacio, Pero de donde viene plugins? Dado que no se e...
	...
	* **Jorge Mendez Ortega** [75665] (3)
		...
		``` 
		    ...
		    // Preparando la configurción del player
		    const PLAYER_CONFIG = {
		        player: document.querySelector("#Play");,
		        plugins: [
		            new AutoPlay(), // <= Aqui esta generando el paso del plugin lo cual tambien se conoce como inyección de dependencias
		        ],
		    };
		    // al final pasa la configuración generada
		    const MEDIA_PLAYER_INSTANCE = new MediaPlayer(PLAYER_CONFIG);
		    
		```
		
		como puedes ver en el ejemplo así es como pasa el plugin, si quieres inspeccionar un poco más el ejemplo te comparto una liga donde genere el ejemplo.
		
		[https://codesandbox.io/s/clase3-j4058?fontsize=14&hidenavigation=1](https://codesandbox.io/s/clase3-j4058?fontsize=14&hidenavigation=1)
...
* **Robinson Ortega** (1) [1099617](https://platzi.com/comentario/1099617/) 
	...
	``` 
	    ...
	    <head>
	      ...
	      <linkrel="stylesheet"href="https://necolas.github.io/normalize.css/8.0.1/normalize.css" />
	      <linkrel="stylesheet"href="./assets/index.css" />
	    </head>
	    ...
	    <body>
	      ...
	      <mainclass="container">
	        <videoclass="movie">
	          <sourcesrc="./assets/BigBuckBunny.mp4" />
	        </video>
	    
	        <buttonid="playButton">Play/Pause</button>
	        <buttonid="muteButton">Mute/Unmute</button>
	      </main>
...
* **capzzula** (1) [1099321](https://platzi.com/comentario/1099321/) 
	    ...
	    <htmllang="en">
	      ...
	      <body>
	        <mainclass="container">
	          ...
	          <buttonid="mute">Mute/UnMute</button>
	        </main>
	        <scripttype="module"src="./js/index.js"></script>
	      </body>
	    </html>
	...
	**Index.js**
	``` 
	    ...
	    const player = new MediaPlayer(options);
...
* **Antonio Rafael González Ferrer** (1) [1093261](https://platzi.com/comentario/1093261/) 
	    ...
	    <html>
	      ...
	      <body>
	        ...
	        <mainclass="container">
	          ...
	          <buttonid="play_pause">Play/Pause</button>
	          <buttonid="mute_unmute">Mute/Unmute</button>
	        </main>
	...
	**index.js**
	``` 
	    ...
	    const video = document.querySelector('video')
	    const btnPlay = document.querySelector('#play_pause')
	    const btnMute = document.querySelector('#mute_unmute')
	    const player = new MediaPlayer({
	        el: video,
	        plugins: [new AutoPlay()]
	    })
...
* **Mafe Castillo** (1) [1078954](https://platzi.com/comentario/1078954/) 
	...
	```
	``` 
	    const $buttonPlay =document.getElementById("Mute") 
	    $buttonPlay.onclick =()=>{ player.unmute() }
...
* **Raundy Ibarras** (1) [1075070](https://platzi.com/comentario/1075070/) 
	...
	index.js
	``` 
	    const buttonP = document.querySelector("#mute");
	    buttonP.onclick = () => player.toggleMute();
...
* **Santiago Andres Duque Moreno** (1) [1073606](https://platzi.com/comentario/1073606/) 
	...
	html:  
	![3.PNG](https://static.platzi.com/media/user_upload/3-22c17acf-3c50-4cc7-a112-cc8d6294c6df.jpg)
	
	index.js:  
	![2.PNG](https://static.platzi.com/media/user_upload/2-7aa38242-036d-4079-8827-b6f99619f4bc.jpg)
...
* **Juan Enrique Rodriguez Garcia** (1) [1069875](https://platzi.com/comentario/1069875/) 
	...
	``` 
	    //index.js
	    const silent = document.getElementById("mute");
	    
	    silent.onclick = () => player.mute();
...
* **pcruzmay** (1) [1061829](https://platzi.com/comentario/1061829/) 
	...
	``` 
	    ...
	    const video = document.querySelector("video")
	    const sound = document.getElementById('muteButton')
	    const player = new mediaPlayer({el: video, sound, plugins: [new autoPlay()]})
...
* **Eleazar Carreón Álvarez** (1) [1016001](https://platzi.com/comentario/1016001/) 
	...
	``` 
	    ...
	    MediaPlayer.prototype.unmutedSound = function(){
	      this.media.muted = false;
	    };
	    
	    MediaPlayer.prototype.toggleMuted = function(){
	      this.media.muted ? this.unmutedSound() : this.mutedSound();
	    };
	...
	index.js
	``` 
	    const $buttonsMuted = document.getElementsByClassName('muted');
	    
	    for (const $buttonMuted of $buttonsMuted) {
	      $buttonMuted.onclick = () => {
	        player.toggleMuted();
	      };
	    }```
...
* **emacastillozam** (1) [1008905](https://platzi.com/comentario/1008905/) 
	...
	``` 
	    const muteButton = document.querySelector('#muteButton');
	    muteButton.onclick = () => muteB.toggleMute();
...
* **Jorge Cruz** (1) [990383](https://platzi.com/comentario/990383/) 
	...
	const buttonMuteUnmute = document.querySelector("#button-mute-unmute");  
...
* **gnbarzol** (1) [982396](https://platzi.com/comentario/982396/) 
	...
	index.html  
	![Captura de Pantalla 2020-02-12 a la\(s\) 8.24.57 p. m..png](https://static.platzi.com/media/user_upload/Captura%20de%20Pantalla%202020-02-12%20a%20la%28s%29%208.24.57%20p.%C2%A0m.-0f76b8ae-9883-4053-97e2-02e4e875f5b1.jpg)
...
* **John Botero** (1) [977612](https://platzi.com/comentario/977612/) 
	...
	```
	    // en el index.html se crea el boton:
	          ...
	          <button id="bt_play">Play/Pause</button>
	          <button id="bt_mute"> Mute/Unmute</button>
	    
	    
	    
	    // En el Index.js
	    // creé dos constantes para identificar cada 
	    // uno de los botones por ID:
	    
	    const btplay = document.getElementById('bt_play')
	    const btmute = document.getElementById('bt_mute')
	    
	    // se captura el evento click de cada boton:
	    
	    btplay.onclick = () => PLAYER.buttonPlay();
	    btmute.onclick = () => PLAYER.buttonMute();
	    
	    
	    // En el mediaPlayer.js
	    // se implementa la funcionalidad muted en el //mediaPlayer:
	    
	      mediaPlayer.prototype.muted = function(){
	        this.media.muted()
	      }
	    
	    //  Se implementa la función que hace la validación del // mute/unmute:
...
* **gonzaloPzl** (1) [952377](https://platzi.com/comentario/952377/) 
	...
	```
	    <!--Index.html-->
	          <buttonid="boton2">Mute/Unmute</button>```
...
* **miguelher007** (1) [950694](https://platzi.com/comentario/950694/) 
	...
	``` 
	    ...
	    button[0].onclick = () => player.play()
	    button[1].onclick = () => player.unMute()
...
* **miguelangelsoler** (1) [950374](https://platzi.com/comentario/950374/) 
	...
	```
	    ...
	    unmutedBtn.onclick = () => player.unmute()
...
* **Jose Arturo Enriquez Hurtado** (1) [908434](https://platzi.com/comentario/908434/) 
	...
	**HTML**
	``` 
	    <videoclass="movie"width="700"height="400">
	      <sourcesrc="./assets/video.mp4"/>
	    </video>
	    
	    <buttonid="play">Play/Pause</button>
	    <buttonid="mute">Mute/Unmute</button>
...
* **luis-mendoza877** (1) [888701](https://platzi.com/comentario/888701/) 
	...
	``` 
	    ...
	    codigo Shavascript como diria el buen Sashaa
	    
	    
	```
	
	const buttonMuted = document.getElementById(“mutedButton”);  
	const buttonPlay = document.getElementById(“playButton”);
	
	buttonPlay.onclick = () => player.togglePlay(player);  
	buttonMuted.onclick = () => player.toggleMute(player);
...
* **José Fernando Briceño Ruíz** (1) [835855](https://platzi.com/comentario/835855/) 
	...
	Agregando el **botón de mute/unmute**
	``` 
	    const mediaButton = document.querySelector('#media');
	    const soundButton = document.querySelector('#sound');
	    mediaButton.onclick = () => player.togglePlay();
	    soundButton.onclick = () => player.toggleMute();
	    
	```
	
	Y la clase de **AutoPlay**
	``` 
	    class AutoPlay {
...
* **predator0077** (1) [830397](https://platzi.com/comentario/830397/) 
	...
	``` 
	    ...
	    botonMedia.onclick = () => player.toggleButton();
	    
	    botonSonido.onclick =  () => player.toggleSonido();```
...
* **Alver Ortega** (1) [828243](https://platzi.com/comentario/828243/) 
	...
	en el archivo index.js, obtengo la referencia del botón y lo asigno a una variable.
	``` 
	    const muteOrUnmuteButton = document.getElementById('muteButton');
	    
	```
	
	al evento onclick del botón llamó el método player.toggleMute()
	``` 
	    muteOrUnmuteButton.onclick = () => player.toggleMute();
	    
	```
	
	en el archivo MediaPlayer.js agregue varios métodos al prototipo de la función
	``` 
	    MediaPlayer.prototype.mute = function(){
	        this.media.muted = true;
	    }
...
* **veronica oviedo** (1) [812432](https://platzi.com/comentario/812432/) 
	...
	``` 
	    const buttonMute = document.getElementById("muteButton");
	    buttonMute.onclick = () => player.muted() ? player.unmute() : player.mute();
	    
	```
	
	En la clase del MediaPlayer creo los eventos para poner mute, unmute y traerme el estatus del mute actual.
	``` 
	    MediaPlayer.prototype.mute = function() {
	      this.media.muted = true;
	    }
...
* **David Daza** (1) [765902](https://platzi.com/comentario/765902/) 
	...
	Esta es otra opción. En esencia es lo mismo, pero ¿cuál creen que sea mejor?
	``` 
	    MediaPlayer.prototype.toggleMute = functiontoggleMute() {
	      this.media.muted = !this.media.muted
	    }
...
* **Erledie Salazar** (1) [757245](https://platzi.com/comentario/757245/) 
	...
	``` 
	    functionMediaPlayer(config){
	        this.videoReproducir = config.video;
	        this.plugins = config.plugins || [];
	    
	        this._initPlugins();
	    }
	    
	    /*Nombre de la clase.prototype.nombre del metodo*/
	    MediaPlayer.prototype.play = function() {
	        this.videoReproducir.play();
	    };
	    MediaPlayer.prototype.pausa = function() {
	        this.videoReproducir.pause();
	    };
	    MediaPlayer.prototype.status = function(){
	        returnthis.videoReproducir.paused
	    };
	    MediaPlayer.prototype._initPlugins = function(){
	    ...
	    MediaPlayer.prototype.mute = function(){
	        this.videoReproducir.muted = true;
	    }
	    MediaPlayer.prototype.noMute = function(){
	        this.videoReproducir.muted = false;
	    }
	    MediaPlayer.prototype.toogleMute = function(){
	        if(this.videoReproducir.muted){//Tiene Mute
	            this.noMute();
	        }else{//No Tiene Mute
	            this.mute();
	        }
...
* **ngmartinezs** (1) [742280](https://platzi.com/comentario/742280/) 
	...
	console.log(buttonUnMuted.innerText);  
	if (buttonUnMuted.innerText === ‘unMuted’) {  
	buttonUnMuted.innerText = ‘Muted’;  
	player.unmute();  
	}  
	else {  
	buttonUnMuted.innerText = ‘unMuted’;  
	player.mute();  
	}  
	}
	
	const buttonUnMuted = document.getElementById(‘btnUnMuted’);  
	buttonUnMuted.onclick = () => conmutarMuted();
...
* **José Daniel Hernández Estrada** (1) [724819](https://platzi.com/comentario/724819/) 
	...
	```
	    ...
	    const unmute = document.querySelector('#mute')
...
ALguien me podria explicar por que en los prototypes no puedo utilizar arrow functions?, tiene algo que ver con el scope de estas?
	...
	* **Bernardo Ayala Montezuma** [78437] (2)
		...
		Compara que te muestra la consola cuando escribes person.fullName() y person2.fullName()
	...
	* **Juan David Castro (Platzi)** [705792] (3)
		...
		``` 
		    const Module = (function() {
		      const privateVar = "hahaha, no puedes verme :P"
		    
		      return {
		        const publicVar = "Chale, a mí si puedes verme D:";
		      }
		    })();
		    
		    console.log(Module.publicVar) // ¡puedo verte!
		    console.log(Module.privateVar) // ¡no puedo verte! :o__
...
* **Cesar Augusto Barco de Gouveia** (3) [722786](https://platzi.com/comentario/722786/) 
	...
	Para empezar con esta parte tenemos que comentar el _plugins_`AutoPlay` para que no nos moleste.
...
bastante confuso esto de this, entonces es para referirnos a un parametro a un conjunto de parametros? en el ultimo ejemplo de angela lo ...
	...
	* **David Granados** [74145] (1)
		...
		Si es en el scope de un función de una clase “this” representa la instancia(objeto) de la clase.
		
		En el ejemplo de angela era necesario, porque al instanciar una “clase” “Person” generamos un “objeto” el cual tiene un conjunto de “atributos” como “name” a los cuales tenemos acceso dentro de las funciones de clase a través del “objeto” “this” una vez instanciado el “objeto” ya podemos usar la variable del “objecto” en vez de usar “this” en este caso “angela”
		
		es decir:
		
		Dentro de las funciones de la clase el nombre de angela está en: “[this.name](http://this.name)”
...
* **Alejandro González Reyes** (8) [727546](https://platzi.com/comentario/727546/) 
	...
	``` 
	    // OTRA FORMA DE HACERLO ES MEDIANTE EL Operador de Propagación
	            ...
	            // Transformo la colección de elemetnos HTML en un arreglo con spread operator.
...
* **LeandroVidela** (6) [720793](https://platzi.com/comentario/720793/) 
	...
	* **Juan David Castro (Platzi)** [720793] (3)
		...
		Pero usando el spread operator lo conviertes en un array que sí que tiene esa propiedad. ¡Magnifico! 👏🎉
		``` 
		    Object.prototype.toString.call(buttons)
	...
	* **David Daza** [720793] (2)
		...
		También se puedete utilizar `Array.from`
		``` 
...
* **Diego Camino** (3) [974869](https://platzi.com/comentario/974869/) 
	...
	* **emacastillozam** [974869] (1)
		...
		(Archivo-> Preferencias-> Atajos del Teclado)  
		Buscar:  
		Toggle Line Comment o editor.action.commentLine  
		Y teclear las teclas que quieren usar para comentar líneas…
...
* **Maximo Martinez Soria** (3) [901484](https://platzi.com/comentario/901484/) 
	...
	En una función que llamamos directamente -> Window  
	En una función que llamamos directamente en Strict Mode -> Undefined  
	En un JSON -> valor del objeto  
	En objetos prototipales -> instancia
	
	Cambiar valor de This con Call, Apply y Bind:
	
	Call y Apply ejecutan la función luego de establecer el contexto.  
	function.call(context, prop_1, prop_2, …)  
	function.apply(context, [ prop_1, prop_2, … ])
	
	Bind, no ejecuta la función. Devuelve una nueva.  
	newFunction = function.bind(context, prop_1, prop_2, …)  
	newFunction()
...
* **rs-mario** (2) [842247](https://platzi.com/comentario/842247/) 
	...
	La forma de iterar en un objeto “NodeList” es agregando llaves y la posicion del elemento ej:  
...
¿Porque con el rest operator puedo convertir una colección de elementos HTML a un Arreglo.? […coleccionHTML] Alguien puede explicarme, gr...
	...
	* **Daniel Alberto Esquinazi** [67688] (4)
		...
		Finalmente usando ese operador creamos un nuevo array expandiendo el HTMLCollection y envolviendolo en `[]`
		
		Este operador tambíen puede usarse para expandir objetos:
		``` 
		    letcurso = {
		    	name: "fundamentos de JS"
		    }
		    
		    letcopiaDeCurso = {...curso}
	...
	* **Cristian Orozco Benjumea** [727712] (1)
		...
		``` 
		    classSayayin{
		            ...
		            saludar() {
		              console.log(`Hola pues soy ${this.name}`)
		            }
...
* **Leonardo Daniel Flores Hernandez** (1) [722313](https://platzi.com/comentario/722313/) 
	...
	* **Daniel Alberto Esquinazi** [722313] (3)
		...
		```
		    functionHero(name){
		    	this.name = name;
		    this.saludar = functionsaludar(){console.log(`Soy ${name}`)}
		    }
		    
		    const zelda = new Hero('Zelda');
		    zelda.saludar();
		    
		    /* Agregando una nueva funcion al prototype de Hero todos los objetos que hereden de el tendran la ventaja de poder llamar a la funcion "fight" a pesar de ya estar creados.*/
		    Hero.prototype.fight = functionFight(){
		    console.log('Fight!');
		    }
	            ...
	            if (typeof declaration.init.value === 'number') {
	              if (declaration.id.name !== declaration.id.name.toUpperCase()) {
	    			context.report(
	                  {
	                  	node: declaration.id,
	                    message: 'Los nombres de las constantes deben ser en mayúsculas',
	                    fix: function(fixer) {
...
* **Cesar Augusto Barco de Gouveia** (12) [727250](https://platzi.com/comentario/727250/) 
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoHySotWO02mHhrAiu3%2F-LoHyiMuJqRlHCN37qYA%2FScreenshot_7.png?alt=media&token=e66df5d8-da6e-4b82-a973-1be4c97fc4df)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoHySotWO02mHhrAiu3%2F-LoHynrE7TgE3np1fCwB%2FScreenshot_8.png?alt=media&token=b813f91f-41c7-492b-9c55-0144978af3d2)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoHySotWO02mHhrAiu3%2F-LoHystDJW4HMil1OSnP%2FScreenshot_9.png?alt=media&token=f92283a6-65ff-41e1-a8db-dff5ad2e8cf1) ![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoHySotWO02mHhrAiu3%2F-LoHywmk6l01P7UexFGD%2FScreenshot_10.png?alt=media&token=4bacc50e-4c0c-40ef-9354-bbe781b585a2) ![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoHySotWO02mHhrAiu3%2F-LoHz-nKI9hr0cTXU6TD%2FScreenshot_11.png?alt=media&token=93afaade-0159-44b8-a26f-53f60d6a8eb9) ![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoHySotWO02mHhrAiu3%2F-LoHz458fc5WLhEhC5aB%2FScreenshot_12.png?alt=media&token=79942ddb-aaae-4e88-9712-71152a695819)
...
* **Cesar Augusto Barco de Gouveia** (10) [727316](https://platzi.com/comentario/727316/) 
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI7QsLVj349M9HdZhw%2FScreenshot_13.png?alt=media&token=43050b2e-b8f4-4699-8af0-9289f513df2e)
	...
	**Memory Heap** : es totalmente desorganizada, se guarda información sobre variable, scope… entre otras cosas.
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI7VqX9GA7xUOsjRqh%2FScreenshot_14.png?alt=media&token=b6787616-4c5a-4609-9e0e-8c9de3269f14)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI7aHaIuzxEZ-eUij2%2FScreenshot_15.png?alt=media&token=8858d267-a85d-4341-b718-cbe9305187cb) ![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI7djC3elfr825jEu5%2FScreenshot_16.png?alt=media&token=b1e8d551-671b-432d-8638-9462baf55c58) ![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI7h6tx-1wLHAYHr8V%2FScreenshot_17.png?alt=media&token=1641cdce-76de-4132-a676-d33bfb3f931c) ![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI7stgR3SUlptd64TA%2FScreenshot_19.png?alt=media&token=9df38018-05c6-4d90-85b9-7db27de94c5a)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI7z2E744BnjVC_qAb%2FScreenshot_20.png?alt=media&token=f938ea4f-dc53-4ed3-92b1-e6b88024fa0d) ![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI81bSZx7T6YEpkyBL%2FScreenshot_21.png?alt=media&token=2b834c21-2e2f-491a-997f-9201112a27cd) ![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI84pea7Y0su4tungM%2FScreenshot_22.png?alt=media&token=e512cd37-5b4d-41b9-a2f5-c1d4c10320a4) ![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI8AFmXfEZI0cYJVaC%2FScreenshot_23.png?alt=media&token=6d24d8ff-d0a8-4153-b46a-7fab2cc97da0)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI8ECasfDh5yGe9mqQ%2FScreenshot_24.png?alt=media&token=8ce5a515-85e6-4cbc-b17b-7dc4cb85705b) ![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI8HXWCsyohjVZW0h9%2FScreenshot_25.png?alt=media&token=014e4ffe-5596-4549-9d6f-e1436111da3d) ![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI8MYCRvAeCTt-XfbT%2FScreenshot_26.png?alt=media&token=a6d4209e-730d-4866-bf11-fec7f7be1b60) ![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI8Putn3ns0AXblb1v%2FScreenshot_27.png?alt=media&token=afe70f50-d329-44d2-a810-5051ac04c119)
	...
	![](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LlTyKe9xd6RJ6x5f2-z%2F-LoI7BKq8iGAhi-e5tzh%2F-LoI8Ud-R0TbAxsgbJg3%2FScreenshot_28.png?alt=media&token=4cdc312d-efe9-4d1c-909e-ed0c3a3b26ba)
...
* **Eden Gomez Gress** (3) [876586](https://platzi.com/comentario/876586/) 
	...
	* **Christian Perez** [876586] (6)
		...
		Dado que JS va linea por linea:
		  ...
		  1. Ejecuta el primer console.log
		  2. manda la función setTimeout() a la cola de tareas
		  3. manda las promesas a las micro tareas
		  4. Ejecuta el segundo console.log
		  5. Regresa las promesas de la fila de micro tareas
		  6. Regresa el setTimeout() debido a que es la ultima prioridad de ejecución
		  7. Termina el stack.
	...
	* **brunoamadori** [1027764] (2)
		...
		``` 
		    <html>
		      ...
		      <body>
		        <ahref="/ejercicios/">Go back</a>
		    
		        <ul>
		          <li><buttonid="sequence">Get Top Movies in Sequence</button></li>
		          <li><buttonid="parallel">Get Top Movies in Parallel</button></li>
		          <li><buttonid="fastest">Get Fastest Top Movie</button></li>
		        </ul>
		        ...
		        <script>
		          ...
		          functiongetTopMoviesIds(n = 3) {
		            return getPopularMovies().then(popularMovies =>
		               popularMovies.slice(0, n).map(movie => movie.id)
		             );
		          }
		    
		          functionrenderMovies(movies) {
		          ...
		          functiongetTopMoviesInSequence() {
		            
		            return [];
		          }
		    
		          functiongetTopMoviesInParallel() {
		            return [];
		          }
		    
		          asyncfunctiongetFastestTopMovie() {
		            return {};
		          }
		    
		          document.getElementById('sequence').onclick = asyncfunction() {
		            const movies = await getTopMoviesInSequence();
		            renderMovies(movies);
		          };
		    
		          document.getElementById('parallel').onclick = asyncfunction() {
		            const movies = await getTopMoviesInParallel();
		            renderMovies(movies);
		          };
		    
		          document.getElementById('fastest').onclick = asyncfunction() {
	    ...
	    <body>
	      ...
	      <script>
	        ...
	        functionrenderMovies(movies) {
	          ...
	          asyncfunctiongetTopMoviesInSequence() {
	            return [];
	          }
	    
	          asyncfunctiongetTopMoviesInParallel() {
	            return [];
	          }
		...
		``` 
		    ...
		    functionpromise1() {
		                returnnewPromise((resolve, reject) => {
		                    // resolve es lo que regresa cuando la promesa se cumplio
		                    // reject para cuando la operacion fue fracasada
		                    resolve("it`s ok")
		                })
		            }
		    
		    // funcion flecha
		    const promise2 = () => newPromise((resolve, reject) => reject("it`s wrong"))
		    
		```
		
		Entonces como puedes ver puedes usar una validacion en la que verifique si en tu proceso existe algun error, de ser asi regresarias **reject** en lugar de **resolve**
		
		Ahora para poder consumir estas promesas que al final son respuestas asincronas, usas the los metodos **then** que lo que hacen es tomar esa respuesata que venia desde tu promisa
		``` 
		    promise1().then(res => console.log(res)) // el parametro res viene del resolve por lo que esto mostrara its ok
		    
		    //En el siguiente caso que la promesa regrese un reject entraria al metodo
		    //catch, donde el parametro err es lo que arroja el reject por lo que estarias viendo
		    // its wrong
		    promise2()
...
* **miguelangelsoler** (2) [953151](https://platzi.com/comentario/953151/) 
	...
	En este caso hubo que crear dos callbacks para interceptar los eventos Succes y error.  
	**Ahora el mismo ejemplo con promises:**
	``` 
	    const getPosts = () => {
	          ...
	          getPosts()
	            .then( (request) => {returnconsole.log(request) })
	            .catch( (error) => { returnconsole.log(error) })
	    
	```
	
	Ahora el mismo ejemplo con encadenamiento de promesas:
	``` 
	    var postId = 1
	          getPosts()
	            .then( (request) => {
	              ...
	              console.log(request.find(n => n.id === postId ))
	            })
...
* **David Vargas Domínguez** (2) [903800](https://platzi.com/comentario/903800/) 
	...
	* **David Vargas Domínguez** [903800] (1)
		...
		Los docs de MDN afirman que siempre se devuelve una promesa, aunque esté implícita.
...
* **Christian Perez** (1) [881083](https://platzi.com/comentario/881083/) 
	...
	* **Roso Peñaranda** [881083] (1)
		...
		``` 
		    ...
		    var connectionString = process.env.DB_CONEXION;
		    var db = pgp(connectionString);
		    const secret = process.env.SECRET
		    
		    asyncfunctionaddGenerico(query, datos) {
		      let respuesta = {
		        allOK: false,
		        datos: "",
		        mensaje: ""
		    ...
		    asyncfunctionaddCaso(req, res, next) {
		      const { nombre, sector } = req.body;
		      const query =
		        "insert into casos (nombre, sector, crea) values ($1,$2,(" +
		        "select id from usuarios where usuario=$3)) returning id";
		    
		      await addGenerico(query, [nombre, sector, req.usuario])
		        .then(respuesta => {
		          if (respuesta.allOK) {
		            res.status(200).json({
		              datos: respuesta
		...
		pgp es una libreria que permite conectar PostgreSQL con nodejs, el tema es que siempre que usamos esto trabajamos con promeras, eso quiere decir que no recibimos directamente la informacion que consultamos en la BD sino que recibimos una promesa de estas respuetas.
		
		la funcion addGenerico se encarga de agregar datos a la BD, recibe un query y los datos a agregar, como se debian agregar datos desde muchas otras funciones se decidio volver esto un metodo para no repetir en todo momento ese codigo, fijate que como el agregar datos con pgp nos trae una promesa, entonces en la funcion addGenerico devolvemos una procesa.
		
		ahora bien , addCaso es una de las tantas funciones que utilizar el addGenerico, envia un query que contiene el insert que se va a usar en la BD y los datos a agregar, en esta funcion utilizamos el async await para llamar a addGenerico.
	...
	``` 
	    <style>
	        ...
	        #moviesli {
	          ...
	          margin: 10px10px;
	          border-radius: 10px;
	          box-shadow: -1px2px16px -8pxrgba(0, 0, 0, 0.75);
	          overflow: hidden;
	        }
	...
	* **Diego Ivan Padilla Bernal** [707467] (3)
		...
		```
		    asyncfunctionmensaje1() {
		    	respuesta = awaitPromise.resolve("Promesa 1")
...
Estoy teniendo problemas entendiendo: Todas las promesas usan el “…then” ? En qué momento o cuándo es que uno usa el “t...
	...
	* **Juan David Castro (Platzi)** [69014] (5)
		...
		3️⃣ Con _async await_ debemos usar el **`await`** para obtener los resultados asíncronos. Y para controlar los errores debemos encerrar la parte del código que usa el _await_ en un bloque **`try-catch`**.
		``` 
		    // Con promesas
		    fetch('url')
		      .then(res => res.json())
...
Encontré este texto por la red, pero no logro entender la última parte Las funciones async devuelven una promesa, por lo que aun debemos ...
	...
	* **Juan David Castro (Platzi)** [67796] (1)
		...
		``` 
		    ...
		    myFunction() // [object Promise]
		    
		```
		
		Así que podemos usar las propiedades `.then` y `.catch` tal cual como si fueran una promesa (porque, de hecho, lo son).
		``` 
		    myFunction()
		      .then(console.log)
		      .catch(console.error)
		...
		O consumir la promesa que nos devuelve la función asíncrona… con otra función asíncrona.
		``` 
		    asyncfunctionexecuteMyFunction() {
		      const la = await myFunction()
		    
		      console.log(la) // "Hola!"
		    }
		    
		    executeMyFunction() // [object Promise]
		    
		```
		
		Al usar async await en nuestras funciones les estamos indicando que deben devolver una promesa. Incluso si solo devuelven un string. Y esto es precisamente porque son asíncronas.
		
		En cualquier momento podemos consumir una API o realizar procesos asíncronos y la función debe estar lista para manejarlos.
		
		Todo tiene más sentido si usas await.
		``` 
		    asyncfunctionmyFunction() {
		    ...
		    myFunction() // [object Promise] Ahora si tiene sentido, tiene que ir a realizar algo de verdad asíncrono (consumir la API).
...
* **Diego Andres Cabrera Rojas** (3) [1068371](https://platzi.com/comentario/1068371/) 
	...
	Recomendaciones para aquellos que se les dificulte entender esta clase , apoyándome de recursos de los comentarios de compañeros
	  ...
	  2. Leer detalladamente la siguiente [imagen](https://platzi.com/comentario/921816/) -> visión general
	  3. Leer paso por paso la siguiente [Infografia](https://platzi.com/comentario/944873/)
...
* **Steve Anthony Luzquiños Agama** (1) [1060010](https://platzi.com/comentario/1060010/) 
	...
	* **jesus-ruvalcaba-miranda** [1060010] (1)
		...
		Pero te preguntaras para que es necesario, uno de los principios de la Programación Orientada a Objetos es la `Encapsulación` cuya definicion es la siguiente:
		
		> _Es el proceso de almacenar en una misma sección los elementos de una abstracción que constituyen su estructura y su comportamiento; sirve para separar el interfaz contractual de una abstracción y su implantación._
		
		esto quiere decir que debemos evitar el programador que intenta utilizar nuestra clase pueda modificar directamente la variables privadas que declaremos en el ejemplo que dice el profesor el ‘video’, pero para que el usuario pueda interactuar como tal le debemos dar las herramientas necesarias para hacerlo
		
		es hay donde entran los Getters y Setters, con estos métodos le damos al usuario la posibilidad de interactuar con el video sin necesidad que cambie algo que nosotros no queramos que modifique, a esto se le llama `Programación Defensiva`,
		
		¿por qué llamar dos métodos de la misma forma?
		
		Bueno pongamos un ejemplo si quieres saber el valor de una variable arias algo como esto:
		``` 
		    nombre = "Jesus"
		    ...
		    // Asignar nuevamente el valor de una variable
		    nombre = "Juan"
		    
		    
		```
		
		si te das cuenta no necesitaste crear dos métodos con diferentes nombres para saber el valor o asignar un nuevo valor a la variable, para eso sirven los Setters y Getter y por eso es una **_Practica_** el llamarlos igual.
		
		en el ejemplo en concreto se asignan getters y setter a la propiedad mute del objeto de video de esa forma si quieres saber si el video esta en mute solo tienes que escribir `player.muted` y si quieres poner el video en silencio solo debes poner `player.muted = true`.
		
		si quieres un ejemplo de como lo he realizado aplicando los cambios que implementaron a partir de ECMAScript 2016 te dejo como lo implemente:
		...
		``` 
		    classMediaPalayer {
		      ...
		      setplayed(value) {
		        value ? this.#media.play() : this.#media.pause();
		      }
		...
		``` 
		    ...
		    functionbuttonsStatus() {
		      if (!player.played) {
		        play.className = "far fa-pause-circle fa-lg buttons";
		      } else {
		        play.className = "far fa-play-circle fa-lg buttons";
		      }
		      if (!player.muted) {
		        muted.className = "fas fa-volume-up fa-lg buttons";
		      } else {
		        muted.className = "fas fa-volume-mute fa-lg buttons";
		      }
		    }
...
* **Daniel Hurtado** (1) [708138](https://platzi.com/comentario/708138/) 
	...
	* **Andrés Felipe Eslava Zuluaga** [708138] (4)
		...
		``` 
		    Más precisamente significa establecer, declarar, colocar, ponerle nuevo estado. Todo dentro del mismo objeto carrito.
		    
		```
		
		Si seguimos en la suposición y decimos que cada evento hace que se elimine o se aparezca algo que en el UI, e indique el evento, entonces podemos decir que:
		``` 
		    Existe una funciónque recibe el cambio de estado    (set)
		    Existe una funciónquese ejecuta cada vez que cambia ese estado   (get)
		    
		```
		
		Si decimos que la función que recibe el cambio de estado es el evento del click en el botón “Comprame que tu sabes que me quieres”… ((`si lo ven, recibe un evento!`)) y  
		Si decimos que la función que cambia en el UI el númerito del carrito es la que se ejecuta cada que cambia el estado. Tenemos:
		``` 
		    Primero, lo que hace hace un getter y un setter dentro de un carrito de compras online, indicando eso que sí sabíasquequerías cada que le das click a ese botón.
		    Segundo, entender que llevas haciéndolo pero no sabíasque existían esas palabras 
...
no estaria entendiendo el setter
	...
	* **David Granados** [76089] (2)
		...
		El objeto intermediario “player” se usa para filtrar la comunicación y el nivel de acceso que tienen los plugins con el objeto “this” del MediaPlayer.
		
		Con el getter le das un nivel de acceso de lectura a la propiedad “media.muted” para que el intermediario pueda saber que valor tiene, pero no lo puede modificar.
...
* **yoshua_diaz** (9) [752276](https://platzi.com/comentario/752276/) 
	...
	``` 
	    const dialogosRamirez = {
	          ...
	          const oficialRamirez = newProxy(dialogosRamirez, dialogosComandante);
...
* **lucas-moreno375** (1) [904161](https://platzi.com/comentario/904161/) 
	...
	* **Antonio Madrid** [904161] (1)
		...
		Así que ademas de poder usar un proxy para comprobar que a un objeto se le mandan mensajes correctamente (como en el video).  
		Podríamos usarlo para hacer validaciones de datos o comprobaciones de seguridad antes de operar un objeto directamente.
...
Los generadores son funciones especiales, pueden pausar su ejecución y luego volver al punto donde se quedaron recordando su _scope_.
...
Entendi lo que hace el Generator, pero no me queda claro un ejemplo puntual en el que se use, en aplicaciones de producción. ¿Podrían ilu...
	...
	* **edgar figueroa** [65836] (3)
		...
		``` 
		    ...
		    thread(function *(){
		      let a = yield read('README.md')
		      let b = yield read('index.html')
		      console.log(a)
		      console.log(b)
		    })
		    ...
		    functionread(path) {
		      returnnewPromise( resolve => fs.readFile(path, 'utf8', (err, res) => resolve(res)))
		    }
...
* **Gonzalo Vazquez** (2) [842369](https://platzi.com/comentario/842369/) 
	...
	* **Cristian Orozco Benjumea** [842369] (5)
		...
		`while(true)` permite que siga en secuencia cada vez que hacemos un `gen.next()` porque siempre habrá un `nextNumber`
		
		**Nota:** Incluso pudimos haber comenzado desde 0
		``` 
		    a = 0
		    b = 1
...
* **Octavio Villavicencio Cruz** (2) [943256](https://platzi.com/comentario/943256/) 
	...
	``` 
	    ...
	    rootBounds: DOMRectReadOnly {x:0, y:0, width:1149, height:978, top:0, …}
	    boundingClientRect: DOMRectReadOnly {x:94.5, y:-389.125, width:960, height:540, top:-389.125, …}
	    intersectionRect: DOMRectReadOnly {x:94.5, y:0, width:960, height:150.875, top:0, …}
	    isIntersecting:true
...
* **Alejo Vera** (1) [867542](https://platzi.com/comentario/867542/) 
	...
	``` 
	    ...
	    funciona, pero si está me tira este error.
...
* **David Vargas Domínguez** (3) [904030](https://platzi.com/comentario/904030/) 
	...
	``` 
	    handleIntersection(entries) {
	        ...
	        this.isBelowThreshold = entry.intersectionRatio <= this.threshold;
	...
	```
	  ...
	  1. En la función handleVisibilityChange, agregamos a la condición nuestra variable, para que el vídeo se active solo si estamos en el tab y si no es menor al threshold.
	...
	``` 
	    handleVisibilityChange() {
	        ...
	        if (isVisible && !this.isBelowThreshold) {
	          this.player.play();
	        } else {
	          this.player.pause();
	        }
...
* **mexicansauce** (2) [1074832](https://platzi.com/comentario/1074832/) 
	...
	Y el método handleVisibilityChange quedaría así:
	``` 
	    handleVisibilityChange() {
	        const isVisible = document.visibilityState === 'visible';
...
* **veronica oviedo** (2) [819162](https://platzi.com/comentario/819162/) 
	...
	```
	    this.handleVisibility = this.handleVisibility.bind(this);
	        document.onvisibilitychange= this.handleVisibility;
...
* **Cesar Augusto Barco de Gouveia** (14) [734897](https://platzi.com/comentario/734897/) 
	...
	* `alcance`: [`USVString`](https://developer.mozilla.org/es/docs/Web/API/USVString "La documentación acerca de este tema no ha sido escrita todavía . ¡Por favor  considera contribuir !") representa una URL que define el alcance de registro de un “service worker”; es decir, qué rango de URL puede controlar un “service worker”. Esto es generalmente una URL relativa. El valor predeterminado es la URL que obtendría si resolviera ‘./’ utilizando la ubicación de la página web como base. No es, como se cree comúnmente, relativo a la ubicación del “service worker”. Vea la sección de Ejemplos para más información sobre cómo funciona.
	...
	The **`open()`** method of the [`CacheStorage`](https://developer.mozilla.org/en-US/docs/Web/API/CacheStorage "The CacheStorage interface represents the storage for Cache objects.") interface returns a [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise "The Promise object represents the eventual completion \(or failure\) of an asynchronous operation, and its resulting value.") that resolves to the [`Cache`](https://developer.mozilla.org/en-US/docs/Web/API/Cache "The Cache interface provides a storage mechanism for Request / Response object pairs that are cached, for example as part of the ServiceWorker life cycle. Note that the Cache interface is exposed to windowed scopes as well as workers. You don't have to use it in conjunction with service workers, even though it is defined in the service worker spec.") object matching the `cacheName`.
	...
	La **`Cache`**interfaz proporciona un mecanismo de almacenamiento para `[Request](http://fetch.spec.whatwg.org/#request)`/ `[Response](http://fetch.spec.whatwg.org/#response)`pares de objetos que se almacenan en caché, por ejemplo, como parte del [`ServiceWorker`](https://developer.mozilla.org/en-US/docs/Web/API/ServiceWorker "La interfaz ServiceWorker de la API ServiceWorker proporciona una referencia a un trabajador de servicio.  Se pueden asociar múltiples contextos de navegación \(por ejemplo, páginas, trabajadores, etc.\) con el mismo trabajador de servicio, cada uno a través de un objeto único de ServiceWorker.")ciclo de vida. Tenga en cuenta que la `Cache`interfaz está expuesta a ámbitos con ventanas, así como a los trabajadores. No tiene que usarlo junto con los trabajadores del servicio, aunque esté definido en la especificación del trabajador del servicio.
	
	## Métodos[Sección](https://developer.mozilla.org/en-US/docs/Web/API/Cache#Methods)
	
	[`Cache.match(request, options)`](https://developer.mozilla.org/en-US/docs/Web/API/Cache/match "El método match \(\) de la interfaz Cache devuelve una Promesa que resuelve la Respuesta asociada con la primera solicitud coincidente en el objeto Cache.  Si no se encuentra ninguna coincidencia, la Promesa se resuelve como indefinida.")
	
	Devuelve un [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise "El objeto Promise representa la finalización \(o falla\) eventual de una operación asincrónica y su valor resultante.")que resuelve la respuesta asociada con la primera solicitud coincidente en el `Cache`objeto.
	
	[`Cache.matchAll(request, options)`](https://developer.mozilla.org/en-US/docs/Web/API/Cache/matchAll "El método matchAll \(\) de la interfaz Cache devuelve una Promesa que se resuelve en una matriz de todas las respuestas coincidentes en el objeto Cache.")
	
	Devuelve un [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise "El objeto Promise representa la finalización \(o falla\) eventual de una operación asincrónica y su valor resultante.")que resuelve una matriz de todas las solicitudes coincidentes en el `Cache`objeto.
	
	[`Cache.add(request)`](https://developer.mozilla.org/en-US/docs/Web/API/Cache/add "El método add \(\) de la interfaz Cache toma una URL, la recupera y agrega el objeto de respuesta resultante a la caché dada. ")
	...
	[`Cache.addAll(requests)`](https://developer.mozilla.org/en-US/docs/Web/API/Cache/addAll "El método addAll \(\) de la interfaz Cache toma una matriz de URL, las recupera y agrega los objetos de respuesta resultantes a la caché dada.  Los objetos de solicitud creados durante la recuperación se convierten en claves para las operaciones de respuesta almacenadas. ")
	
	Toma una matriz de URL, las recupera y agrega los objetos de respuesta resultantes a la caché dada.
	
	[`Cache.put(request, response)`](https://developer.mozilla.org/en-US/docs/Web/API/Cache/put "El método put \(\) de la interfaz Cache permite agregar pares clave / valor al objeto Cache actual.")
	
	Toma tanto una solicitud como su respuesta y la agrega al caché dado.
	
	[`Cache.delete(request, options)`](https://developer.mozilla.org/en-US/docs/Web/API/Cache/delete "El método delete \(\) de la interfaz Cache encuentra la entrada Cache cuya clave es la solicitud y, si se encuentra, elimina la entrada Cache y devuelve una Promesa que se resuelve como verdadera.  Si no se encuentra una entrada de caché, se resuelve en falso.")
	
	Encuentra la [`Cache`](https://developer.mozilla.org/en-US/docs/Web/API/Cache "La interfaz de caché proporciona un mecanismo de almacenamiento para pares de objetos de Solicitud / Respuesta que se almacenan en caché, por ejemplo, como parte del ciclo de vida de ServiceWorker.  Tenga en cuenta que la interfaz de caché está expuesta a ámbitos con ventanas, así como a los trabajadores.  No tiene que usarlo junto con los trabajadores del servicio, aunque esté definido en la especificación del trabajador del servicio.") entrada cuya clave es la solicitud, devolviendo una [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise "El objeto Promise representa la finalización \(o falla\) eventual de una operación asincrónica y su valor resultante.")que se resuelve `true`si `Cache`se encuentra y elimina una entrada coincidente . Si no `Cache`se encuentra ninguna entrada, la promesa se resuelve `false`.
	
	[`Cache.keys(request, options)`](https://developer.mozilla.org/en-US/docs/Web/API/Cache/keys "El método keys \(\) de la interfaz Cache devuelve una Promesa que se resuelve en una matriz de claves Cache.")
...
alguien me puede indicar como hace para que los operadores logicos salgan de esa forma como diferente de ., mayor o igual estoy usando ...
	...
	* **Favio Sauto** [70581] (1)
		...
		en los ajustes de vscode. De ahí sigues usando los operadores lógicos como siempre != >= <=, etc.
...
* **mexicansauce** (3) [1081566](https://platzi.com/comentario/1081566/) 
	...
	```
	  ...
	  1. Creía haber resuelto el problema, pero cuando recargaba la página, me seguía apareciendo el mismo error:  
	![Captura de pantalla 2020-03-31 a la\(s\) 00.42.33.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202020-03-31%20a%20la%28s%29%2000.42.33-f6e766e0-2569-49b0-a88c-b0db950fbdde.jpg)
	
	
	
	Entonces, al ver que el problema tenía que ver con los service workers, procedí a eliminarlos de la memoria del navegador:  
	![Copia de Captura de pantalla 2020-03-31 a la\(s\) 00.42.33.png](https://static.platzi.com/media/user_upload/Copia%20de%20Captura%20de%20pantalla%202020-03-31%20a%20la%28s%29%2000.42.33-fb7f6254-130f-48c9-bd6d-52c933eb4814.jpg)
	
	¡Y funcionó! Ya podía recargar la página las veces que quiera sin el error:  
	![Captura de pantalla 2020-03-31 a la\(s\) 00.46.42.png](https://static.platzi.com/media/user_upload/Captura%20de%20pantalla%202020-03-31%20a%20la%28s%29%2000.46.42-bb055f4d-7ecc-466f-931e-740b0c0ad362.jpg)
	
	Al final, entendí que el error lo había originado cuando había abierto la url del video (<http://localhost:1234/index.html>) teniendo el typo en “browserslist”. Parece que ese error se había quedado guardado en los service workers (es mi razonamiento). Cuando corregí el error y eliminé los service workers, todo funcionó.
...
* **Javier Armando Vargas Vega** (2) [973197](https://platzi.com/comentario/973197/) 
	...
	Lo que hice fue copiar el archivo sw.js al directorio assets y ahí sí funcionó.
	
	¿Será esa una solución correcta?
...
* **Delfina Merola Moreschi** (1) [1101200](https://platzi.com/comentario/1101200/) 
	...
	``` 
	    ...
	    > platzi-media-player@1.0.0 start /mnt/c/Users/usuario/Documents/escuelaJS/profesionalJS
	    > parcel index.html ejercicios/index.html ejercicios/**/*.html
	...
	* **Alejandro Ávila Guerrero** [1101200] (1)
		...
		ingresa en el navegador a  
		**inspect** ==> **aplications** ==> **clear storage**  
...
* **luisglopez7777** (1) [1024747](https://platzi.com/comentario/1024747/) 
	...
	* **luisglopez7777** [1024747] (1)
		...
		``` 
		    {
		      "name": "platzi-media-server",
		      "version": "1.0.0",
		      "description": "Proyecto del Curso Profesional de Javascript",
		      "scripts": {
		      ...
		      "author": "Luis Gerardo Lopez <luisglopez7777@gmail.com>",
		      "license": "MIT",
		      "devDependencies": {
		        "live-server": "^1.2.1",
...
* **Bernardo Ayala Montezuma** (1) [896395](https://platzi.com/comentario/896395/) 
	...
	* **Bernardo Ayala Montezuma** [896395] (1)
		...
		Dejando en el package.json para el build solamente esto:
		``` 
		    "build": "tsc",
		    
		```
		
		He leído documentación en línea para entender el error pero aún no lo tengo del todo claro, lo que sé es que es algo que le ha pasado a varias personas.
...
* **Cristian Caraballo** (1) [828431](https://platzi.com/comentario/828431/) 
	...
	``` 
	    ...
	    🚨  /home/leonardo/github/Platzi/typescript/typescript.ts: Failed to install typescript.
...
* **Cesar Augusto Barco de Gouveia** (8) [735632](https://platzi.com/comentario/735632/) 
	...
	``` 
	    	functionsumar(valor1:number, valor2:number): number{
...
* **José Manuel Puicón Rodas** (1) [943678](https://platzi.com/comentario/943678/) 
	...
	```
	    ...
	    functioncreateAdder(a: number): (number) => number{
	        returnfunction (b: number) {
	            return b + a
	        }
	    }
	    ...
	    functionfullName(firstName: String, lastName?: String): String{
	        return`${firstName}${lastName}`
	    }
...
* **Luis Fernández** (1) [931610](https://platzi.com/comentario/931610/) 
	...
	```
	    /* Funcion Básica */
	        ...
	        functionfullNameInitLastname(firstName: string, lastName: string = "Apellido"): string{
	            return`${firstName}${lastName}`;
	        }
...
¿Como hacemos para definir los tipos de datos cuando desestructuramos un objeto en typescript? Tengo la siguiente función: async ...
	...
	* **Manuel Ojeda** [67005] (7)
		...
		Lo que es que tienes que destructurarlo así, primero ponemos la destructuración, seguido de la declaración del tipo
		``` 
		    { providerId, data} // <-Esta es la destructuración normal
		    ({ providerId, data }: { providerId: number; data: object }) // <- Este es con TypeScript, aparte de la destructuración debemos indicar los tipos como otro parametro.
...
* **Cesar Augusto Barco de Gouveia** (5) [735647](https://platzi.com/comentario/735647/) 
	...
	``` 
	    functionprintLabel(labeledObj: { label: string }) {
	...
	``` 
	    ...
	    functionprintLabel(labeledObj: LabeledValue) {
	        console.log(labeledObj.label);
	    }
...
* **José Manuel Puicón Rodas** (1) [943692](https://platzi.com/comentario/943692/) 
	...
	```
	    ...
	    rect.toString = function () {
	        returnthis.color ? `Un rectángulo ${this.color}` : `Un rectangulo`
	    }
...
* **Luis Fernández** (1) [931620](https://platzi.com/comentario/931620/) 
	...
	```
	    ...
	    rectangulo.toString = function () {
	        returnthis.color ? `Un Rectangulo ${this.color}`:`Un rectangulo`;
	    }
...
* **Cesar Augusto Barco de Gouveia** (9) [735655](https://platzi.com/comentario/735655/) 
	...
	``` 
	    class Person {
	        protected name: string;
	        protectedconstructor(theName: string) { this.name = theName; }
	    }
...
* **Delfina Merola Moreschi** (1) [1104252](https://platzi.com/comentario/1104252/) 
	...
	``` 
	    ...
	    Argument oftype'(entries: IntersectionObserverEntry) => void'isnot assignable to parameter oftype'IntersectionObserverCallback'.
	      Types of parameters 'entries'and'entries' are incompatible.
	        Type'IntersectionObserverEntry[]'is missing the following properties fromtype'IntersectionObserverEntry': boundingClientRect, intersectionRatio, intersectionRect, isIntersecting, and3 more.ts(2345)``
...
* **Jhonatan David Ibarra Lavado** (1) [857776](https://platzi.com/comentario/857776/) 
	...
	``` 
	    functionMediaPlayer(config){
	        ...
	        this.media=config.el //objeto de configuración
	        this.plugins= config.plugins || []
	        this._initPlugins()
	    ...
	    MediaPlayer.prototype._initPlugins =function (){
	        ...
	        const player={
	            ...
	            set  muted  (value){//el valor "value" viene de autoplay =true
	    ...
	    this.plugins.forEach(plugin => {
	       ...
	       //plugin.run(this)  //ese this se refiera a la instancia del media player
	    });
...
* **Cristian Caraballo** (1) [804456](https://platzi.com/comentario/804456/) 
	...
	* **Gabriel De Andrade (Platzi)** [804456] (3)
		...
		Al parecer ya está siendo solucionado por los desarrolladores de parcel
...
* **Cesar Augusto Barco de Gouveia** (9) [738728](https://platzi.com/comentario/738728/) 
	...
	* Al estar internamente autoreferenciada, en lenguajes como Java, el recolector de basura no actúa.
	...
	``` 
	    Singleton = functionSingleton$constructor() {
	        return { 
...
* **Cesar Augusto Barco de Gouveia** (11) [738763](https://platzi.com/comentario/738763/) 
	...
	## Conceptos básicos[](https://es.redux.js.org/docs/introduccion/conceptos-basicos.html#conceptos-b%C3%A1sicos)
...
* **Antonio Madrid** (2) [925738](https://platzi.com/comentario/925738/) 
	...
	```
	    ...
	    functionwithMemory(amount: number, computer: MacbookPro): void{
	      letcost: number = computer.cost();
	    
	      computer.cost = function():number{
	        letmemoryCost: number = Math.max((amount - 8) * 25, 0);
	    
	        return cost + memoryCost;
	      }
	    }
	    
	    letmacbook: MacbookPro = new MacbookPro();
...
* **Filiberto Santillán** (5) [945494](https://platzi.com/comentario/945494/) 
	...
	A esto:
	``` 
	    field |> RequiredFieldDecorator |> EmailFieldDecorator
	...
	_  
	Así se logra entender mejor que estamos pasando **field** y que este primero pasa por **RequiredFieldDecorator** y después por **EmailFieldDecorator**.  
	_  
	Lo pueden usar ya mismo con babel: <https://babeljs.io/docs/en/babel-plugin-proposal-pipeline-operator>  
	_  
	Por ahora hay dos propuestas en competencia bajo consideración (F# Pipelines & Smart Pipelines) pero las dos usan la misma sintaxis para el operador: **| >**.  
	_  
...
* **Eden Gomez Gress** (1) [884880](https://platzi.com/comentario/884880/) 
	...
	``` 
	    ...
	    functionEmailFieldDecorator(field: Field): Field {
	      let validate = field.validate;
	    ...
	    No entiendo porque validate() que esta dentro de la clase Field no esta llenado
	...
	validate() {}
	``` 
	    Y en las otras funciones de abajo como hacen referencia a validate() o como es quese modifica?
	...
	``` 
	    Espero me puedan ayudar a comprender esto mejor !!
	...
	* **David Vargas Domínguez** [884880] (3)
		...
		``` 
		    functionvalidate() {
		    	...
		    	if (!value) {
		    		this.errors.push('Requerido')
		    	}
		    }
		    
		```
		
		Y luego se aplicaría el decorador EmailFieldDecorator…
...
* **oteka21** (1) [756299](https://platzi.com/comentario/756299/) 
	...
	* **Marco Antonio Macedo Preciado** [756299] (2)
		...
		``` 
		    ...
		    //Agregas el código de Field. mostrado en la clase
		    ...
		    functionEmailFieldDecorator(field: Field): Field {
		      ...
		      field.validate = function() {
		        ...
		        if (!value.match(EMAIL_REGEX)) {
		          field.errors.push("Not an email!");
		        }
		      };
		    
		      returnfield;
		    }
		    let field = newField(document.querySelector("#email"));
...
* **braco** (1) [1004676](https://platzi.com/comentario/1004676/) 
	...
	y no lo hace como normalmente lo hizo en todo el curso asi  
	import Ads from ‘./plugins/Ads/Index.ts’
...
* **Steven Benjamín Diaz Flores** (2) [713192](https://platzi.com/comentario/713192/) 
	...
	* **NicoBertini** [713192] (1)
		...
		{  
		“name”: “@nicolas/platzi-media-player”,  
		“version”: “1.0.0”,  
		“description”: “”,  
		“main”: “lib/MediaPlayer.js”,  
		“scripts”: {  
		“build”: “tsc src/ **/ _.ts src/plugins/_.ts src/plugins/**/*.ts --outDir lib”,  
...
* **Alejandro Daniel Oroncoy Almeyda** (1) [991850](https://platzi.com/comentario/991850/) 
	...
	``` 
	    npm ERR! code E403
	    npm ERR! 403403 Forbidden - PUT https://registry.npmjs.org/@alejo%2fmediaplayer - Forbidden
...
* **Sebastian** (1) [774020](https://platzi.com/comentario/774020/) 
	...
	* **Alejandro Lopez Ramírez** [774020] (1)
		...
		cuando realizar la instalacion de nodejs (<https://nodejs.org/es/>) el instala también un paquete llamado npm desde ese momento podras utilizar todos los comandos por consola que necesitas.
		
		si necesitas mas profundidad de como alistar el entorno puede ver el [Curso de Prework: Buenas Prácticas y Entorno de Desarrollo](https://platzi.com/clases/prework/)
		
		cualquier cosa que necesites con gusto alguien de la comunidad te vamos a responder.
