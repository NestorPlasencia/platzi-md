[Curso de Ionic 4 1718](https://platzi.com/cursos/ionic-avanzado)
...
* **Cristobal Vega** (2) [765054](https://platzi.com/comentario/765054/) 
	...
	¡A la mareeee! (esa será mi reseña de este curso) 🤓
...
* **Victor César** (4) [768956](https://platzi.com/comentario/768956/) 
	...
	Está mí aplicacíon esta hecha en IONIC 4  
...
* **Christian David Sánchez** (4) [764486](https://platzi.com/comentario/764486/) 
...
* **Anthony Will Solsol Soplin** (2) [70030](https://platzi.com/comentario/767883/) 
...
* **David Trespalacios** (1) [79297](https://platzi.com/comentario/937717/) 
...
* **Daniel Rojas Vidal** (2) [918397](https://platzi.com/comentario/918397/) 
...
* **jhonnyzapata** (1) [81357](https://platzi.com/comentario/979589/) 
...
* **Paola Quezada del Río** (0) [82554](https://platzi.com/comentario/1007707/) 
...
* **Victor César** (2) [769016](https://platzi.com/comentario/769016/) 
	...
	* **JCMeza** [769016] (1)
		...
		Efectivamente, el subir una App con Apple es muy burocrático, pero parte del proceso es que vaya todo lo que debe de ir, como los iconos, las pantallas, la descripción, etc etc etc.
...
* **Jefferson Aguilar Suarez** (1) [844396](https://platzi.com/comentario/844396/) 
...
* [CSS Utilities - Ionic Documentation](https://ionicframework.com/docs/layout/css-utilities)
...
* **juanbarcinilla** (1) [943943](https://platzi.com/comentario/943943/) 
	...
	``` 
	    ...
	    common.js:290 Native: tried calling SplashScreen.hide, but Cordova is not available. Make sure to include cordova.js or run ina device/simulator
	    cordovaWarn @ common.js:290
	    checkAvailability @ common.js:146
	    callCordovaPlugin @ common.js:232
	    (anonymous) @ common.js:315
...
* **Luis José Leopardi Velásquez** (1) [979075](https://platzi.com/comentario/979075/) 
...
* **odortega** (10) [827371](https://platzi.com/comentario/827371/) 
...
* **Ray** (1) [1073032](https://platzi.com/comentario/1073032/) 
...
* **Alfonso Navarro** (1) [71523](https://platzi.com/comentario/798997/) 
Función TypeScript en el Home async showAlbum(album) { const songs = await this.musicService.getAlbumTracks(album.id); const mo...

# Acceso al hardware [4667]

## 0320. Usar la cámara a través de Capacitor [23370](https://platzi.com/clases/1718-ionic-avanzado/23370-usar-la-camara-a-traves-de-capacitor/)
...
* **MaicolQJ** (2) [796772](https://platzi.com/comentario/796772/) 
	...
	* **Sebastian Gomez Arias** [796772] (1)

		Hola, eso no lo vimos en el curso pero tienes varias opciones:
		
		  1. Usar algún servicio de almacenamiento en la nube como firebase storage para almacenar la foto y guardar el enlace permanente.
		
		  2. Obtener la ruta relativa de la foto en tu dispositivo pero esto solo te funcionaría en dispositivos reales, y luego guardar dicha ruta en algún servidor o en LocalStorage. el problema es que si borras la foto del dispositivo, desaparecería.
		
		
		

* **serpisoluciones** (2) [791242](https://platzi.com/comentario/791242/) 
	
	![eee.png](https://static.platzi.com/media/user_upload/eee-16b15a21-3b09-4fd3-984b-fe193c4b4952.jpg)
	...
	* **Sebastian Gomez Arias** [791242] (1)

		Hola!, Instalaste el @ionic/pwa-elements ? mira el minuto 11:18.
		
		Saludos.

* **eduardo.rodriguezv** (1) [82666](https://platzi.com/comentario/1010050/) 
Hola ¿Alguien sabe como poder instalar la app en Android por comando en lugar de usar el Android Studio?

	* **Alfonso Navarro** [82666] (1)
...
* **Harold Wilson Castaño Moreno** (1) [81594](https://platzi.com/comentario/984913/) 
Alguien conoce un plugin de capacitor para poder crear archivos. Pdf?

* **odortega** (1) [73078](https://platzi.com/comentario/827966/) 
Hola al aceptar el permiso para que chrome acceda a la camara, tengo el siguiente error y no abre el plugin de la camara del laptop (macb...

* **MaicolQJ** (1) [71416](https://platzi.com/comentario/796771/) 
Hola, podrían por favor ayudarme con una duda, la cámara efectivamente toma la fotografía y se puede visualizar en el ion-avatar, pero al...

* **Arturo Cerda** (0) [1033198](https://platzi.com/comentario/1033198/) 
	...
	![](https://i.ibb.co/cQ6LN1M/error.png)

## 0330. Corrección de errores y afinando detalles [23371](https://platzi.com/clases/1718-ionic-avanzado/23371-correccion-de-errores-y-afinando-detalles/)
...
* **MaicolQJ** (5) [785999](https://platzi.com/comentario/785999/) 

	muy genial la clase!!

	* **Sebastian Gomez Arias** [785999] (2)

		Gracias!

* **walter** (2) [839399](https://platzi.com/comentario/839399/) 

	tengo un problema cada vez que ininico me da error en import * as dataArtists from “./artists.json”; y tengo que abrir el visual studio y la complilo 2 veces y arranca pero no se porque lo hace.

	* **Sebastian Gomez Arias** [839399] (2)

		Revisaste la configuración del TSconfig para permitir el uso y la importación de archivos json ?

	* **walter** [839399] (1)

		si la revise lo que yo cambie si lo actualizo varias veces anda , sabes como puedo poner audios completos y no fragmentos.

## 0340. Mejorando nuestra página de Settings con CSS [23372](https://platzi.com/clases/1718-ionic-avanzado/23372-mejorando-nuestra-pagina-de-settings-con-css/)
...
* **Luis José Leopardi Velásquez** (1) [997789](https://platzi.com/comentario/997789/) 

	En lugar de crear varios métodos para navegar preferí hacer esto:
	``` 
	...
	Y mi vista:
	``` 
	    <ion-item (click)="goToModule(itemsMenu.home)">Home</ion-item>
	    <ion-item (click)="goToModule(itemsMenu.sports)">Sports</ion-item>
	    <ion-item (click)="goToModule(itemsMenu.settings)" >Settings</ion-item>
	    
	```

* **juanbarcinilla** (1) [955930](https://platzi.com/comentario/955930/) 

	a mi no me sale el menu  
	<ion-header>
...
## 0350. Página Sports y Angular Maps [23373](https://platzi.com/clases/1718-ionic-avanzado/23373-pagina-sports-y-angular-maps/)
...
* [Getting started with Angular Google Maps (AGM)](https://angular-maps.com/guides/getting-started/)

### Comentarios:

* **mavi** (2) [769238](https://platzi.com/comentario/769238/) 

	y como se haria con leaflet en lugar de googlemap  
	gracias

	* **Erik Ochoa (Platzi)** [769238] (3)

		Puedes usar Leaflet tal como lo usas en web, ahora en lugar de usar `<agm-map></agm-map>` dentro de tu `<ion-content></ion-content>` usarías un simple `<div>` con un id. checa el repositorio [oficial](https://www.npmjs.com/package/leaflet) y aquí te dejo un [tutorial completo](https://edupala.com/how-to-add-leaflet-map-in-ionic-4/).

	* **Sebastian Gomez Arias** [769238] (2)

		Nunca use leaflet! pero anímate a escribir un tutorial de como lo hiciste!

* **dennis-nunez** (1) [1036771](https://platzi.com/comentario/1036771/) 

	gracias profe sebas por esa libreria de angular para usar los mapas de google maps. Sin dudas me ahorro muchisimo en lugar de hacer con javascript 😂

* **juanbarcinilla** (1) [955931](https://platzi.com/comentario/955931/) 

	No permite descargar el proyecto pagina no found.

## 0360. Crear la página Sport [23374](https://platzi.com/clases/1718-ionic-avanzado/23374-crear-la-pagina-sport/)
...
* **ricardocelis (Platzi)** (4) [763791](https://platzi.com/comentario/763791/) 

	Recuerda que en la seccion de archivos, en la carpeta Source, encuentras la imagen de la bicileta.

* **Alfonso Navarro** (3) [800156](https://platzi.com/comentario/800156/) 

	Huy esta clase estuvo genial, no me esperaba esta practica pero la verdad he aprendido mucho y me ha servido muchísimo para un proyecto en el que involucro Google Maps, estuvo genial esta clase, gracias “querido profesor”.

	* **Sebastian Gomez Arias** [800156] (1)

		Gracias Alfonso!

* **Xavier Alexandro Basir Jeffrey** (1) [986147](https://platzi.com/comentario/986147/) 

	me está apareciendo este mensaje en la consola y no se me muestra el mapa “You must enable Billing on the Google Cloud Project at <https://console.cloud.google.com/project/_/billing/enable> Learn more at <https://developers.google.com/maps/gmp-get-started>”
	
	Será que esta parte del curso todavía se puede hacer sin necesidad de pagar por google maps? 😦

	* **alexishuerta** [986147] (1)
A mi me deja conectarme a las Apis de maps solo si tengo cuenta en google con una tarjeta de crédito o débito dada de alta. Para hacer pruebas no genera ningún cargo.

* **alexishuerta** (1) [82035](https://platzi.com/comentario/995856/) 
Este tipo de apps pueden ejecutarse en segundo plano? Como al bloquear pantalla?

## 0370. RETO Buscador dinámico en Sports [23375](https://platzi.com/clases/1718-ionic-avanzado/23375-reto-buscador-dinamico-en-sports/)
...
* **Jhon Carlos   Romo Ramirez** (3) [765063](https://platzi.com/comentario/765063/) 

	Creo que el video no corre.

	* **lmedina2016** [765063] (1)

		Si, no se puede visualizar

	* **ricardocelis (Platzi)** [765063] (1)

		listos!

	* **Erik Ochoa (Platzi)** [765063] (3)

		El vídeo ya funciona sin problemas 👍

	* **Sebastian Gomez Arias** [765063] (1)

		Ya funciona!

* **JandroMejia** (2) [940251](https://platzi.com/comentario/940251/) 
	...
	**sportpage.html**
	``` 
	    ...
	    <ion-content>
	      ...
	      <divclass="ion-padding">
	        <ion-searchbar (keyup)="getTracks($event.target.value)"></ion-searchbar>
	    
	        <h2>Tracks</h2>
	    
	        <divclass="ion-text-center" *ngIf="searching">
	          <ion-spinnername="crescent"></ion-spinner>
	        </div>
	          ...
	          <ion-item *virtualItem="let song">
	            ...
	            <ion-buttonsslot="end">
	              <ion-button (click)="pause()" *ngIf="song.playing">
	                <ion-iconname="pause"></ion-icon>
	              </ion-button>
	              <ion-button *ngIf="song.playing">
	                <ion-spinnername="dots"></ion-spinner>
	              </ion-button>
...
* **NavaMario** (1) [1089444](https://platzi.com/comentario/1089444/) 
...
* **mjmuslaco** (1) [768133](https://platzi.com/comentario/768133/) 

	No funciona

	* **Sebastian Gomez Arias** [768133] (1)

		Ya funciona!

* **odortega** (1) [73098](https://platzi.com/comentario/828351/) 
Hola en el material del archivo sports.page.ts ¿Alguien sabe para que sirve el asterisco * del atributo *virtualItem en la directiva <...

* **Andrés Aristizabal** (1) [72765](https://platzi.com/comentario/822183/) 
No funciona el video

	* **Bikatti** [72765] (2)

		Hey, si tienes problemas para verlo, te recomiendo que se lo reportes a [team@platzi.com](mailto:team@platzi.com) para que te puedan ayudar

## 0380. Llevar nuestra aplicación a producción con Android [23376](https://platzi.com/clases/1718-ionic-avanzado/23376-llevar-nuestra-aplicacion-a-produccion-con-android/)
...
* **Ana Zerpa** (2) [822066](https://platzi.com/comentario/822066/) 

	buen dia. Estoy utilizando httpClient de angular. pero al generar el apk de mi aplicacion no me funciona tiene que ver si mi endpoint no es https?

	* **LocoDarwin** [822066] (2)

		Lo lograste solucionar?

	* **Sebastian Gomez Arias** [822066] (1)

		En teoría no debería afectar, tienes algun enlace a tu codigo para ver como hiciste? ¿Porque no usaste fetch?

	* **juanbarcinilla** [822066] (1)

		a mi me pasa lo mismo, y no he encontrado una solución.
	...
	* **juanbarcinilla** [822066] (1)
		...
		```
		      loginUser(credentials: any) {
		        ...
		        this.aut.loginRestFull(credentials).subscribe(
		          async (response: any) => {
		            console.log(response);
		            if (response.estado) {
		              this.router.navigateByUrl('/home');
		            } else {
		              const alert = awaitthis.alertController.create({
		                header: 'Advertencia',
		                subHeader: null,
	...
	* **juanbarcinilla** [822066] (1)
		...
		```
		      loginRestFull(login: any)  {
		        try {
		          console.log(this.url);
		          const params = JSON.stringify(login);
		          returnthis.http.post(this.url + 'login', params, { headers: this.headersJson });
		        } catch (error) {
		          console.error(error);
		        }
		     }```
	...
	* **josericardoperezperez** [822066] (1)

		Mal no recuerdo en el config.xml debes declarar esto en el apartado de Android
		``` 
		    <platformname="android">
		            ...
		            <resource-filesrc="resources/android/xml/network_security_config.xml"target="app/src/main/res/xml/network_security_config.xml" />
	...
	* **juanbarcinilla** [822066] (1)
		...
		utilice el fetch y pasa lo mismo, no se que puede ser.  
		en el debug del android studio me sale es solo eso.
		``` 
		    D/eglCodecCommon: setVertexArrayObject: set vao to1 (1) 00
		    E/Capacitor/Console: File: http://localhost/vendor-es2015.js - Line 46777 - Msg: ERROR
		    D/eglCodecCommon: setVertexArrayObject: set vao to1 (1) 48
		    D/eglCodecCommon: setVertexArrayObject: set vao to2 (2) 280
		    D/eglCodecCommon: setVertexArrayObject: set vao to1 (1) 029
		    D/eglCodecCommon: setVertexArrayObject: set vao to0 (0) 411
		    D/eglCodecCommon: setVertexArrayObject: set vao to1 (1) 48
		    D/eglCodecCommon: setVertexArrayObject: set vao to0 (0) 411
		    D/eglCodecCommon: setVertexArrayObject: set vao to1 (1) 48
		    D/eglCodecCommon: setVertexArrayObject: set vao to0 (0) 411
	...
	* **juanbarcinilla** [822066] (1)
		...
		config.xml lo busque en todo el directorio y no lo encontré, descargue el proyecto que el profe hizo y tampoco lo veo que lo tenga.

* **mavi** (2) [806559](https://platzi.com/comentario/806559/) 

	Hola, una consulta donde se genera el archivo apk?  
	Cuales son los pasos para llevar al celular o lo copio nomas
	
	gracias

	* **Ana Zerpa** [806559] (2)

		El apk se genera en pestaña build, puedes generar el APK o el build de la aplicación (Que es el nuevo formato utilizado)

* **mavi** (2) [806538](https://platzi.com/comentario/806538/) 

	Buenas, felicidades por el curso.  
	Tengo un problema, en base al curso hice una app, que funciona bien en el navegador web.  
	La app que realice tiene un backend en node con acceso a mysql.  
	Cuando lo pruebo en el emulador android studio funciona pero al momento de desplegar la información no desplega nada como si el backend no estuviese corriendo.  
	Alguna ayuda por favor

	* **Sebastian Gomez Arias** [806538] (1)

		Revisa el HTTPS y la conexión a MySQL, ¿Donde tienes alojado el backend?

* **lautaumpierrez** (2) [799733](https://platzi.com/comentario/799733/) 

	Hola, como puedo cambiar el **splash screen** y el **icono** de mi aplicación?

	* **Alfonso Navarro** [799733] (2)

		Compañero lo primero q’ debes tener son las imágenes con las resoluciones recomendadas, esto lo puedes encontrar en el sgte link <https://ionicframework.com/docs/cli/commands/cordova-resources>.
		
		Luego que tengas las imágenes e iconos listos en sus respectivas carpetas, debes instalar y ejecutar lo sgte:
		``` 
		...
		Con el comando **ionic cordova resources** , ionic automáticamente generara el nuevo splashScreen e iconos, y actualizara el Config.xml.

* **LocoDarwin** (1) [839173](https://platzi.com/comentario/839173/) 

	Hola querido profesor, estoy compilando con ionic 5 y capacitor, para crear una app de android, mi pregunta es: para instalar (es necesario ?) google-services.json que tengo que hacer ya que me genera incompatibilidades

	* **Sebastian Gomez Arias** [839173] (1)

		Hola Darwin, Ionic 5? o ionic-cli 5+? Google services json no lo necesitamos con las versiones que usamos en el proyecto!, Hiciste algo más?

## 0390. Llevar nuestra aplicación a producción con iOS y cierre del curso [23377](https://platzi.com/clases/1718-ionic-avanzado/23377-llevar-nuestra-aplicacion-a-produccion-con-ios-y-c/)
...
* **JandroMejia** (2) [941231](https://platzi.com/comentario/941231/) 

	Hola a todos, les comparto cómo me quedo la app de Platzi Music al final del curso. Le añadí funcionalidades extra, cómo:
	
	* El registro de usuarios y almacenamiento de imágenes en Firebase.
	* También intenté hacer uso directo de la API de Spotify, pero primero se me complicó la obtención del token de acceso, ahora que lo tengo estoy tratando de encontrar la forma de renovarlo automáticamente, dado que el mismo tiene tiempo de expiración.
	* En la página de settings se muestran los datos del usuario que tiene la sesión activa.
	
	
	
	Pueden encontrar la app desplegada en Firebase [aquí](https://platzi-music-c5d1f.web.app/) y el código fuente en este [enlace](https://github.com/JandroMejia97/platzi-music). Para ver la aplicación en el navegador, recuerden verlo en modo de desarrollo. Aún no modifico el CSS para que se adapte a las distintas resoluciones de pantalla. Saludos.

* **Alfonso Navarro** (2) [800244](https://platzi.com/comentario/800244/) 

	“Querido profesor” en verdad el curso cumplió con todas mi expectativas y un poco mas, me aclaro muchos conceptos q tenia, y me enseño muchos temas mas. En realidad muchas gracias.

	* **Sebastian Gomez Arias** [800244] (1)

		Con gusto Alfonso!

* **Mauricio Quiñones** (1) [926657](https://platzi.com/comentario/926657/) 

	hola a todos, cuando llevo mi app a android studio al momento de correrla me lanza el siguiente error: “error: class R is public, should be declared in a file name R.java”; que puedo hacer para solucionar esto?

* **Rogelio Torres Dueñas** (1) [912215](https://platzi.com/comentario/912215/) 

	Buen día, tengo el siguiente problema, espero alguien pueda ayudarme, subí la aplicación a la playstore pero me aparece la siguiente leyenda ya que está instalado “instalar aplicaciones de esta fuente puede poner en riesgo su telefono”.  
	Saben a que se deba esto?

	* **Jessie Buckland Pérez** [912215] (2)

		Creo que tienes que añadir un “certificado especial en el play store” para que detecte la aplicación como software que proviene de una fuente segura. Aqui hay mucha mas información <https://support.google.com/googleplay/android-developer/answer/113469?hl=es>
