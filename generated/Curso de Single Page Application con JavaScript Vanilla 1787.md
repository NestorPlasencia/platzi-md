...
* **Cristhian Franco** (1) [1116411](https://platzi.com/comentario/1116411/) 
	...
	```     info it worked if it ends with ok
	    ...
	    23 error cientifico@1.0.0build: `webpack --mode production`
...
* [styles.css · GitHub](https://gist.github.com/gndx/cf251e88979581d6228028710bbff87c)
...
* **Jhonatan David Ibarra Lavado** (1) [1114929](https://platzi.com/comentario/1114929/) 
	...
	Please review <https://docs.travis-ci.com>, or contact us at [support@travis-ci.com](mailto:support@travis-ci.com) with the error ID: 3def003e8000481686b4401d2b956ddc
...
* **carlosextra1** (1) [1113382](https://platzi.com/comentario/1113382/) 
	...
	```     Entrypoint main = main.js
	    ...
	    Module not found: Error: Can't resolve '../templates/Header' in '/home/travis/build/aplysoft/spa_js_vanilla/src/routes'
	     @ ./src/routes/index.js 1:0-4116:27-33
	     @ ./src/index.js
...
* [Frontend con React.js](https://platzi.com/desarrollo-react/)

* [Desarrollo con Angular](https://platzi.com/desarrollo-angular/)

* [Desarrollo con Vue.js](https://platzi.com/vue/)
	...
	* **Victor Martin Ortiz Palacio** [1109991] (1)
		...
		```     #En el curso creamos esta funcion que maneja las rutas
		    const router = async () => {
		      ...
		      lethash = getHash(); #Aqui obtenemos el hash o "valor" de la url
		      letroute = await resolveRoutes(hash); #Aqui validamos el hash/valor de la url
		      letrender = routes[route] ? routes[route] : Error404; #Aqui es donde segun el valor devuelto por route podemos recorrer las keys('/', '/:id', '/contact') del objeto routes y si alguna coincide llamara a esa 'pagina'(Home, Character, Contact) de lo contrario llamara a la "pagina" Error404 "
		      content.innerHTML = await render(); #Aqui insertamos dentro del <section> con el id=content lo que nos devuelve render
		    };
