...
## 0020. Características de Relational Database Service (RDS)
...
* **Franco Agustín Torres** (5)
	...
	* **Carlos Andrés Zambrano Barrera** (3)
...
## 0030. Desplegando nuestra primer base de datos
...
* **Nestor Alfonso Portela Rincón** (2)
	...
	* **andresguerrerf5134f1227214204** (2)
...
* **DrHarrys** (2)
	...
	* **Nestor Alfonso Portela Rincón** (6)
...
* **edisoncastro14** (1)
	...
	* **Carlos Andrés Zambrano Barrera** (2)
...
## 0040. Conexión gráfica a nuestra base de datos
...
## 0060. Conexión por consola a nuestra base de datos
...
* **Juan Sebastian Piedrahita Gonzalez** (1)
...
## 0070. Base de Datos corporativa en RDS
...
* **Marollyn Jisselly Alvarado Navarro** (2)
...
## 0090. Demo estrategias de backup
...
* **Francisco Genaro Cerna Fukuzaki** (2)
...
## 0100. Estrategias de performance en RDS
...
* **carlos alberto arguello ramirez** (2)
...
## 0120. Estrategias de migración a RDS
...
## 0130. Migraciones homogéneas y heterogéneas
...
* **estebanvasquezvalencia** (1)
	...
	* **Carlos Andrés Zambrano Barrera** (4)
...
## 0160. Características de  Aurora
...
## 0190. Base de Datos corporativa para encuestas en DynamoDB
...
## 0200. Características de DynamoDB
...
* **Cristian Camilo Alvarado Beltran** (2)
...
## 0220. Creando nuestra primer tabla en DynamoDB
...
* **estebanvasquezvalencia** (2)
	...
	* **Carlos Andrés Zambrano Barrera** (5)
...
## 0240. Índices y particiones en DynamoDB
...
## 0250. Operaciones Scan en DynamoDB
...
## 0260. Operaciones Query en DynamoDB
...
* **Cristian David Montoya Montoya** (3)
...
## 0270. Demo de operaciones Scan y Query en DynamoDB
...
## 0280. ¿Qué es Local Seconday Index
...
## 0290. Características Streams y Replicación en DynamoDB
...
## 0300. Casos de uso Streams y Replicación en DynamoDB
