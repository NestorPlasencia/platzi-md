...
Me tomé una pequeña licencia aquí para hacer más claro el ejemplo, a esta altura sabes que las variables en C no comienzan con el caracter $… ¿cierto?
...
* **Jair Sebastian Lozano Moron** (1) [944405](https://platzi.com/comentario/944405/) 
	...
	* **JanethM** [944405] (3)
		...
		**Los caracteres** se representan utilizando el tipo char, que tiene sólo 1 byte de tamaño. Este tipo se utiliza para representar los 256 caracteres de la tabla de caracteres del sistema. El tipo char es también un tipo entero, ya que puede tomar valores de 0 a 255. Por lo tanto también puede ser signed o unsigned.
		...
		Un **tipo de dato entero** en computación es un tipo de dato que puede representar un subconjunto finito de los números enteros. El número mayor que puede representar **depende del espacio usado por el dato y la posibilidad (o no) de representar números negativos.**
...
* **Abdel Mejia** (2) [1020975](https://platzi.com/comentario/1020975/) 
	...
	Las dinámicas estas en alguna parte de tu memoria y le pasan a tu ejecutable los símbolos solo en el momento que la usara al ejecutar tu programa, eso lo hace diciendo a cada programa donde esta ubicado por medio de una dirección relativa. De esta forma solo tengo una librería para multiples ejecutables, aunque esto también lo vuelve mas lento.
	...
	``` 
	    ...
	    intmain( int argc, constchar * argv[] )
	    {
	            ...
	            if ( argc > 2 )
	            {
	                    ...
	                    printf( "La cadena de caracteres más larga es: %s\n", str_large );
	            }
...
* **david.lachealvarez** (1) [1104848](https://platzi.com/comentario/1104848/) 
	...
	``` 
	    ...
	    intmain(int argc, char *argv[]){
	        ...
	        printf("El argumento de mayortamaño es: %s \n", mayor);
...
* **paconity** (1) [1085823](https://platzi.com/comentario/1085823/) 
	...
	``` 
	    ...
	    int main ( int argc, const char * argv[] ) {
	            ...
	            if ( argc < 3 ) {
	                    printf("\nIngrese mínimo 2 cadenas de caracteres\n");
...
* **AngelFA04** (1) [1033943](https://platzi.com/comentario/1033943/) 
	...
	```
	    ...
	    intmain(int argc, char **argv)
	    {
	        ...
	        printf("La palabra más grande es: %s\n", argv[indexGreatest]);
	        return0;
	    }
...
* **Abdel Mejia** (4) [1023855](https://platzi.com/comentario/1023855/) 
	...
	**No es una función, es un operador unario**
...
![abrir una consola.png](https://static.platzi.com/media/user_upload/abrir%20una%20consola-d5a8a351-c75d-4c0d-84ca-68e3a88a941c.jpg)
  ...
  2. Actualiza tu administrador de paquetes (Ingresa tu contraseña cuando se te solicite).  
...
![parecido a .png](https://static.platzi.com/media/user_upload/parecido%20a%20-3e79ceeb-e89e-40bc-8f4e-19efdee7498b.jpg)
  ...
  3. Instala Valgrind usando sudo apt install Valgrind (Ingresa tu contraseña cuando se te solicite)
...
![instala valgrind.png](https://static.platzi.com/media/user_upload/instala%20valgrind-46c02b78-b0d9-41a3-8c2c-14c23911c3ff.jpg)
  ...
  4. Contesta sí  
![contesta sí.png](https://static.platzi.com/media/user_upload/contesta%20si%CC%81-f429b8d6-3cb1-4106-9421-ba5d8376bbde.jpg)

  5. Utiliza el comando `valgrind --help` para validar que la instalación fue exitosa
...
* [Curso Básico de Algoritmos | Platzi](https://platzi.com/clases/algoritmos/)
...
* **alepaper** (2) [1057959](https://platzi.com/comentario/1057959/) 
	...
	```
	    ...
	    int main( int argc, const char * arg[] )
	    {
	        ...
	        printf( "La lista contiene %d nodos. Ingrese el número a eliminar (0 para finalizar)\n", listSize );
	        scanf("%d", &number );
	        if ( number ) {
	...
	``` 
	    ...
	    void findNode(int number, NODE** start){
	            ...
	            if(band){
	                    ...
	                    printf("No se encontró el numero en la lista\n");
	            }
	    }
	...
	``` 
	    ...
	    int main( int argc , const char * argv[]){
	        ...
	        do{
	            ...
	            switch (goOn){
	                case1:
	                    printf("Ingrese el numero a añadir:\n");
	                    scanf("%d", &number);
...
* **ffranco_** (1) [1053805](https://platzi.com/comentario/1053805/) 
	    ...
	    printf ("Se tienen los nodos del 0 al %d.\n", listSize - 1);
	        ...
	        if (ans == 'y' || ans == 'Y')
	        {
	            ...
	            if (theNode >= 0 && theNode < listSize)
	            {
	    			...
	    			// Por si se desea eliminar el último nodo, aux es el anterior a este.
	    			while (current -> next)
	    			{
	    				aux = current;
	    			...
	    			// Current ahora contiene la direccion de memoria de la última variable y aux la direccion anterior.
	    			aux -> next = NULL;
	    			free (current);
	    			listSize--;
	...
	La idea era ir moviendo los datos hasta que el último nodo quede vacío y luego eliminar el último nodo. Sin embargo una vez vi el tip entendí que había una forma mucho más eficaz. Realizando las modificaciones al código anterior quedó:
	``` 
	    printf ("Se tienen los nodos del 0 al %d.\n", listSize - 1);
	        printf ("Desea eliminar alguno de los %d nodos? (y): ", listSize);
	        char ans;
...
* **LuqueDaniel** (1) [965629](https://platzi.com/comentario/965629/) 
	...
	``` 
	    ...
	    {
	    	// Guardamos la dirección de memoria que contiene start
	    	NODE** prev = start;
	    	NODE* current = *start;
	...
	Llamar a la función pasando como primer parámetro la dirección de memoria del puntero `start`, y el número a eliminar como segundo.
	``` 
...
* **Gustavo Marín** (1) [875564](https://platzi.com/comentario/875564/) 
	...
	``` 
	    ...
	    int main( int argc, const char * argv[] ){
	    	...
	    	do{
	    		current = start;
	    		printf("Para borrar un número de la lista indique la posicion (0 para omitir este paso):");
	    		scanf("%d", &node);
	    		if( node > listsize ){
	    			printf("la posición no esta en la lista.\n");
	    			node = -1;
	    		}
	    		elseif( node == 1 ){
	    			start = current->next;
